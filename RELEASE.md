...
- **Sheet cleanups.** Sheet 1's Section A-A duplicated Sheet 3's wall section (a superset), so Sheet 1 is now a single front-view general arrangement pointing to Sheet 3 for the section. On Sheet 4 the lens groups are relabeled "front/rear element" and drawn as glass elements (ellipsoids), with a one-line definition.
