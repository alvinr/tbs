...
- [x] **Potassium ferricyanide re-price — DONE 2026-07-26.** `PRICE_FERRI_PER_KG` $24.29 → **$60.80/kg** (Bostick & Sullivan, $151.99/2500 g firm — sole supplier; the interim Photographers' Formulary $61.71/kg was superseded when consolidated to one supplier). Cascaded: costing tiers (Standard total $4,190→$4,400, per-print $84→$88), parts registry, master/cost-breakdown injected, prose restatements updated. Dichromate also firmed to Bostick $79.95/1000 g ($25/run allowance holds).
- [x] **process-comparison.md — rebased to firm chemistry prices — DONE 2026-07-26** (Alvin confirmed AmFe retail price firm). Cyanotype-lean $1,116 → **$3,040 ($61/print)**; gum's ammonium dichromate reconciled to the firm Bostick $79.95/kg (was Chem-Impex $142.41) → gum $2,202 → **$1,592 ($32/print)**. Thesis inverted: **gum is now cheapest, cyanotype second** — added a "why cyanotype despite not being cheapest" rationale (archival permanence / low hazard / process simplicity) + a caveat that the cyanotype figure is inflated by retail 1-lb AmFe and a bulk source would narrow the gap. Van Dyke/Salt/Ilford/Liquid-Light unaffected (silver/paper-driven).
- [ ] **Bulk AmFe pricing — OPTIONAL follow-up (would move totals).** AmFe is firm at the retail 1-lb-pack rate ($98.95/lb = $218.16/kg) → $3,731 for 17.1 kg (Standard). A bulk/lab AmFe source (e.g. Artcraft, a chemical supplier) would materially lower the cyanotype chemistry line and could restore its cost lead over gum. Only pursue if the chemistry budget matters; the model is internally consistent as-is.
