...
- [x] **Potassium ferricyanide re-price — DONE 2026-07-26.** `PRICE_FERRI_PER_KG` $24.29 → **$61.71/kg** (Photographers' Formulary, $139.95/5 lb firm). Cascaded: costing tiers (Standard total $4,190→$4,410, per-print $84→$88), parts registry, master/cost-breakdown injected, prose restatements updated. Supplier primary→Photographers' Formulary, Bostick & Sullivan secondary.
