...
- [ ] **process-comparison.md — cyanotype baseline is on PRE-reprice chemistry (thesis-breaking).** The comparison table (§summary lines 14–21, §211 detail) still costs cyanotype-lean at the OLD AmFe $60/kg + ferri $24.29/kg → **chem ~$816 / total ~$1,116 / ~$22-print**. Under the corrected retail prices (AmFe $218/kg, ferri $61.71/kg) cyanotype-lean is **~$2,800 chem / ~$3,100 total / ~$62-print**, which now **exceeds gum bichromate's $2,202** — inverting the document's central claim ("Cyanotype is the only process under $2,000 total"). NOTE: this also surfaces the real procurement question — the retail $/lb prices applied to 11.6 kg AmFe give a $3,731 line; bulk AmFe was the original $60/kg basis. Decide bulk-vs-retail basis BEFORE rebasing this doc. (Surfaced 2026-07-26 during the ferricyanide cascade.)
