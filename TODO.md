...
- [ ] **Potassium ferricyanide re-price (mirror the AmFe fix).** `PRICE_FERRI_PER_KG = $24.29/kg` in costing.py is a bulk/industrial figure; retail photo-grade (Photographers' Formulary) is ~$120–150/kg (~$12–15/100 g). AmFe was just corrected $60→$218/kg (2026-07-26); ferricyanide is the same class of underestimate — get the firm Photographers' Formulary lb/kg price and cascade the chem tiers. (Surfaced 2026-07-26 during the AmFe quantity reconciliation.)
