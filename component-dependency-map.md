...
| Parameter | Value | Constant |
|-----------|-------|----------|
| Duct penetration X | 1,420 mm | `EVAP_DUCT_X` |
| Duct penetration Z | 1,440 mm | `EVAP_DUCT_Z` |
...
Ø200mm insulated flex duct to a wall penetration with light-safe baffle at Z=1,440mm.*
