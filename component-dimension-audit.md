...
| 6 | **Evap cooler** (was fictional "Portacool Jetstream 110, 12 V DC") | **Hessaire MC18M**, 120 V AC, 1300 CFM, <!-- BEGIN fact:evap_cooler_w_ac -->85<!-- END fact:evap_cooler_w_ac --> W, 16 lb, 559×305×711 | 600×350×800 → **559×305×711** (`EVAP_*`) | ✅ **RESOLVED** — no clean 12 V DC ground unit exists (only RV-roof or $1,100+ Solar Chill), so: commodity 120 V AC cooler on a dedicated 12V→120V inverter (Victron Phoenix 12/375 GFCI). Circuit E re-based to **<!-- BEGIN fact:evap_cooler_w_bus -->97<!-- END fact:evap_cooler_w_bus --> W on the 12 V bus**; AC isolation/GFCI/bonding in [Electrical §7.6](electrical-report.md#ac-safety) |
