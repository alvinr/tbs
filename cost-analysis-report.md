...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,047<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,017** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,017<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,873 | 24% | Tray (304 SS) + IBC frame dominate |
...
| **Perimeter walkway** | $2,276 | 8% | GRP grating + steel cantilevers |
