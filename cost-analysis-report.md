...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,491<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,241** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,241<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,474 | 26% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,291 | 15% | Carriages, Option-A 304 cross-slides, muslin spring clips, wall-seat saddles |
| **Light lock** | $3,470 | 12% | Plastic-skin custom fabrication |
...
| **Chemistry prep shelf** | $230 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
...
- **Container shell** — already the cheapest large steel box; only the *grade* is a lever
  (#1).
- **Light lock** — already the cheap custom option (<!-- BEGIN costing:ca-lightlock-mid -->$3,470<!-- END costing:ca-lightlock-mid --> mid vs $2,500–4,500 for a
