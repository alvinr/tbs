...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,286<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,036** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,036<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,148 | 26% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $3,875 | 14% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
