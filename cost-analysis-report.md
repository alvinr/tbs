...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,248<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$26,998** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$26,998<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $3,934 | 15% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
