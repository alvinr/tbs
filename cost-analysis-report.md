...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$26,981<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$23,791** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$23,791<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,650<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $5,300 | 22% | Tray (304 SS) + IBC frame dominate |
