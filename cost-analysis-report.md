...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,415<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,165** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,165<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,061 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,942 | 18% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Container + delivery** | $3,300 | 12% | Grade-dependent (CW vs WWT) |
| **Power & electrical** | $3,037 | 11% | Battery + solar + distribution + protection |
| **Perimeter walkway** | $2,395 | 9% | GRP grating + steel cantilevers |
| **Light lock** | $2,280 | 8% | Plastic-skin custom fabrication |
| **Hinged panel structure** | $1,919 | 7% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
| **Swing pivot** | $1,395 | 5% | Pivot post + bearings + cage + fixed RHS door frame |
| **Ventilation & cooling** | $847 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
| **Interior conversion** | $605 | 2% | Insulation, sealing, safelight |
| **Chemistry prep shelf** | $229 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
...
single biggest line** (<!-- BEGIN costing:tray-low -->$1,583<!-- END costing:tray-low -->–<!-- BEGIN costing:tray-high -->$2,271<!-- END costing:tray-high -->) — the same item that topped the weight study.
