...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,580<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,550** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,550<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,647 | 23% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,600 | 23% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
