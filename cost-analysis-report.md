...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,458<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,208** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,208<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Light lock** | $3,466 | 12% | Plastic-skin custom fabrication |
...
| **Hinged panel structure** | $1,428 | 5% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
...
- **Container shell** — already the cheapest large steel box; only the *grade* is a lever
  (#1).
- **Light lock** — already the cheap custom option (<!-- BEGIN costing:ca-lightlock-mid -->$3,466<!-- END costing:ca-lightlock-mid --> mid vs $2,500–4,500 for a
