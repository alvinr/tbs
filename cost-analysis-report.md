...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$33,192<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,942** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,942<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,340 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,440 | 22% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Container + delivery** | $3,300 | 11% | Grade-dependent (CW vs WWT) |
| **Power & electrical** | $3,037 | 10% | Battery + solar + distribution + protection |
| **Perimeter walkway** | $2,395 | 8% | GRP grating + steel cantilevers |
| **Light lock** | $2,280 | 8% | Plastic-skin custom fabrication |
| **Hinged panel structure** | $1,919 | 6% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
