...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,786<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,536** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,536<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,051 | 26% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,587 | 17% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Power & electrical** | $3,349 | 12% | Battery + solar + distribution + protection |
