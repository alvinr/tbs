...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,882<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,632** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,632<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,148 | 24% | Tray (304 SS) + IBC frame dominate |
...
| **Ventilation & cooling** | $749 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
| **Interior conversion** | $605 | 2% | Insulation, sealing, safelight |
| **Chemistry prep shelf** | $235 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
