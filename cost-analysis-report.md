...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,489<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,239** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,239<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Chemistry prep shelf** | $228 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
