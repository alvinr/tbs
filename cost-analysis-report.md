...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,720<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,470** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,470<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,474 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,291 | 15% | Carriages, Option-A 304 cross-slides, muslin spring clips, wall-seat saddles |
| **Light lock** | $3,651 | 12% | Plastic-skin custom fabrication |
| **Power & electrical** | $3,464 | 12% | Battery + solar + distribution + protection |
| **Container + delivery** | $3,300 | 11% | Grade-dependent (CW vs WWT) |
| **Perimeter walkway** | $2,507 | 9% | GRP grating + steel cantilevers |
| **Swing pivot** | $1,490 | 5% | Pivot post + bearings + cage + fixed RHS door frame |
| **Hinged panel structure** | $1,432 | 5% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
| **Ventilation & cooling** | $808 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
| **Interior conversion** | $605 | 2% | Insulation, sealing, safelight |
| **Chemistry prep shelf** | $278 | 0.9% | Fold-down phenolic board + frame + hinge/stays + tap extension |
| **Optics — pinhole** | $170 | 0.6% | Trivial (it is a pinhole) |
<!-- END costing:ca-ranking -->

The **water system is <!-- BEGIN costing:ca-water-pct -->25<!-- END costing:ca-water-pct -->% of the capital build** and the **304 SS processing tray is its
...
- **Container shell** — already the cheapest large steel box; only the *grade* is a lever
  (#1).
- **Light lock** — already the cheap custom option (<!-- BEGIN costing:ca-lightlock-mid -->$3,651<!-- END costing:ca-lightlock-mid --> mid vs $2,500–4,500 for a
