...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,626<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,596** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,596<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,650 | 23% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,557 | 23% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Container + delivery** | $3,300 | 12% | Grade-dependent (CW vs WWT) |
| **Power & electrical** | $2,806 | 10% | Battery + solar + distribution + protection |
| **Perimeter walkway** | $2,529 | 9% | GRP grating + steel cantilevers |
| **Light lock** | $1,739 | 6% | Plastic-skin custom fabrication |
| **Hinged panel structure** | $1,418 | 5% | Stepped frame + PP skins + Al core + EPDM + latches + B2 bay |
| **Swing pivot** | $1,239 | 4% | Pivot post + bearings + cage + fixed RHS door frame |
| **Interior conversion** | $1,138 | 4% | Insulation, sealing, safelight |
| **Ventilation & cooling** | $817 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
| **Chemistry prep shelf** | $218 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
| **Optics — pinhole** | $185 | 0.6% | Trivial (it is a pinhole) |
...
single biggest line** (<!-- BEGIN costing:tray-low -->$1,296<!-- END costing:tray-low -->–<!-- BEGIN costing:tray-high -->$2,011<!-- END costing:tray-high -->) — the same item that topped the weight study.
...
- **Container shell** — already the cheapest large steel box; only the *grade* is a lever
  (#1).
- **Light lock** — already the cheap custom option (<!-- BEGIN costing:ca-lightlock-mid -->$1,739<!-- END costing:ca-lightlock-mid --> mid vs $2,500–4,500 for a
