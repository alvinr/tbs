...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,053<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,803** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,803<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,045 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,596 | 17% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
