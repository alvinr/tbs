...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,096<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,846** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,846<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Light lock** | $3,223 | 11% | Plastic-skin custom fabrication |
...
- **Container shell** — already the cheapest large steel box; only the *grade* is a lever
  (#1).
- **Light lock** — already the cheap custom option (<!-- BEGIN costing:ca-lightlock-mid -->$3,223<!-- END costing:ca-lightlock-mid --> mid vs $2,500–4,500 for a
