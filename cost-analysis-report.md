...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,222<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,192** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,192<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,916 | 24% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,368 | 22% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Container + delivery** | $3,300 | 11% | Grade-dependent (CW vs WWT) |
| **Power & electrical** | $2,904 | 10% | Battery + solar + distribution + protection |
