...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$28,521<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$25,461** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$25,461<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,520<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $3,548 | 14% | Carriages, Option-A cross-slides, cam-lever clamps, wall-seat saddles |
