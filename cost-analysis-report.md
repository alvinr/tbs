...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$33,104<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,854** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,854<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,278 | 24% | Tray (304 SS) + IBC frame dominate |
...
| **Power & electrical** | $3,011 | 10% | Battery + solar + distribution + protection |
...
single biggest line** (<!-- BEGIN costing:tray-low -->$1,538<!-- END costing:tray-low -->–<!-- BEGIN costing:tray-high -->$2,226<!-- END costing:tray-high -->) — the same item that topped the weight study.
