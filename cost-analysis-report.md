...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,426<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,176** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,176<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,478 | 26% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,309 | 15% | Carriages, Option-A 304 cross-slides, muslin spring clips, wall-seat saddles |
...
| **Hinged panel structure** | $1,370 | 5% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
