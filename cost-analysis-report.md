...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,566<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,536** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,536<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,628 | 23% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,565 | 23% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
...
| **Chemistry prep shelf** | $202 | 0.7% | Fold-down phenolic board + frame + hinge/stays + tap extension |
