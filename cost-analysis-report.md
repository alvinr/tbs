...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,749<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,499** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,499<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $4,570 | 17% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Power & electrical** | $3,336 | 12% | Battery + solar + distribution + protection |
...
| **Ventilation & cooling** | $807 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
