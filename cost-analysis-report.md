...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,791<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,761** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,761<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,690 | 24% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,022 | 22% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
