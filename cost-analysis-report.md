...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$34,683<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$31,653** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$31,653<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,178 | 23% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,427 | 20% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Perimeter walkway** | $4,481 | 14% | GRP grating + steel cantilevers |
| **Container + delivery** | $3,300 | 10% | Grade-dependent (CW vs WWT) |
