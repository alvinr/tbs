...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$31,749<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$28,719** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$28,719<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $6,569 | 23% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
...
| **Swing pivot** | $1,219 | 4% | Pivot post + bearings + cage + fixed RHS door frame |
