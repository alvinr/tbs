...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,788<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,758** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,758<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $6,019 | 22% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
