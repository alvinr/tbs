...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,863<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,613** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,613<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,073 | 24% | Tray (304 SS) + IBC frame dominate |
...
| **Ventilation & cooling** | $831 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
| **Interior conversion** | $573 | 2% | Insulation, sealing, safelight |
| **Chemistry prep shelf** | $241 | 0.8% | Fold-down phenolic board + frame + hinge/stays + tap extension |
