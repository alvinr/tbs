...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$32,365<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,115** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,115<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Hinged panel structure** | $1,309 | 4% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
