...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$33,280<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$30,030** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$30,030<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,428 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,440 | 21% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
