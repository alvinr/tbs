...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$34,252<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$31,222** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$31,222<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,490<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,873 | 22% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $6,427 | 21% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
| **Perimeter walkway** | $4,481 | 14% | GRP grating + steel cantilevers |
| **Container + delivery** | $3,300 | 11% | Grade-dependent (CW vs WWT) |
| **Power & electrical** | $2,958 | 9% | Battery + solar + distribution + protection |
| **Light lock** | $2,268 | 7% | Plastic-skin custom fabrication |
| **Hinged panel structure** | $1,713 | 5% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
| **Swing pivot** | $1,395 | 4% | Pivot post + bearings + cage + fixed RHS door frame |
...
| **Chemistry prep shelf** | $227 | 0.7% | Fold-down phenolic board + frame + hinge/stays + tap extension |
