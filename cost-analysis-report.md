...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,189<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$26,939** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$26,939<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Chemistry prep shelf** | $229 | 0.9% | Fold-down phenolic board + frame + hinge/stays + tap extension |
