...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,226<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,166** | The systems you build once — this is where build-savings live |
| Consumable (per 50-print batch) | $1,520 | Cyanotype chemistry + substrate (Standard ½-Ware) — recurs every batch |
| Recurring (per deployment) | $750 | Commercial-hire transport |
| Soft / regulatory | $790 | Licenses & permits |
<!-- END costing:ca-buckets -->

Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,166<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,520<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,647 | 24% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $5,253 | 19% | Carriages, Option-A cross-slides, cam-lever clamps, wall-seat saddles |
...
| **Light lock** | $1,768 | 7% | Plastic-skin custom fabrication |
| **Hinged panel structure** | $1,418 | 5% | Stepped frame + PP skins + Al core + EPDM + latches + B2 bay |
| **Swing pivot** | $1,143 | 4% | Pivot post + bearings + cage + fixed RHS door frame |
