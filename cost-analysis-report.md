...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$33,077<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$29,827** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$29,827<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Ventilation & cooling** | $980 | 3% | Fans + cooler + inverter + baffle-duct fab + canopy |
