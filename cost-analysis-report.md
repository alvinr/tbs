...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$28,476<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$25,286** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$25,286<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,650<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $6,339 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $3,681 | 15% | Carriages, Option-A cross-slides, cam-lever clamps, wall-seat saddles |
