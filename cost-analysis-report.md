...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$25,620<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$22,430** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$22,430<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,650<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $5,258 | 23% | Tray (304 SS) + IBC frame dominate |
...
| **Swing pivot** | $1,232 | 5% | Pivot post + bearings + cage + fixed RHS door frame |
