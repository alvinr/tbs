...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,627<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,377** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,377<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
| **Film-plane mechanism** | $4,066 | 15% | Carriages, Option-A 304 cross-slides, muslin spring clips, wall-seat saddles |
