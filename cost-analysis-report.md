...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,901<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,651** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,651<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,051 | 25% | Tray (304 SS) + IBC frame dominate |
| **Film-plane mechanism** | $4,587 | 17% | Carriages, Option-A cross-slides, muslin spring clips, wall-seat saddles |
