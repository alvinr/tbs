...
mid-total is **~<!-- BEGIN costing:ca-mid-total -->$30,511<!-- END costing:ca-mid-total -->**.
...
|---|--:|---|
| **Capital build** (one-time hardware) | **$27,261** | The systems you build once — this is where build-savings live |
...
Build-savings work on the **<!-- BEGIN costing:ca-capital -->$27,261<!-- END costing:ca-capital --> capital**. The <!-- BEGIN costing:ca-consumable -->$1,710<!-- END costing:ca-consumable --> consumable is attacked
...
|---|--:|--:|---|
| **Processing water system** | $7,045 | 26% | Tray (304 SS) + IBC frame dominate |
...
| **Hinged panel structure** | $1,377 | 5% | Stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay |
