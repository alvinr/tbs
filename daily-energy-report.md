...
> so Circuit F draws nothing. Per-**session** energy (incl. the once-daily morning warmup) is ~**812 Wh** (vs 820 Wh with the optional
...
| Phase / load | W | Min | Wh |
|---|--:|--:|--:|
| Dark adaptation (fans + cooler + safelight) | 257 | 20 | 86 |
| Load image plane (fans + cooler + safelight) | 257 | 45 | 193 |
| **Exposure** (fans + cooler) | 217 | 37.5 | 136 |
| Development & **wash** (fans + cooler + white light) | 293 | 20 | 98 |
| Cleanup (fans + cooler + white light) | 293 | 30 | 146 |
| Wash pump P-01 (Blue, 3× fills) | 90 | 15 | 22.5 |
| Wash pump P-02 (Brown recycled) | 90 | 10 | 15.0 |
| Tray-drain pump P-04 (sump → IBC) | 90 | 5 | 7.5 |
| **Per print (manual)** | | | **~<!-- BEGIN energy:per-print-wh -->703<!-- END energy:per-print-wh -->** *(excl. one-time morning warmup)* |
...
| 3 prints × <!-- BEGIN energy:per-print-wh -->703<!-- END energy:per-print-wh --> Wh (cycle + wash/drain pumps) | 1,989 |
| **Daily total (3 prints)** | **~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 --> Wh** |

| Day | Prints | Daily Wh |
|---|--:|--:|
| Short / poor light | 2 | ~<!-- BEGIN energy:daily-wh-2 -->1,515<!-- END energy:daily-wh-2 --> |
| **Representative** | **3** | **~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 -->** |
| Pushed | 4 | ~<!-- BEGIN energy:daily-wh-4 -->2,921<!-- END energy:daily-wh-4 --> |
...
| **Per-dump-run drain total** | | | | **~<!-- BEGIN energy:drain-wh -->40<!-- END energy:drain-wh --> Wh** |

Because gravity does the bulk, the pump energy is **independent of how full the totes
got** and is **tiny — ~37 Wh per dump run** (a fraction of a single operating day's ~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 --> Wh,
...
|---|--:|--:|---|
| 2 prints | ~<!-- BEGIN energy:daily-wh-2 -->1,515<!-- END energy:daily-wh-2 --> | **+<!-- BEGIN energy:solar-net-2 -->1,785<!-- END energy:solar-net-2 -->** | Yes (with wide margin) |
| 3 prints | ~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 --> | **+<!-- BEGIN energy:solar-net-3 -->1,082<!-- END energy:solar-net-3 -->** | Yes — full overnight autonomy |
| 4 prints | ~<!-- BEGIN energy:daily-wh-4 -->2,921<!-- END energy:daily-wh-4 --> | **+<!-- BEGIN energy:solar-net-4 -->379<!-- END energy:solar-net-4 -->** | Exceeds the <!-- BEGIN energy:battery-wh-2pack -->2,400<!-- END energy:battery-wh-2pack --> Wh battery by ~521 Wh → covered by **daytime solar** (which runs during the prints), not battery alone |
...
- A **4-print day relies on the panels topping up during the day** (the loads run in
  ...
  shortfall at ~521 Wh — still solar-covered, but battery-only 4-print days are off the table.
...
Solar generates ~<!-- BEGIN energy:solar-wh-day -->3,300<!-- END energy:solar-wh-day --> Wh/day; a 3-print day draws ~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 --> Wh — a **+<!-- BEGIN energy:solar-net-3 -->1,082<!-- END energy:solar-net-3 --> Wh/day surplus**,
...
| Battery | Usable | No-sun reserve (at ~<!-- BEGIN energy:daily-wh-3 -->2,218<!-- END energy:daily-wh-3 --> Wh/day) | With sun |
|---|--:|--:|---|
| **1 pack** (1×100 Ah) | <!-- BEGIN energy:battery-wh-1pack -->1,200<!-- END energy:battery-wh-1pack --> Wh | ~<!-- BEGIN energy:reserve-1pack-day -->0.5<!-- END energy:reserve-1pack-day --> day (≈ 2 prints) | Indefinite (solar-positive) |
