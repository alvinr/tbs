...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$2,831<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,473<!-- END costing:elec-grand-total -->** |
