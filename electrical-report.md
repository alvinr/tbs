...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$2,873<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,515<!-- END costing:elec-grand-total -->** |
