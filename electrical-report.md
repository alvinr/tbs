...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$2,795<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,356<!-- END costing:elec-grand-total -->** |
