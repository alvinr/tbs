...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$2,806<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,448<!-- END costing:elec-grand-total -->** |
