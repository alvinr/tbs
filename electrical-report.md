...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$3,037<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,585<!-- END costing:elec-grand-total -->** |
