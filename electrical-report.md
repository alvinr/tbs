...
Electrical diagrams: [Sheet 1 — System One-Line](assets/electrical-sheet1.png) | [Sheet 2 — Container Wiring Layout](assets/electrical-sheet2.png)
...
See the Python-generated diagrams linked at the top of this document:

- **Sheet 1 — System One-Line Diagram:** complete power flow from solar panels through controller, battery bank, fuse block, and out to each circuit. Wire gauges, fuse ratings, and component models labelled.
- **Sheet 2 — Container Wiring Layout:** top-down floor plan showing all component positions, conduit routes, penetrations, and connection points.
