...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$2,904<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,465<!-- END costing:elec-grand-total -->** |
