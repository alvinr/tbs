...
A representative daylight day of **3 sequential prints** draws **~2,000 Wh** (2 prints ~1,375; 4 prints ~2,620), dominated by the continuous fans + evaporative cooler; the end-of-day Brown/Waste pump-out is gravity-assisted and tiny (~37 Wh).

**Disconnected endurance (no AC charge, solar top-up only): the system is clean-water limited, not power limited.** With sun it is solar-positive (+1,300 Wh/day at 3 prints) → runs **indefinitely on either 1 or 2 packs**; the fresh Blue supply (1,200 L / 121 L net per print) caps a deployment at **~10 prints ≈ 3.3 days @ 3/day**. Battery count sets only the *cloudy-day reserve* (1 pack ≈ 0.6 day, 2 packs ≈ 1.2 day) and the 4-print-day headroom — **not** the deployment length. The Black waste tote (600 L) is a parallel out-flow limit for fully self-contained field use.
