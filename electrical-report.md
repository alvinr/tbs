...
| **Electrical system total** | | | **~<!-- BEGIN costing:elec-system-total -->$3,367<!-- END costing:elec-system-total -->** |
...
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,865<!-- END costing:elec-grand-total -->** |
