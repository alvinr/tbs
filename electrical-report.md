...
| **Shade canopy total** | | | **~<!-- BEGIN costing:elec-canopy-total -->$419<!-- END costing:elec-canopy-total -->** |
| **Cooling (cooler + inverter + DC protection + AC outlet + cord)** | | | **~<!-- BEGIN costing:elec-cooling-total -->$262<!-- END costing:elec-cooling-total -->** |
| **Systems grand total** | | | **~<!-- BEGIN costing:elec-grand-total -->$3,692<!-- END costing:elec-grand-total -->** |
