...
Second view from the film plane wall (Yd = 2362mm), looking toward the pinhole. X axis
...
Optical axis shown from pinhole (X=2946, Y=0) to film plane (Y=2262mm).
...
- **Right walkway** (IBC end): ceiling-hung design — no floor contact. Two 25×25×5mm
  steel angle bearers run full container width (2362mm along Yd) at X=4329mm and
  X=4629mm. Suspended from ceiling corrugations by M10 threaded rod hangers at
  457mm centers (5 pairs — 1st at Yd=320mm, rest at 457mm centers; all at Yd ≤ 2057mm — clear of optical cone). 300mm wide
...
- **Left walkway** (cargo door end): removable lift-out section with no wall brackets.
  ...
  RHS) at X=470 spanning 1762mm between near/far bracket vertical legs; (b) 3
...
**Sheet 3 — External plumbing panel elevation: View from outside the container sealed end wall. 3× 2" NPT bulkhead unions stacked vertically on container centerline — fill port X1 (Blue IBC-1 at 2250mm) above IBC tops for gravity feed (IBC-2 self-levels via 2" cross-connect), drain ports X3 (Brown IBC-3 at 400mm) and X4 (Waste IBC-4 at 200mm) at bottom. Reinforcing plate, camlock fittings, height dimensions**
...
**Sheet 2 — Side elevation (looking along Yd from near wall): Frame depth (1284mm) showing three upright bays at 642mm centers, longitudinal beams at three levels, X-bracing in bottom-tier bays for racking resistance, D-ring positions, access gate outline**
![TBS-001 IBC Frame — Sheet 2: Side Elevation](assets/ibc-frame-sheet2.png)

**Sheet 3 — Plan view at platform level (Z=1060mm): Beam layout in cross-section showing longitudinal corridor beams, transverse cantilever beams, corridor opening, wall bracket positions and bolt pattern, anti-rotation lip perimeter, rubber mat positions. Detail A: typical welded corner joint (≈5:1). Detail B: D-ring lashing point mounting (≈4:1)**
