...
| M8×1.25 × 20 hex bolt, 304 SS (A2-70) — cross-slide joints J1/J2 | J1 (skate carriage → Z-slide) + J2 (X-way → Z-carriage) — 4× M8×20 each, 2 joints/corner ×4 = 32. Threads into the tapped 304 flat-bar slide; flat + split washer, 24 N·m, Loctite 243 (Sheet 8). 304 SS A2-70 (wet cyanotype zone; no chloride → 316 unneeded). SKU + price EST — source the M8×20 304 A2-70 (McMaster 18-8 metric hex, e.g. 91290A-series) at purchase. | 32 ea | McMaster-Carr | $10 |
| M8 flat washer, 304 SS | Flat washer under each J1/J2 M8×20 head (Sheet 8). 304 SS, wet zone. SKU + price EST — confirm at purchase. | 32 ea | McMaster-Carr | $3 |
...
| M4×0.7 hex nut, 304 SS | Plain hex nut under the cam-clamp mount tab — M4×12 bolt-through (2/clamp ×12 = 24). 304 SS, wet zone. Pitch M4×0.7. SKU + price EST — confirm the M4 304 nut at purchase. | 24 ea | McMaster-Carr | $1 |
...
**Estimated materials total (incl. wall-seat saddles): ~<!-- BEGIN costing:film-total -->$4,047<!-- END costing:film-total -->** (the 2 bottom-right saddles move to the walkway's combined corner plates)
