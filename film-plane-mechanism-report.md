...
| 316 flat-bar Z (tilt) + X (swing) cross-slides + UHMW pad + gib | One 2-axis cross-slide stack per corner — 316 flat-bar Z (tilt) + X (swing) slides on UHMW pads with an adjustable gib. FLAT-BAR STOCK: 316 SS ¼"×1½" (6.35×38.1mm); 8 pieces (4× ~250mm Z-tilt + 4× ~260mm X-swing) ≈ 2.05m cut length → order ~2.4m (one 8ft length) to allow kerf + mounting overlap. UHMW pad $23–93/sheet + brass-tip gib separate. Firm at order (est.). | 4 set | Metal Supermarkets / McMaster-Carr | $180–$380 |
...
**Estimated materials total (incl. wall-seat saddles): ~<!-- BEGIN costing:film-total -->$6,173<!-- END costing:film-total -->** (the 2 bottom-right saddles move to the walkway's combined corner plates)
