...
| Ø10 316 SS rod — skate axles (2× 600mm) | Ø10 316 SS rod for the skate axles — 4 per skate × 4 = 16 axles at ~60mm each (spray-skate precedent). Buy 2× 600mm: 60mm tiles into 600 exactly (10 axles/stick, ZERO cut waste) → 20 axles = 16 + 4 spare (best yield of the 200/400/600/800 stock lengths). 316 (not free-machining 303 — its sulfur inclusions corrode in the wet cyanotype zone; axle is cut rod, no machining needed). Pin the McMaster Ø10 316-rod SKU + price at order. | 2 600mm rod | McMaster-Carr | $66–$102 |
