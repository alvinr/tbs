...
| Ø10 316 SS rod — skate axles (6× 200mm) | Ø10 316 SS rod for the skate axles — 4 per skate × 4 = 16 axles at ~60mm each (spray-skate precedent) = ~960mm; sold in 200mm units, so 6 sticks (3 axles/stick + cut waste → 18, covers 16 + 2 spare). 316 (not free-machining 303 — its sulfur inclusions corrode in the wet cyanotype zone; axle is cut rod, no machining needed). Pin the McMaster Ø10 316-rod SKU + price at order. | 6 200mm rod | McMaster-Carr | $66–$102 |
