...
| [Dibond ACM panel 4mm (black)](https://www.grimco.com/catalog/products/maxmetal) (MAXMETAL) | 4 ft × 8 ft black ACM sheets — single rigid backing, <!-- BEGIN fact:film_plane_width_mm -->4,499<!-- END fact:film_plane_width_mm -->×<!-- BEGIN fact:film_plane_height_mm -->2,094<!-- END fact:film_plane_height_mm -->mm. Grimco MAXMETAL 4mm 48×96 (account-gated ~$45–75, SoCal pickup) or Curbell DIBOND Jet Black 4mm (~$80–110); confirm TRUE 4mm black is stocked (3mm/6mm are the common black thicknesses). Central Coast Plastics does cut-to-size. | 6 sheet | Grimco / Curbell / Central Coast Plastics | $300–$510 |
