...
| Mild steel plate 8mm (laser/plasma cut + welded) | ICP-11: per saddle = back-plate 150×200 + exterior plate 150×200 + gusset triangle 200×110 (all 8mm A36) + seat 150×110 (10mm A36); A36 mild steel (Alvin 2026-07-21); ~21 kg over 6 saddles. CUT-FROM: 8mm sheet 610×760mm (24×30in) nests all 12 back/exterior plates + 6 gussets (from 3× 200×110); 10mm sheet 610×254mm (24×10in) nests the 6 seats. Plus laser/plasma cut + weld — get a fab quote (the $53/saddle est covers material + fab). | 6 ea | Metal Supermarkets / Online Metals | $318 |
