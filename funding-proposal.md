...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$35,357<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,383 |
...
| Contingency (10%) | ~$3,210 |
| **Level 1 total** | **~$35,357** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$38,382–43,107<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
