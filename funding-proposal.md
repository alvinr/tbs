...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,627<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,568 |
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,502 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,652–42,377<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
