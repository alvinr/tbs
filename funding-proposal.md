...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,576<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,427 |
| Tilt-swing front board mechanism | $1,470 |
| Housed revolving-door light trap (plastic-skin Ø900 housing + C-shell drum, bearings, seals, fabrication) | $2,093 |
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,675 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,873 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,601–42,326<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
