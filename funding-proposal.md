...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,364<!-- END costing:fund-l1-total -->, Standard scenario)
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,389–42,114<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
