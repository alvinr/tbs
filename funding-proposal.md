...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,716<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,557 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,650 |
...
| Panel swing pivot + fixed door frame (Ø89 post + bearings + cage + wall stays + door frame) | $1,239 |
| Hinged panel structure (stepped frame + PP skins + Al core + EPDM + latches + B2 bay + handle) | $1,418 |
| Chemistry prep shelf (fold-down board + frame + hinge/stays + tap trunk extension) | $218 |
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,490 |
| Contingency (10%) | ~$3,160 |
| **Level 1 total** | **~$34,716** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,741–42,466<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
