...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$31,301<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner Option A, manual actuation) | $3,548 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$34,651–38,101<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
