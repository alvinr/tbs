...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,200<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,148 |
...
| Chemistry prep shelf (fold-down board + frame + hinge/stays + tap trunk extension) | $235 |
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,710 |
| Contingency (10%) | ~$3,290 |
| **Level 1 total** | **~$36,200** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,225–43,950<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
