...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,849<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$26,000–$40,000<!-- END costing:fund-scenario-span -->.

<!-- BEGIN costing:funding-level1 -->
| Item | Cost |
|------|------|
| 20ft container (Cargo Worthy grade) + delivery | $3,300 |
| Interior conversion (light-seal, paint, image-plane backing) | $1,128 |
| Pinhole plate (precision laser-drilled, SS-302, interchangeable frame) | $185 |
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,569 |
| Tilt-swing front board mechanism | $1,470 |
| Housed revolving-door light trap (plastic-skin Ø900 housing + C-shell drum, bearings, seals, fabrication) | $1,773 |
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,738 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,831 |
| Ventilation & cooling (2 fans · evap cooler + 12V→120V inverter · light-safe ducting) | $817 |
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,529 |
| Panel swing pivot + fixed door frame (Ø89 post + bearings + cage + wall stays + door frame) | $1,219 |
...
| Contingency (10%) | ~$3,170 |
| **Level 1 total** | **~$34,849** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,874–42,599<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
