...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$29,492<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$21,000–$35,000<!-- END costing:fund-scenario-span -->.
...
| Film plane mechanism (4-corner Option A, manual actuation) | $3,678 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $5,207 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,350 |
...
| Contingency (10%) | ~$2,680 |
| **Level 1 total** | **~$29,492** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$32,842–36,292<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
