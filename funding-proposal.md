...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$38,073<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$30,000–$41,000<!-- END costing:fund-scenario-span -->.
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,178 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$41,098–45,823<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
