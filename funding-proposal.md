...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$33,964<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,175 |
...
| Contingency (10%) | ~$3,090 |
| **Level 1 total** | **~$33,964** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$36,989–41,714<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
