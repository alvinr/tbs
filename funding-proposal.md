...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$35,841<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Housed revolving-door light trap (plastic-skin Ø800 housing + C-shell drum, bearings, seals, fabrication) | $3,582 |
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,507 |
...
| Contingency (10%) | ~$3,260 |
| **Level 1 total** | **~$35,841** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$38,866–43,591<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
