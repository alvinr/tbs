...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,073<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Interior conversion (light-seal, paint, ventilation, door) | $573 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,073 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $3,011 |
| Ventilation & cooling (2 fans · evap cooler + 12V→120V inverter · light-safe ducting) | $831 |
...
| Chemistry prep shelf (fold-down board + frame + hinge/stays + tap trunk extension) | $241 |
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,710 |
| Contingency (10%) | ~$3,280 |
| **Level 1 total** | **~$36,073** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,098–43,823<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
