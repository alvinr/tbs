...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$35,628<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Belden U-joint) | $4,287 |
| Tilt-swing front board mechanism | $1,470 |
| Housed revolving-door light trap (plastic-skin Ø800 housing + C-shell drum, bearings, seals, fabrication) | $3,466 |
...
| Panel swing pivot + fixed door frame (Ø89 post + bearings + cage + wall stays + door frame) | $1,490 |
...
| Contingency (10%) | ~$3,240 |
| **Level 1 total** | **~$35,628** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$38,653–43,378<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
