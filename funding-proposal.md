...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$33,833<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $4,587 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,051 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $3,386 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$36,858–41,583<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
