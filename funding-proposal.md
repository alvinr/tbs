...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,685<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Chemistry prep shelf (fold-down board + frame + hinge/stays + tap trunk extension) | $223 |
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,490 |
| Contingency (10%) | ~$3,150 |
| **Level 1 total** | **~$34,685** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,710–42,435<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
