...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,530<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,428 |
...
| Contingency (10%) | ~$3,320 |
| **Level 1 total** | **~$36,530** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,555–44,280<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
