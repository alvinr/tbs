...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,595<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $3,242 |
...
| Contingency (10%) | ~$3,330 |
| **Level 1 total** | **~$36,595** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,620–44,345<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
