...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$35,630<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,472 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$38,655–43,380<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
