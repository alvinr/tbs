...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$33,237<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,093 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$36,262–40,987<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
