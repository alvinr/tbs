...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,959<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,276 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,984–42,709<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
