...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,852<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,572 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,877–42,602<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
