...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$35,661<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Chemistry prep shelf (fold-down board + frame + hinge/stays + tap trunk extension) | $230 |
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,710 |
| Contingency (10%) | ~$3,240 |
| **Level 1 total** | **~$35,661** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$38,686–43,411<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
