...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,830<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$26,000–$39,000<!-- END costing:fund-scenario-span -->.
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,212 |
...
| Panel swing pivot + fixed door frame (Ø89 post + bearings + cage + wall stays + door frame) | $1,557 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,855–42,580<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
