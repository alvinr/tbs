...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,322<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,341 |
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,593 |
...
| Contingency (10%) | ~$3,120 |
| **Level 1 total** | **~$34,322** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,347–42,072<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
