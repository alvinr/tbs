...
## 1. The Hook
A standard shipping container sits in a field. Inside, on 104 square feet of cotton fabric, a cyanotype image is forming. The image will be approximately 15 feet wide and 7 feet tall. The people who made it will wade into the image to develop it.
...
### What
TBS-001 is a 20-foot ISO shipping container converted into a functional large-format pinhole camera. The pinhole (<!-- BEGIN fact:pinhole_diameter_mm -->2.17<!-- END fact:pinhole_diameter_mm -->mm, precision laser-drilled, stainless steel) sits at one side of the container. The image plane — a stretched cotton muslin surface spanning the active <!-- BEGIN fact:film_plane_width_mm -->4,499<!-- END fact:film_plane_width_mm --> × <!-- BEGIN fact:film_plane_height_mm -->2,138<!-- END fact:film_plane_height_mm -->mm film zone — sits at the other. Every exposure produces a latent cyanotype image on approximately 104 square feet of fabric, developed in plain water.
...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$33,176<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$24,000–$38,000<!-- END costing:fund-scenario-span -->.
...
| Film plane mechanism (4-corner Option A, manual actuation) | $5,253 |
...
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $1,520 |
| Contingency (10%) | ~$3,020 |
| **Level 1 total** | **~$33,176** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$36,526–39,976<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
...
50 cyanotype prints on cotton muslin, each approximately <!-- BEGIN fact:film_plane_width_mm -->4,499<!-- END fact:film_plane_width_mm --> × <!-- BEGIN fact:film_plane_height_mm -->2,138<!-- END fact:film_plane_height_mm -->mm (~14'9" × 7'0"). Numbered, signed, with full exposure metadata. Available for acquisition by institutions and private collectors.
