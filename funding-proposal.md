...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,495<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,393 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,520–44,245<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
