...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,834<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,965 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,690 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,859–42,584<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
