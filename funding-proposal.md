...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$33,462<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Belden U-joint) | $3,931 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$36,487–41,212<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
