...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$36,370<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$29,000–$40,000<!-- END costing:fund-scenario-span -->.
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,440 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,278 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $3,037 |
| Ventilation & cooling (2 fans · evap cooler + 12V→120V inverter · light-safe ducting) | $847 |
...
| Contingency (10%) | ~$3,310 |
| **Level 1 total** | **~$36,370** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$39,395–44,120<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
