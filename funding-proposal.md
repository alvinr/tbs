...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$37,688<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$29,000–$41,000<!-- END costing:fund-scenario-span -->.
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,823 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,958 |
| Ventilation & cooling (2 fans · evap cooler + 12V→120V inverter · light-safe ducting) | $797 |
| Perimeter walkway (4 sections + drum-exit punch-out) | $4,481 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$40,713–45,438<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
