...
Per-print cost: approximately <!-- BEGIN costing:fund-perprint -->$88<!-- END costing:fund-perprint --> (chemistry + fabric + water) at the Standard sensitizer strength — ranging <!-- BEGIN costing:fund-perprint-range -->$61–170<!-- END costing:fund-perprint-range --> by tier, to be pinned by post-build sensitizer trials. A 50-print run costs approximately <!-- BEGIN costing:fund-50run -->$4,410<!-- END costing:fund-50run -->. By comparison, the next cheapest alternative (gum bichromate) costs ~$49 per print and depends on bulk dichromate as its primary sensitizer, with full hazmat handling and disposal.
...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$38,463<!-- END costing:fund-l1-total -->, Standard scenario)
Everything required to operate the camera for a first deployment. Figures are the Standard (Mid) column of the [cost breakdown](project-cost-breakdown.md); Low–High scenarios span ~<!-- BEGIN costing:fund-scenario-span -->$29,000–$45,000<!-- END costing:fund-scenario-span -->.

<!-- BEGIN costing:funding-level1 -->
| Item | Cost |
|------|------|
| 20ft container (Cargo Worthy grade) + delivery | $3,300 |
| Interior conversion (light-seal, paint, ventilation, door) | $578 |
| Pinhole plate (precision laser-drilled, SS-302, interchangeable frame) | $155 |
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,368 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,916 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,795 |
...
| Cyanotype chemistry + muslin substrate (50-print run, Standard tier) | $4,410 |
| Contingency (10%) | ~$3,500 |
| **Level 1 total** | **~$38,463** |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$41,488–46,213<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
