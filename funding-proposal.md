...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,062<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Belden U-joint) | $4,471 |
...
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $7,188 |
...
| Perimeter walkway (4 sections + drum-exit punch-out) | $2,505 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,087–41,812<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
