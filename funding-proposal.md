...
### Level 1 — Core Build (~<!-- BEGIN costing:fund-l1-total -->$34,445<!-- END costing:fund-l1-total -->, Standard scenario)
...
| Film plane mechanism (4-corner U-channel + acetal skate + Ruland U-joint) | $6,107 |
| Tilt-swing front board mechanism | $1,470 |
| Housed revolving-door light trap (plastic-skin Ø900 housing + C-shell drum, bearings, seals, fabrication) | $1,770 |
| Processing water system (tray, spray bar, 3-stage filtration, IBC stacking frame) | $6,709 |
| Power & electrical (600W solar · LiFePO4 · MPPT · distribution · protection · lighting) | $2,811 |
...
**Combined (Levels 1+2+3):** ~<!-- BEGIN costing:fund-combined -->$37,470–42,195<!-- END costing:fund-combined --> for a complete first-year program with three public deployments, 50-print edition, and full documentation.
