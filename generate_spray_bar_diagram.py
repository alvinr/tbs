...
def draw_sheet2():
    ...
    # ── U-clamp cradle under beam (carriage bolted below) ──────────────
    ...
    # Flared feet (extend outward at bottom, rest on plate top)
    ...
    # Bolts through U-clamp feet and plate, wing nuts below
    ...
    bj_yd = (c_beam_r + UC_GAP + UC_T + plate_yd_r) / 2
    ...
    cs_notes = [
        ...
        f"1. U-clamp cradles beam from below.",
        "2. Carriage plate bolted to U-clamp underside, forks to wheels.",
