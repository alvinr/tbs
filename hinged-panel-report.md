...
pivot post** (the reused film-plane far-left upright at the far panel edge). The swing carries
...
The apron **hinge line** is light-sealed by a fixed 3mm-steel **lapping board** off the sill — an
exterior daylight baffle standing over the piano hinge — plus a 10mm closed-cell **foam strip** the
apron compresses when up, with the hinge knuckle inboard of the lap (**Sheet 16 Detail F**).
...
| Item | Spec | Qty | Supplier | Est. cost |
|------|------|-----|----------|-----------|
| [3/16" UV-stab HDPE sheet, black — 48×96 (×3)](https://www.usplastic.com/catalog/item.aspx?itemid=136962&catid=705) (46685) | Ø800 fixed housing shell (~56 ft², ~2,062mm tall — spans beam-to-beam), rolled + extrusion-welded from 3× 4×8 ft 3/16" (≈5mm) UV-stab HDPE sheets — the 99" circumference needs 3× 48" sheet widths (2 fall ~15" short). ~33% offcut on the 3rd sheet; a 5×10 ft sheet would cut to 2 (optimize at order). US Plastics 46685 $184.99/sheet. | 3 sheet | US Plastics / TAP Plastics | $555 |
| [1/8" black HDPE sheet — 48×96 (×3)](https://www.usplastic.com/catalog/item.aspx?itemid=136961&catid=705) (46684) | Ø764 revolving drum shell (~49 ft², ~1,890mm tall) — rolled + extrusion-welded 1/8" HDPE (94.5" circ needs 3× 48" widths). A light-tight cover over the steel/Al structure; its 1/8" is non-structural (lighter = easier revolve, less bearing load). The 2 end caps are now 8mm 6061-T6 ALUMINUM (ll-caps-al) — NOT HDPE — since they carry the stub-shaft hubs into the SKF 6215 bearings. US Plastics 46684 $123.34/sheet. | 3 sheet | US Plastics / TAP Plastics | $370 |
...
| [1/8" 18-8 SS multigrip blind rivets — shell→cap lap (100-pack)](https://www.mcmaster.com/97525A420/) (97525A420) | Shell→cap lap rivets (~35/cap ×2 ≈ 70 → 1 pack of 100). 1/8" (Ø3.18) 18-8 SS multigrip low-profile head, drill #30 (Ø3.3). 97525A420 is ONE multigrip SKU consolidating the former shell/rim (0.188–0.25") + housing/surround (0.313–0.375") grip pair — its range spans both the ~6mm and ~8–9.5mm laps (per the 97525A420 datasheet). Wet in DP8010 for light-tightness. $12.59/100 firm (2026-09-07). | 1 pack-100 | McMaster-Carr | $13 |
| [1/8" 18-8 SS multigrip blind rivets — housing→frame lap (100-pack)](https://www.mcmaster.com/97525A420/) (97525A420) | Housing→frame lap rivets (~26/edge ×2 ≈ 52 → 1 pack of 100). 1/8" (Ø3.18) 18-8 SS multigrip, drill #30. Same one multigrip SKU 97525A420 as the shell/rim laps (spans the 0.313–0.375" housing grip and the thinner shell/rim laps). $12.59/100. | 1 pack-100 | McMaster-Carr | $13 |
...
| Item | Spec | Qty | Supplier | Est. cost |
|------|------|-----|----------|-----------|
| 50×20×3 RHS (6 m bulk lengths) | Frame members — 50×20×3 RHS (50mm FACE = the seal landing, 20mm depth). REUSES the IBC retaining-bar section (ibcf-rhs, 50×20×3) so it needs no bespoke order. Non-weight-bearing (the pivot post carries the hinge panel) — the frame only takes seal-compression + cam-latch load. | 3 ea | Metal Supermarkets | $90–$120 |
...
|----------|------------|--------------|
| Panel structure (incl. B2 bay + pull handle) | <!-- BEGIN costing:hp-panel-low -->$1,320<!-- END costing:hp-panel-low --> | <!-- BEGIN costing:hp-panel-high -->$1,533<!-- END costing:hp-panel-high --> |
| Housing + drum (plastic skin) | <!-- BEGIN costing:hp-housing-low -->$2,944<!-- END costing:hp-housing-low --> | <!-- BEGIN costing:hp-housing-high -->$3,985<!-- END costing:hp-housing-high --> |
...
| **Total** | **<!-- BEGIN costing:hp-total-low -->$5,514<!-- END costing:hp-total-low -->** | **<!-- BEGIN costing:hp-total-high -->$7,248<!-- END costing:hp-total-high -->** |
