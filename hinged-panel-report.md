...
| Housing + drum (plastic skin) | <!-- BEGIN costing:hp-housing-low -->$2,977<!-- END costing:hp-housing-low --> | <!-- BEGIN costing:hp-housing-high -->$3,998<!-- END costing:hp-housing-high --> |
...
| **Total** | **<!-- BEGIN costing:hp-total-low -->$5,435<!-- END costing:hp-total-low -->** | **<!-- BEGIN costing:hp-total-high -->$7,092<!-- END costing:hp-total-high -->** |
