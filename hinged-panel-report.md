...
| [1/8" black HDPE sheet — 48×96 (×3)](https://www.usplastic.com/catalog/item.aspx?itemid=136961&catid=705) (46684) | Ø864 revolving drum shell (~65 ft²) + 2 end caps from the 3rd-sheet offcut — rolled + extrusion-welded. 1/8" HDPE is nearest stock to the 4mm LT_DRUM_T nominal AND weld-compatible with the 3/16" HDPE housing (46685); the skin is a light-tight cover over the steel shaft + caps + edge-stiffening, so the 0.8mm is non-structural (and lighter = easier revolve, less bearing load). 106.9" circ needs 3× 48" widths. US Plastics 46684 $123.34/sheet. | 3 sheet | US Plastics / TAP Plastics | $370 |
