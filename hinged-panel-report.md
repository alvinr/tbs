...
| Housing + drum (plastic skin) | <!-- BEGIN costing:hp-housing-low -->$2,964<!-- END costing:hp-housing-low --> | <!-- BEGIN costing:hp-housing-high -->$3,985<!-- END costing:hp-housing-high --> |
...
| **Total** | **<!-- BEGIN costing:hp-total-low -->$5,422<!-- END costing:hp-total-low -->** | **<!-- BEGIN costing:hp-total-high -->$7,079<!-- END costing:hp-total-high -->** |
