...
| Housing + drum (plastic skin) | <!-- BEGIN costing:hp-housing-low -->$2,958<!-- END costing:hp-housing-low --> | <!-- BEGIN costing:hp-housing-high -->$3,983<!-- END costing:hp-housing-high --> |
...
| **Total** | **<!-- BEGIN costing:hp-total-low -->$5,416<!-- END costing:hp-total-low -->** | **<!-- BEGIN costing:hp-total-high -->$7,077<!-- END costing:hp-total-high -->** |
