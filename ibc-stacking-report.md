...
| J4 | Rear panel → welded L-bracket upstand (off the back upright) | M8 hex into captive 5/16 tee-nut in the ply | zinc | 6 brackets | snug + locker (light static load) | flat washer under head | thread-locker |
