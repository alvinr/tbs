...
This is the collecting area. Every photon contributing to the image at any point on the <!-- BEGIN fact:image_area_sqft -->99<!-- END fact:image_area_sqft --> sq ft image plane has passed through this 3.70mm² opening. No others.
...
- **Pinhole mode:** The full <!-- BEGIN fact:image_area_sqft -->99<!-- END fact:image_area_sqft --> sq ft image plane records everything in the field of view, all at the same soft resolution, with 43-minute exposures. Best for scenes that do not move — landscapes, architecture, long-duration light painting.
