...
| Approximate cost | USD <!-- BEGIN costing:hp-housing-low -->$2,046<!-- END costing:hp-housing-low -->–<!-- BEGIN costing:hp-housing-high -->$2,516<!-- END costing:hp-housing-high --> (local plastic fabrication shop) |
| Lead time | 2–3 weeks |
...
| Item | Specification |
|------|--------------|
| Entry handle | 100mm Ø × 400mm SS round grab rail, interior face only, at 900mm height — welded to a steel standoff that is **structural-bonded (3M DP8010) to an extrusion-welded HDPE reinforcement pad**; no fastener pierces the drum wall (no through-hole, no light leak). Mount detail on §9 Sheet 1 |
...
**Total custom housing + drum estimate: <!-- BEGIN costing:hp-housing-low -->$2,046<!-- END costing:hp-housing-low -->–<!-- BEGIN costing:hp-housing-high -->$2,516<!-- END costing:hp-housing-high -->** — priced line-item BOM in the [Project Cost Breakdown](project-cost-breakdown.md) §6 and [Hinged Panel Report](hinged-panel-report.md) §8.2.
...
| Price (USD) | $2,500–$3,500 | $3,000–$4,500 | **<!-- BEGIN costing:hp-housing-low -->$2,046<!-- END costing:hp-housing-low -->–<!-- BEGIN costing:hp-housing-high -->$2,516<!-- END costing:hp-housing-high -->** |
...
- The drum rotates freely in both directions; there is no rotation limit. The exterior face carries no handle — the operator pushes the bare drum wall to enter. An interior grab rail (100mm Ø SS on a steel standoff **structural-bonded with DP8010 to an extrusion-welded HDPE pad** — no fastener through the wall) at 900mm height allows the operator to pull the drum closed from inside and brace during exit. This eliminates any through-bolt penetration of the drum wall on the exterior face, removing a potential light leak path.
