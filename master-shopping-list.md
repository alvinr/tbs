...
| 7. Housed revolving-door light lock (plastic-skin custom fabrication) | $2,953 | $3,984 |
...
| **TOTAL (base build + 50-print run)** | **~$27,489** | **~$36,274** |
...
| Bearing retaining rings — DIN 471 (inner) + DIN 472 (outer, upper) | 1 lot | McMaster-Carr | lightlock | $8–$15 |
...
| **fasteners-hardware subtotal** | | | | **$1,838–$2,168** |
...
| McMaster-Carr | 57 | adhesives-finishes, aluminum, bearings-motion, fasteners-hardware, seals-gaskets, steel-structural | $1,555–$1,572 |
