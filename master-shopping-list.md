...
| 4. Film plane mechanism (4-corner U-channel + acetal skate + 316 cross-slide + U-joint, incl. wall-seat saddles) | $5,741 | $6,307 |
...
| **TOTAL (base build + 50-print run)** | **~$25,057** | **~$35,406** |
