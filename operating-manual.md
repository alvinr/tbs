...
- [ ] 2.5.2 — **First pass:** roll horizontally from left to right across the full width of the muslin. Even strokes, 50% overlap. Work top to bottom.
- [ ] 2.5.3 — **Second pass:** roll vertically, top to bottom. Cross-direction ensures even coverage.
...
- [ ] 5.5.4 — Carry the cooler in through the door opening (~20 kg, one person). Place on a ply base plate on the near-walkway wide section at X=1200–1800mm. Secure with 2× ratchet straps to the wall brackets. Stow the flex duct alongside.
