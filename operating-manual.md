...
- [ ] 5.5.3 — Swing panel closed (do not latch).
- [ ] 5.5.4 — Release 2 Destaco toggle clamps at operational position.
- [ ] 5.5.5 — Push panel inward 300mm on HGR20 rails. Carriage contacts transport end stops.
- [ ] 5.5.6 — Engage 2 Destaco toggle clamps at transport position.
- [ ] 5.5.7 — Close and latch standard ISO container cargo doors.
...
- [ ] 5.6.4 — Swing panel open 180°.
- [ ] 5.6.5 — Swing panel closed. Engage all 4 Southco cam latches.
- [ ] 5.6.6 — Perform dark-adaptation check (Phase 1.3, step 1.3.4).
