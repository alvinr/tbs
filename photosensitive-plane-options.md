...
Covering a 140 sq ft photosensitive plane is not a solved problem in commercial photography. Every process listed below has been documented at large scale or can be extrapolated from known chemistry; costs are calculated per image for the full 140 sq ft surface including chemistry, substrate where applicable, and processing. All chemistry listed under historic/alternative processes can be sourced and mixed in a home or garage darkroom from commercially available reagents.
...
| Substrate | Cost per sq ft | Total (140 sq ft) | Notes |
|---|---|---|---|
...
2. **Cut panels** to slightly oversize (e.g., 5,950 × 2,450 mm). For full coverage, one continuous roll of 60" (1,524 mm) wide muslin folded/overlapped at join, or two lengths of 120" wide drop cloth fabric joined with a single flat seam at centre.
...
**Silver nitrate requirement:** ~5–10 ml of 12% solution per sq ft = 700–1,400 ml total. At 12% concentration: 84–168 g of AgNO₃.

| Reagent | Quantity | Unit cost | Subtotal |
|---|---|---|---|
| Silver nitrate (AgNO₃) | 100–170 g | ~$260/100 g (Chem-Impex) | **$260–$442** |
| Sodium chloride (table salt) | 100–200 g | Negligible (~$1) | ~$1 |
...
| Cotton muslin/canvas (140 sq ft) | ~$80–100 |
| **Total** | **~$350–$450** |
...
| Reagent | Quantity | Unit cost | Subtotal |
|---|---|---|---|
| Silver nitrate | 30–60 g (single/double coat) | ~$260/100 g | ~$78–$156 |
| Ferric ammonium citrate | 70–100 g | ~$15/100 g | ~$15–$20 |
| Tartaric acid | 7–10 g | ~$8–12/100 g | ~$5 |
| Sodium thiosulfate | 500 g | ~$5/kg | ~$3 |
| **Chemistry total** | | | **~$100–$185** |
...
### Processing Chemistry (140 sq ft)
...
1. **Accept seam lines** as a design feature — horizontal bands visible at 1,270 mm intervals across width.
...
1. Pre-cut five strips to 2,450 mm (allowing overlap/trim) in complete darkness or under dark cloth in a light-tight changing tent.
...
3. Butt strips together or overlap by 10 mm. Tape reverse side seams with 2" black photographic tape.
...
For 140 sq ft at 1.5 sq ft/oz (single coat): **~94 oz required**.  
...
| Substrate | Aesthetic | Cost per sq ft | Total (140 sq ft) |
|---|---|---|---|
...
| Item | Cost |
|---|---|
| Liquid Light emulsion (double coat, ~188 oz) | ~$590–705 |
| Substrate (reclaimed wood — near free) | ~$0–50 |
...
| Spec | Value |
|---|---|
| Available sizes | Up to 14"×17" (355×432 mm) standard medical; industrial film to 36"×48" (914×1219 mm) and larger |
...
At approximately $5–8 per 14"×17" sheet, covering 140 sq ft would require roughly 150–200 sheets depending on layout, at a material cost of $750–$1,600. Large-format industrial X-ray film in continuous rolls is available from medical/NDT suppliers, but ordering in custom widths is typical.
...
X-ray film is double-coated — emulsion on both sides. Wet processing produces a dimensionally stable but somewhat delicate large sheet. Handling and tiling 150+ sheets in complete darkness is a significant operational challenge. A continuous roll format would be far preferable but difficult to source. **For this reason X-ray film is rated as viable but operationally complex.**
...
Covering 140 sq ft with photographic film at any standard format produces costs that are an order of magnitude higher than paper-based options:

| Format | Sheets needed | Cost/sheet | Material cost |
|---|---|---|---|
| 8×10 in | ~350 sheets | $8–15 (Ilford HP5/FP4) | $2,800–$5,250 |
| 11×14 in | ~170 sheets | $15–25 | $2,550–$4,250 |
| 20×24 in | ~60 sheets | $40–80 (specialty) | $2,400–$4,800 |
...
Film is included here for completeness and to confirm the user's instinct: **film is categorically the wrong medium for a 140 sq ft image plane**, both on cost and operational grounds.
...
**Aluminium Composite Material (ACM / Dibond) panels, 3 mm thick:**
- Available in 4×8 ft (1,220×2,440 mm) sheets; approximately 18 sheets needed to tile 140 sq ft
...
**Practical implication: gum bichromate is not viable as a primary in-camera process at f/1088.** At 8–17 hours, a single exposure spans daylight, sunset, and astronomical darkness — the illumination changes are uncontrollable and the accumulated exposure across the full period would be chaotic. Gum bichromate is retained in this report because it is an excellent option for contact printing from a negative made on one of the faster materials, and because a larger pinhole (reducing the f-number) could bring exposure times into range. At f/300 (achievable with a ~8 mm pinhole), ISO 0.5 gum bichromate would require ~40 minutes — fully workable, though at the cost of a larger blur circle.
