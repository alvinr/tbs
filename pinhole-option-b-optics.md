...
| Image plane height | <!-- BEGIN fact:film_plane_height_mm -->2,138<!-- END fact:film_plane_height_mm -->mm (7 ft 10 in) | Container interior height |
...
The image plane is <!-- BEGIN fact:container_interior_length_mm -->5,893<!-- END fact:container_interior_length_mm -->mm wide × <!-- BEGIN fact:film_plane_height_mm -->2,138<!-- END fact:film_plane_height_mm -->mm tall. For a given subject distance, the portion of the real world captured within that frame is:
...
For a person 1.8 m (71 inches) tall to fit within the 2,138mm image height:

```
1,800 × M ≤ 2,138
1,800 × (2362/u) ≤ 2,138
u ≥ 1,800 × 2362 / 2138
u ≥ 1989mm ≈ 1.99 m (6.5 ft)
```

For a vehicle 4.5 m tall (truck/bus) to fit in frame:

```
u ≥ 4,500 × 2362/2138 ≈ 4972mm ≈ 4.97 m (16.3 ft)
```

For a building 10 m tall to fit in frame:

```
u ≥ 10,000 × 2362/2138 ≈ 11048mm ≈ 11.0 m (36.2 ft)
```
