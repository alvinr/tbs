...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $6,098 | $6,572 | $7,046 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,765** | **$31,752** | **$39,616** |
...
| Clamp mounting — M5×16 SS csk screws (×176) + Nylocks (×176) + neoprene pad strip | $129 | $129 | $129 |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$6,098** | **$6,572** | **$7,046** |
<!-- END costing:film -->
...
| Pinhole plate | $110 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $6,098 |
...
| Pinhole plate | $185 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $6,572 |
...
| **Scenario B total (excl. CDL)** | **~$32,062** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,162 |
...
| **Scenario C total** | **~$120,662–$150,662** |
