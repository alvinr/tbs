...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,977 | $3,489 | $3,998 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,563** | **$32,362** | **$39,228** |
...
| **Housing + drum total** | **$2,977** | **$3,489** | **$3,998** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,977 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $3,489 |
...
| **Scenario B total (excl. CDL)** | **~$32,672** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,772 |
...
| **Scenario C total** | **~$121,272–$151,272** |
