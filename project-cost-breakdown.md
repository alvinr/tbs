...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,311** | **$32,913** | **$39,568** |
...
| **Scenario B total (excl. CDL)** | **~$33,223** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,323 |
...
| **Scenario C total** | **~$121,823–$151,823** |
