...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,948 | $3,470 | $3,989 |
...
| **6d. Chemistry prep shelf (fold-down phenolic board + steel frame + hinge/stays + TAP-01 trunk extension)** | $223 | $230 | $237 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,627** | **$32,491** | **$39,419** |
...
| **Housing + drum total** | **$2,948** | **$3,470** | **$3,989** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,948 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $3,470 |
...
| Chemistry prep shelf (fold-down board + tap trunk extension) | $230 |
...
| **Scenario B total (excl. CDL)** | **~$32,801** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,901 |
...
| **Scenario C total** | **~$121,401–$151,401** |
