...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $4,258 | $5,300 | $6,335 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$21,288** | **$26,981** | **$34,742** |
...
| Valves and fittings (incl. S60×6 adapters, check valves CV1/CV3/CV4) | $345 | $591 |
...
| **Water system total** | **$4,258** | **$6,335** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $4,258 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $5,300 |
...
| **Scenario B total (excl. CDL)** | **~$27,291** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $26,391 |
...
| **Scenario C total** | **~$115,891–$145,891** |
