...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $6,097 | $6,571 | $7,045 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,496** | **$31,536** | **$39,452** |
...
| Saddle fasteners — M12 through-bolts (×28) + M8 thumbscrews (×12) + M8 hex bolts (×8) | $112 | $112 | $112 |
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$6,097** | **$6,571** | **$7,045** |
<!-- END costing:film -->
...
| Pinhole plate | $110 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $6,097 |
...
| Pinhole plate | $185 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $6,571 |
...
| **Scenario B total (excl. CDL)** | **~$31,846** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,946 |
...
| **Scenario C total** | **~$120,446–$150,446** |
