...
| **TOTAL (excl. own transport, CDL, lens)** | **$21,201** | **$26,888** | **$34,643** |
...
| Valves and fittings (incl. S60×6 adapters, check valves CV1/CV3/CV4) | $333 | $567 |
...
| **Water system total** | **$4,171** | **$6,236** |
<!-- END costing:water -->
...
| **Scenario B total (excl. CDL)** | **~$27,198** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $26,298 |
...
| **Scenario C total** | **~$115,798–$145,798** |
