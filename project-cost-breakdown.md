...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,257 | $7,070 | $7,920 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,096** | **$32,851** | **$39,696** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,003 | $1,061 |
...
| **Water system total** | **$6,257** | **$7,920** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,257 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,070 |
...
| **Scenario B total (excl. CDL)** | **~$33,161** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,261 |
...
| **Scenario C total** | **~$121,761–$151,761** |
