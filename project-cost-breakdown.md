...
| **6c. Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + cam latches + B2 bay + pull handle)** | $1,261 | $1,377 | $1,491 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,921** | **$30,511** | **$37,151** |
...
| Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay + handle) | $1,261 |
...
| Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay + handle) | $1,377 |
...
| **Scenario B total (excl. CDL)** | **~$30,821** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,921 |
...
| **Scenario C total** | **~$119,421–$149,421** |
