...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,222** | **$30,815** | **$37,458** |
...
| **Scenario B total (excl. CDL)** | **~$31,125** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,225 |
...
| **Scenario C total** | **~$119,725–$149,725** |
