...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $4,328 | $4,596 | $4,866 |
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,412 | $7,045 | $7,679 |
| **5a. Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)** | $3,024 | $3,071 | $3,119 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,953** | **$30,550** | **$37,199** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$4,328** | **$4,596** | **$4,866** |
<!-- END costing:film -->
...
| Pinhole plate | $100 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $4,328 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,412 |
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,024 |
...
| Pinhole plate | $155 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $4,596 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,045 |
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,071 |
...
| **Scenario B total (excl. CDL)** | **~$30,860** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,960 |
...
| **Scenario C total** | **~$119,460–$149,460** |
