...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,476** | **$31,053** | **$37,682** |
...
| **Scenario B total (excl. CDL)** | **~$31,363** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,463 |
...
| **Scenario C total** | **~$119,963–$149,963** |
