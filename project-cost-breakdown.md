...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,521 | $7,093 | $7,672 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,835** | **$30,287** | **$36,795** |
...
| Pumps and accumulator (P-01, P-02, P-04 manifold + P-03, P-05 IBC corridor) | $572 | $572 |
...
| **Water system total** | **$6,521** | **$7,672** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,521 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,093 |
...
| **Scenario B total (excl. CDL)** | **~$30,597** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,697 |
...
| **Scenario C total** | **~$119,197–$149,197** |
