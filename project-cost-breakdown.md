...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,696 | $7,315 | $7,943 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,655** | **$31,158** | **$37,731** |
...
| IBC stacking frame (2×2×0.120in restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,175 | $1,709 |
...
| **Water system total** | **$6,696** | **$7,943** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,696 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,315 |
...
| **Scenario B total (excl. CDL)** | **~$31,468** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,568 |
...
| **Scenario C total** | **~$120,068–$150,068** |
