...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $5,738 | $6,810 | $7,878 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,089** | **$32,979** | **$39,743** |
...
| **Water system total** | **$5,738** | **$7,878** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,810 |
...
| **Scenario B total (excl. CDL)** | **~$33,289** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,389 |
...
| **Scenario C total** | **~$121,889–$151,889** |
