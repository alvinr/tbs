...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,310 | $7,205 | $8,094 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,042** | **$32,935** | **$39,875** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,066 | $1,172 |
...
| **Water system total** | **$6,310** | **$8,094** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,310 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,205 |
...
| **Scenario B total (excl. CDL)** | **~$33,245** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,345 |
...
| **Scenario C total** | **~$121,845–$151,845** |
