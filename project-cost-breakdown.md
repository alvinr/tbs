...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,498 | $7,073 | $7,654 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,812** | **$30,267** | **$36,777** |
...
| Captive tee-nut ply-mount hardware (¼-20 + 5/16 pronged tee-nuts + zinc machine screws) | $29 | $34 |
...
| **Water system total** | **$6,498** | **$7,654** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,498 |
...
| **Scenario B total (excl. CDL)** | **~$30,577** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,677 |
...
| **Scenario C total** | **~$119,177–$149,177** |
