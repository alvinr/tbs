...
## 3. Optics — Pinhole Wall Interface

**Source document:** `pinhole-report.md`, `pinhole-disc-holder-report.md`

The pinhole/lens **mount** is the [pinhole disc holder](pinhole-disc-holder-report.md) (in the front-board system); this section is the **wall interface** it bolts to. The standard Ø600 interchangeable pinhole/lens plate was retired — the Ø80-carrier disc holder does both jobs, so the pinhole element + retaining ring + mount bolts now live once, in the front board.

### 3.1 Pinhole wall interface

<!-- BEGIN costing:optics -->
| Item | Low | Mid | High | Notes |
|------|-----|-----|------|-------|
| Wall-frame adapter plate + weld | $20 | $30 | $40 | Flat steel adapter welded over the corrugation; 4× M6 @ Ø150 datum |
| Aperture dark slide / cap | $15 | $22 | $30 | Light-tight cover over the aperture between exposures |
| **Wall-interface total** | **$35** | **$52** | **$70** | |
<!-- END costing:optics -->

### 3.2 Optional large-format lens

**Source document:** `lens-options.md`

The disc holder takes a Copal/Compur **lens board** (0/1/3) in place of a pinhole board — for portrait or shorter-exposure work. Focus is set at the film plane (depth rail).
...
| Saddle fasteners — M12×70 through-bolts (×28) + M8 thumbscrews (×12) + M8×25 hex bolts (×8) | $228 | $228 | $228 |
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$4,063** | **$4,291** | **$4,525** |
<!-- END costing:film -->
...
| IBC stacking frame (2×2×0.120in restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,312 | $1,873 |
...
| Pump-run support boards + L-brackets + P-clips (corridor side boards, spine, skid) | $50 | $77 |
| Filter skid (3× Big Blue housings + cartridges) | $527 | $527 |
| Captive tee-nut ply-mount hardware (¼-20 + 5/16 pronged tee-nuts + zinc machine screws) | $37 | $37 |
...
| **Water system total** | **$6,841** | **$8,114** |
<!-- END costing:water -->
...
| Bearing retaining rings + upper end-retainer plate — 3× DIN 471 (inner) + 1× DIN 472 (outer) + Ø90×4 plate | $17 | $17 | $18 | upper hub hang on a bolted end plate (not a lone circlip); outer race located (shoulder + DIN 472), lower floats; firm |
...
| Al U-channel opening-edge stiffeners (×4) + L-clips + M8 | $152 | $152 | $152 | housing free-edge stiffeners (replaces jamb posts); rivet-only 2026-09-08; est. |
| Al U-channel — rotating-drum opening-edge stiffeners (×2) + rivets | $30 | $43 | $55 | drum free-edge stiffeners (2026-09-08); rivet-only; est. |
| Formed-Al strip channel-support beams (×4) + rivets | $69 | $69 | $69 | one across each housing opening top+bottom, rail-to-rail so the U-channels rivet to a member; SS blind-riveted to the frame beams; smallest formed section (SKU pending); est. |
...
| Bolts/nuts/isolation washers — cap/ring/collar/stile/handle/edge/housing (SS) | $95 | $95 | $95 | ≈$91 firm, McMaster F1–F7 + W (one pack per line) |
| SS blind rivets — housing skin → outer beam face (97525A425, 100-pack) | $14 | $14 | $14 | 2026-09-08: rim-angle dropped, skin fixes directly to the outer beam face (Sheets 9/10); $13.83/100 firm |
| M10 twist-resistant rivet-nuts ×20 (95105A199) + setting tool (96349A866) | $24 | $34 | $44 | $53 firm; 14 into the 3mm RHS beam wall (ring/collar→beam) |
| 1/8" blind rivets — brush-holder → drum OD (97447A015, 250-pack) | $16 | $16 | $16 | $10.78 firm; ~72 for the Al holder flanges |
| Fabrication — roll + weld 2 cylinders, roll rim-angle, fit metal caps/bearings (16–22 hrs) | $800 | $975 | $1,150 | Local plastic + metal fab |
| **Housing + drum total** | **$3,144** | **$3,651** | **$4,155** | |
...
| M12×70 partial-thread bolts + nuts + washers (×59) | $146 | $146 | $146 | 91280A728 $1.595 + plain nut 90591A181 $0.256 + 4 flat 91166A290 + split 91202A246 /bolt; 3 per std bracket (39) + 4 per widened (20) |
...
| **Perimeter walkway total** | **$2,088** | **$2,507** | **$2,950** | |
<!-- END costing:walkway -->
...
| Turntable thrust bearing, 12″ (Ø305) 1000 lb | $70 | $95 | $120 | VXB |
| Flanged sleeve (journal) bearings, Ø90 bore (×2) | $80 | $80 | $80 | McMaster SAE 841 |
