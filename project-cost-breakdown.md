...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,551 | $7,143 | $7,742 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,781** | **$30,281** | **$36,837** |
...
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, single center feed, 4 wheels, ball joint, arm, hose) | $550 | $562 |
| Electrical (wiring only — fuse block in Electrical Report) | $31 | $31 |
| Processing consumables (6-mil poly, pH meter, citric acid) | $253 | $253 |
| **Water system total** | **$6,551** | **$7,742** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,551 |
...
| **Scenario B total (excl. CDL)** | **~$30,591** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,691 |
...
| **Scenario C total** | **~$119,191–$149,191** |
