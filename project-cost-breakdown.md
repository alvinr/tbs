...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $4,592 | $5,777 | $6,955 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$21,596** | **$27,432** | **$35,336** |
...
| **Water system total** | **$4,592** | **$6,955** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $4,592 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $5,777 |
...
| **Scenario B total (excl. CDL)** | **~$27,742** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $26,842 |
...
| **Scenario C total** | **~$116,342–$146,342** |
