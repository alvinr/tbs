...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,577 | $7,169 | $7,768 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,807** | **$30,307** | **$36,863** |
...
| Processing consumables (6-mil poly, pH meter, citric acid) | $278 | $278 |
| **Water system total** | **$6,577** | **$7,768** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,577 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,169 |
...
| **Scenario B total (excl. CDL)** | **~$30,617** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,717 |
...
| **Scenario C total** | **~$119,217–$149,217** |
