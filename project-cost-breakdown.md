...
| **5a. Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)** | $3,147 | $3,200 | $3,252 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,076** | **$30,679** | **$37,332** |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,147 |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,200 |
...
| **Scenario B total (excl. CDL)** | **~$30,989** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,089 |
...
| **Scenario C total** | **~$119,589–$149,589** |
