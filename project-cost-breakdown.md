...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,953 | $3,470 | $3,984 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,539** | **$32,343** | **$39,214** |
...
| Bearing retaining rings — 4× DIN 471 (inner) + 1× DIN 472 (outer, upper) | $8 | $11 | $15 | outer-race retention: upper located (shoulder + DIN 472), lower floats; est. |
...
| **Housing + drum total** | **$2,953** | **$3,470** | **$3,984** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,953 |
