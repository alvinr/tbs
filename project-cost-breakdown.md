...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,534** | **$33,130** | **$39,778** |
...
| **Scenario B total (excl. CDL)** | **~$33,440** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,540 |
...
| **Scenario C total** | **~$122,040–$152,040** |
