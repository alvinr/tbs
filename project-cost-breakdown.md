...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,100** | **$32,854** | **$39,698** |
...
| **Scenario B total (excl. CDL)** | **~$33,164** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,264 |
...
| **Scenario C total** | **~$121,764–$151,764** |
