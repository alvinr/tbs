...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,338 | $7,150 | $7,999 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,177** | **$32,931** | **$39,775** |
...
| Filter skid (3× Big Blue housings + cartridges) | $384 | $544 |
...
| **Water system total** | **$6,338** | **$7,999** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,338 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,150 |
...
| **Scenario B total (excl. CDL)** | **~$33,241** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,341 |
...
| **Scenario C total** | **~$121,841–$151,841** |
