...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,978 | $3,513 | $4,044 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,704** | **$32,582** | **$39,520** |
...
| Rim-angle → beam TEK screws (~24× #14 self-drilling) | $14 | $14 | $14 | weld→TEK (Sheets 9/10); est. |
...
| **Housing + drum total** | **$2,978** | **$3,513** | **$4,044** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,978 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $3,513 |
...
| **Scenario B total (excl. CDL)** | **~$32,892** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,992 |
...
| **Scenario C total** | **~$121,492–$151,492** |
