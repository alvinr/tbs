...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $4,007 | $4,235 | $4,469 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,547** | **$32,414** | **$39,349** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$4,007** | **$4,235** | **$4,469** |
<!-- END costing:film -->
...
| Pinhole plate | $100 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $4,007 |
...
| Pinhole plate | $155 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $4,235 |
...
| **Scenario B total (excl. CDL)** | **~$32,724** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,824 |
...
| **Scenario C total** | **~$121,324–$151,324** |
