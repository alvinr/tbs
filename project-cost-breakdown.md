...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,112** | **$32,113** | **$39,004** |
...
| **Scenario B total (excl. CDL)** | **~$32,423** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,523 |
...
| **Scenario C total** | **~$121,023–$151,023** |
