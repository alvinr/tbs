...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,493 | $7,111 | $7,732 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,723** | **$30,249** | **$36,827** |
...
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, single center feed, 4 wheels, ball joint, arm, hose) | $492 | $552 |
...
| **Water system total** | **$6,493** | **$7,732** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,493 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,111 |
...
| **Scenario B total (excl. CDL)** | **~$30,559** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,659 |
...
| **Scenario C total** | **~$119,159–$149,159** |
