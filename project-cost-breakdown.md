...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $6,107 | $6,581 | $7,055 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,506** | **$31,546** | **$39,462** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$6,107** | **$6,581** | **$7,055** |
<!-- END costing:film -->
...
| Pinhole plate | $110 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $6,107 |
...
| Pinhole plate | $185 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $6,581 |
...
| **Scenario B total (excl. CDL)** | **~$31,856** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,956 |
...
| **Scenario C total** | **~$120,456–$150,456** |
