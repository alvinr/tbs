...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $5,734 | $6,019 | $6,304 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,100** | **$30,788** | **$38,343** |
...
| Acetal 4-wheel skates (×4) — Ø32 rollers, Ø10 316 axles, carriage plates | $175 | $227 | $279 |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$5,734** | **$6,019** | **$6,304** |
<!-- END costing:film -->
...
| **Water system total** | **$5,424** | **$7,949** |
<!-- END costing:water -->
...
| Pinhole plate | $110 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $5,734 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $5,424 |
...
| Pinhole plate | $185 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $6,019 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,690 |
...
| **Scenario B total (excl. CDL)** | **~$31,098** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,198 |
...
| **Scenario C total** | **~$119,698–$149,698** |
