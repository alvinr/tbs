...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,407 | $7,147 | $7,923 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,300** | **$32,973** | **$39,736** |
...
| Filter skid (3× Big Blue housings + cartridges) | $451 | $492 |
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,015 | $1,065 |
...
| **Water system total** | **$6,407** | **$7,923** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,407 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,147 |
...
| **Scenario B total (excl. CDL)** | **~$33,283** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,383 |
...
| **Scenario C total** | **~$121,883–$151,883** |
