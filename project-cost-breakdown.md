...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,684 | $7,303 | $7,931 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,643** | **$31,146** | **$37,719** |
...
| IBC stacking frame (2×2×0.120in restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,163 | $1,697 |
...
| **Water system total** | **$6,684** | **$7,931** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,684 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,303 |
...
| **Scenario B total (excl. CDL)** | **~$31,456** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,556 |
...
| **Scenario C total** | **~$120,056–$150,056** |
