...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,787** | **$31,302** | **$37,891** |
...
| **Scenario B total (excl. CDL)** | **~$31,612** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,712 |
...
| **Scenario C total** | **~$120,212–$150,212** |
