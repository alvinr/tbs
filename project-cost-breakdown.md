...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,554 | $7,146 | $7,745 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,868** | **$30,340** | **$36,868** |
...
| IBC stacking frame (50×50×3mm RHS restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,079 | $1,545 |
| Pumps and accumulator (P-01, P-02, P-04 manifold + P-03, P-05 IBC corridor) | $536 | $536 |
...
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, single center feed, 4 wheels, ball joint, arm, hose) | $551 | $563 |
...
| **Water system total** | **$6,554** | **$7,745** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,554 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,146 |
...
| **Scenario B total (excl. CDL)** | **~$30,650** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,750 |
...
| **Scenario C total** | **~$119,250–$149,250** |
