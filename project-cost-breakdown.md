...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,264 | $7,132 | $7,994 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,996** | **$32,862** | **$39,775** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,020 | $1,072 |
...
| **Water system total** | **$6,264** | **$7,994** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,264 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,132 |
...
| **Scenario B total (excl. CDL)** | **~$33,172** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,272 |
...
| **Scenario C total** | **~$121,772–$151,772** |
