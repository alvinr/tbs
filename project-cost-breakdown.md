...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $5,741 | $6,022 | $6,307 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,107** | **$30,791** | **$38,346** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$5,741** | **$6,022** | **$6,307** |
<!-- END costing:film -->
...
| Pinhole plate | $110 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $5,741 |
...
| Pinhole plate | $185 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $6,022 |
...
| **Scenario B total (excl. CDL)** | **~$31,101** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,201 |
...
| **Scenario C total** | **~$119,701–$149,701** |
