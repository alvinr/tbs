...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,818 | $3,363 | $3,902 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,404** | **$32,236** | **$39,132** |
...
| Al straight-flange holders for the #4 wiper brush ×4 (8 ft) | $72 | $116 | $159 | flange-riveted to the drum OD — rivets clear of the brush; est. |
...
| Ø25 SS grab bar — 16" bolt-on (marine) | $25 | $35 | $45 | off-the-shelf; BOLTED to the stile (2× M8 tapped per foot), not welded |
| 40×40×5 SS RHS grab-bar stile (cap→cap) + M12 cap bolts | $50 | $73 | $95 | pull load into the Al caps (not the HDPE wall); est. |
| Matte-black interior finish | $40 | $55 | $70 | scuff + flat-black touch-in |
| Stainless bolts (cap/ring/edge/stile/grab) + M10 rivet-nuts + nylon isolation washers | $45 | $58 | $70 | no galvanic couple; rivets/M8/M12 separate |
| Fabrication — roll + weld 2 cylinders, roll rim-angle, fit metal caps/bearings (16–22 hrs) | $800 | $975 | $1,150 | Local plastic + metal fab |
| **Housing + drum total** | **$2,818** | **$3,363** | **$3,902** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,818 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $3,363 |
...
| **Scenario B total (excl. CDL)** | **~$32,546** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,646 |
...
| **Scenario C total** | **~$121,146–$151,146** |
