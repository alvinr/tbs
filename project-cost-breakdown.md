...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,469 | $7,199 | $7,965 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,362** | **$33,025** | **$39,778** |
...
| IBC stacking frame (50×50×3mm RHS restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,079 | $1,551 |
...
| **Water system total** | **$6,469** | **$7,965** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,469 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,199 |
...
| **Scenario B total (excl. CDL)** | **~$33,335** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,435 |
...
| **Scenario C total** | **~$121,935–$151,935** |
