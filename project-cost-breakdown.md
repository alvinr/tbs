...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,265 | $7,132 | $7,995 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,997** | **$32,862** | **$39,776** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,021 | $1,073 |
...
| **Water system total** | **$6,265** | **$7,995** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,265 |
