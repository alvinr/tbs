...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,384 | $7,009 | $7,635 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,614** | **$30,147** | **$36,730** |
...
| **Water system total** | **$6,384** | **$7,635** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,384 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,009 |
...
| **Scenario B total (excl. CDL)** | **~$30,457** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,557 |
...
| **Scenario C total** | **~$119,057–$149,057** |
