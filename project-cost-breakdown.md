...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $3,746 | $3,972 | $4,200 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,745** | **$30,286** | **$36,877** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$3,746** | **$3,972** | **$4,200** |
<!-- END costing:film -->
...
| Pinhole plate | $100 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $3,746 |
...
| Pinhole plate | $155 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $3,972 |
...
| **Scenario B total (excl. CDL)** | **~$30,596** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,696 |
...
| **Scenario C total** | **~$119,196–$149,196** |
