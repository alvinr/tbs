...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,232 | $7,104 | $7,972 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,964** | **$32,834** | **$39,753** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $988 | $1,050 |
...
| **Water system total** | **$6,232** | **$7,972** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,232 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,104 |
...
| **Scenario B total (excl. CDL)** | **~$33,144** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,244 |
...
| **Scenario C total** | **~$121,744–$151,744** |
