...
| **6c. Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + cam latches + B2 bay + pull handle)** | $1,229 | $1,309 | $1,387 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,555** | **$32,365** | **$39,242** |
...
| Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay + handle) | $1,229 |
...
| Hinged panel structure (stepped frame + HDPE skins + Al core + EPDM + latches + B2 bay + handle) | $1,309 |
...
| **Scenario B total (excl. CDL)** | **~$32,675** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,775 |
...
| **Scenario C total** | **~$121,275–$151,275** |
