...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,560 | $7,152 | $7,751 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,874** | **$30,346** | **$36,874** |
...
| **Water system total** | **$6,560** | **$7,751** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,560 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,152 |
...
| **Scenario B total (excl. CDL)** | **~$30,656** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,756 |
...
| **Scenario C total** | **~$119,256–$149,256** |
