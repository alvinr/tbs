...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,522** | **$31,991** | **$39,331** |
...
| **Scenario B total (excl. CDL)** | **~$32,301** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,401 |
...
| **Scenario C total** | **~$120,901–$150,901** |
