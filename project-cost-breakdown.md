...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,633 | $7,286 | $7,938 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,542** | **$33,138** | **$39,786** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $1,038 | $1,057 |
| Pipe (HDPE, spray bar) | $67 | $67 |
| Processing tray (304 SS, fabricated, 2 panels) | $1,538 | $2,226 |
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, manifold + 7 feed tubes, 4 wheels, ball joint, arm, hose) | $385 | $457 |
...
| **Water system total** | **$6,633** | **$7,938** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,633 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,286 |
...
| **Scenario B total (excl. CDL)** | **~$33,448** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,548 |
...
| **Scenario C total** | **~$122,048–$152,048** |
