...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,253 | $7,065 | $7,913 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,092** | **$32,846** | **$39,689** |
...
| Valves and fittings (incl. S60×6 adapters, check valve CV-1 (pumps have integral checks)) | $999 | $1,054 |
...
| **Water system total** | **$6,253** | **$7,913** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,253 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,065 |
