...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,938** | **$30,516** | **$37,144** |
...
| **Scenario B total (excl. CDL)** | **~$30,826** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,926 |
...
| **Scenario C total** | **~$119,426–$149,426** |
