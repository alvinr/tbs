...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $3,975 | $4,203 | $4,437 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,515** | **$32,382** | **$39,317** |
...
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$3,975** | **$4,203** | **$4,437** |
<!-- END costing:film -->
...
| Pinhole plate | $100 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $3,975 |
...
| Pinhole plate | $155 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $4,203 |
...
| **Scenario B total (excl. CDL)** | **~$32,692** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,792 |
...
| **Scenario C total** | **~$121,292–$151,292** |
