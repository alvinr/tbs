...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,459 | $7,031 | $7,610 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,773** | **$30,225** | **$36,733** |
...
| Valves and fittings (BV/V100/3-way valves, X1 cross, CV-1, SV taps, equalization tie, PVC slip fittings + transition adapters, unions) | $802 | $802 |
...
| **Water system total** | **$6,459** | **$7,610** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,459 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,031 |
...
| **Scenario B total (excl. CDL)** | **~$30,535** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,635 |
...
| **Scenario C total** | **~$119,135–$149,135** |
