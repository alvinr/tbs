...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,945 | $7,538 | $8,136 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,175** | **$30,676** | **$37,231** |
...
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, single center feed, 4 wheels, ball joint, arm, hose) | $944 | $956 |
...
| **Water system total** | **$6,945** | **$8,136** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,945 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,538 |
...
| **Scenario B total (excl. CDL)** | **~$30,986** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,086 |
...
| **Scenario C total** | **~$119,586–$149,586** |
