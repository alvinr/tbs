...
| **4. Film plane mechanism (4-corner U-channel + acetal skate + U-joint, incl. wall-seat saddles)** | $3,649 | $3,875 | $4,103 |
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,449 | $7,082 | $7,716 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,679** | **$30,220** | **$36,811** |
...
| Electrical (wiring only — fuse block in Electrical Report) | $36 | $36 |
| Processing consumables (6-mil poly, pH meter, citric acid) | $255 | $255 |
| **Water system total** | **$6,449** | **$7,716** |
<!-- END costing:water -->
...
| Pinhole plate | $100 |
| Film plane mechanism (4-corner U-channel + U-joint, incl. wall-seat saddles) | $3,649 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,449 |
...
| Pinhole plate | $155 |
| Film plane mechanism (4-corner U-channel + U-joint + wall-seat saddles) | $3,875 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,082 |
...
| **Scenario B total (excl. CDL)** | **~$30,530** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,630 |
...
| **Scenario C total** | **~$119,130–$149,130** |
