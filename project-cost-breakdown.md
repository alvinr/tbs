...
| **4. Film plane mechanism (4-corner Option A, incl. wall-seat saddles + cross-slides)** | $3,454 | $3,684 | $3,914 |
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $4,181 | $5,221 | $6,254 |
...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $1,385 | $1,728 | $2,070 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$21,211** | **$26,902** | **$34,661** |
...
| Rod-end spherical bearings GIR25-DO (×8) + pivot pins SS316 (×8) | $240 | $240 | $240 |
...
| **Section total — film plane mechanism (manual, incl. saddles + cross-slides)** | **$3,454** | **$3,684** | **$3,914** |
<!-- END costing:film -->
...
| IBC stacking frame (50×50×3mm RHS restraint front portal + floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $955 | $1,455 |
| Pumps and accumulator (P-01, P-02, P-04 manifold + P-03 IBC corridor) | $315 | $345 |
| Filter skid (3× Big Blue housings + cartridges) | $282 | $445 |
| Valves and fittings (incl. S60×6 adapters, check valves CV1/CV3/CV4) | $343 | $585 |
| Pipe (HDPE, spray bar) | $80 | $114 |
| Processing tray (304 SS, fabricated, 2 panels) | $1,300 | $2,015 |
| Spray bar assembly (gantry: beam, LDPE pipe, 26 nozzles, manifold + 7 feed tubes, 4 wheels, ball joint, arm, hose) | $235 | $299 |
| Electrical (wiring only — fuse block in Electrical Report) | $35 | $35 |
| Processing consumables (6-mil poly, pH meter, citric acid) | $241 | $241 |
| **Water system total** | **$4,181** | **$6,254** |
<!-- END costing:water -->
...
| SKF 6215-2RS1 sealed bearing (×2) | $90 | $110 | $130 | Bearing World / Applied |
...
| **Housing + drum total** | **$1,385** | **$1,728** | **$2,070** | |
...
| Pinhole plate | $95 |
| Film plane mechanism (manual Option A, incl. wall-seat saddles + cross-slides) | $3,454 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $4,181 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $1,385 |
...
| Pinhole plate | $165 |
| Film plane mechanism (manual Option A + wall-seat saddles + cross-slides) | $3,684 |
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $5,221 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $1,728 |
...
| **Scenario B total (excl. CDL)** | **~$27,212** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $26,312 |
...
| **Scenario C total** | **~$115,812–$145,812** |
