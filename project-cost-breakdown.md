...
| **5a. Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)** | $3,353 | $3,386 | $3,418 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,282** | **$30,823** | **$37,414** |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,353 |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,386 |
...
| **Scenario B total (excl. CDL)** | **~$31,133** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,233 |
...
| **Scenario C total** | **~$119,733–$149,733** |
