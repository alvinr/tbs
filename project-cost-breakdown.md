...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $6,719 | $7,341 | $7,975 |
...
| **6a. Perimeter walkway (4 sections + drum-exit punch-out)** | $2,150 | $2,593 | $3,060 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,742** | **$31,272** | **$37,875** |
...
| Saddle fasteners — M12×65 through-bolts (×28) + M8 thumbscrews (×12) + M8×25 hex bolts (×8) | $211 | $211 | $211 |
| **Section total — film plane mechanism (U-channel + U-joint, incl. saddles)** | **$4,271** | **$4,470** | **$4,673** |
<!-- END costing:film -->
...
| IBC stacking frame (2×2×0.120in restraint deep 4-leg box + 4 floor feet + 50×20 front retaining bars + wall joist hangers through-bolted to exterior backing plates + fabrication, per [Stacking §9.1](ibc-stacking-report.md)) | $1,187 | $1,721 |
...
| **Water system total** | **$6,719** | **$7,975** |
<!-- END costing:water -->
...
| Right walkway center arms, solid 2×1 flat bar (×2) | $36 | $48 | $60 | Solid (not tube) — each arm is half-lapped over both long beams; a notched partial section must be solid. Notch rebalanced to the moment (ibc_frame_load.arm_notch_check) |
...
| Walkway-arm J6 end-plate hardware (8× M12×100 + 4 plates 70×130×8 + 8 crush sleeves) | $33 | $44 | $55 | Bolted end-plate joint (welded to arm) + rear backing plate + 4 M12/arm through the upright + internal crush sleeve/bolt |
...
| **Perimeter walkway total** | **$2,150** | **$2,593** | **$3,060** | |
<!-- END costing:walkway -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $6,719 |
...
| Perimeter walkway (4 sections, removable, GRP grating) | $2,150 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $7,341 |
...
| Perimeter walkway (4 sections, removable, GRP grating) | $2,593 |
...
| **Scenario B total (excl. CDL)** | **~$31,582** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,682 |
...
| **Scenario C total** | **~$120,182–$150,182** |
