...
| **5a. Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)** | $3,316 | $3,349 | $3,381 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$26,245** | **$30,786** | **$37,377** |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,316 |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,349 |
...
| **Scenario B total (excl. CDL)** | **~$31,096** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $30,196 |
...
| **Scenario C total** | **~$119,696–$149,696** |
