...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,784** | **$30,284** | **$36,840** |
...
| Spray bar assembly (gantry: beam, LDPE pipe, 39 nozzles, single center feed, 4 wheels, ball joint, arm, hose) | $553 | $565 |
...
| **Scenario B total (excl. CDL)** | **~$30,594** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,694 |
...
| **Scenario C total** | **~$119,194–$149,194** |
