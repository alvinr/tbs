...
| **5. Processing water system (incl. tray, spray bar, IBC stacking frame)** | $4,250 | $5,288 | $6,319 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$21,280** | **$26,969** | **$34,726** |
...
| Valves and fittings (incl. S60×6 adapters, check valves CV1/CV3/CV4) | $337 | $575 |
...
| **Water system total** | **$4,250** | **$6,319** |
<!-- END costing:water -->
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $4,250 |
...
| Water system (incl. processing tray, spray bar, IBC stacking frame) | $5,288 |
...
| **Scenario B total (excl. CDL)** | **~$27,279** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $26,379 |
...
| **Scenario C total** | **~$115,879–$145,879** |
