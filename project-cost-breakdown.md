...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,518** | **$33,104** | **$39,743** |
...
| **Scenario B total (excl. CDL)** | **~$33,414** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,514 |
...
| **Scenario C total** | **~$122,014–$152,014** |
