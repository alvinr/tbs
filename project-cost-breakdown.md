...
| **TOTAL (excl. own transport, CDL, lens)** | **$25,648** | **$30,189** | **$36,780** |
...
| **Scenario B total (excl. CDL)** | **~$30,499** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $29,599 |
...
| **Scenario C total** | **~$119,099–$149,099** |
