...
| **6. Housed revolving-door light lock (plastic-skin custom fabrication)** | $2,955 | $3,469 | $3,979 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,541** | **$32,342** | **$39,209** |
...
| **Housing + drum total** | **$2,955** | **$3,469** | **$3,979** | |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $2,955 |
...
| Revolving drum light trap (plastic-skin custom fabrication) | $3,469 |
...
| **Scenario B total (excl. CDL)** | **~$32,652** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,752 |
...
| **Scenario C total** | **~$121,252–$151,252** |
