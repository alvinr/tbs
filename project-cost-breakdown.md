...
| **TOTAL (excl. own transport, CDL, lens)** | **$27,674** | **$32,539** | **$39,465** |
...
| **Scenario B total (excl. CDL)** | **~$32,849** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $31,949 |
...
| **Scenario C total** | **~$121,449–$151,449** |
