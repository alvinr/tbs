...
| **5a. Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)** | $3,238 | $3,242 | $3,246 |
...
| **TOTAL (excl. own transport, CDL, lens)** | **$28,763** | **$33,335** | **$39,960** |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,238 |
...
| Power & electrical system (solar · 1× LiFePO4 · distribution · lighting · protection · master pump switch) | $3,242 |
...
| **Scenario B total (excl. CDL)** | **~$33,645** |
...
| Item | Cost |
|------|------|
| Scenario B build (less the $900 commercial transport, replaced here by owned transport) | $32,745 |
...
| **Scenario C total** | **~$122,245–$152,245** |
