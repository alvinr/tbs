...
to one of four root causes — three of which are mechanical. Run this audit after
...
## The four failure modes (from real anomalies)
...
```bash
python3 src/generators/check_consistency.py          # all four checks
