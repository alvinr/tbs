...
LIGHTLOCK = [
    ...
    LineItem("Bolts/nuts/isolation washers — cap/ring/collar/stile/handle/edge/housing (SS)", 97, 97, 97, "≈$97 firm, McMaster (F1–F7 + W; one pack per line)"),
