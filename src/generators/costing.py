...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (26718, 31399, 38134),  # 2026-07-29: +$16 1" PVC recount 2→4 sticks. 2026-07-28: +$37 water (transition-adapter +$8, sump pickup +$45, spray Option 1 −$8). Earlier: external power panel penetration box; MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
