...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "film": (4007, 4235, 4469), # 2026-09-05: +$32 — skate axle-saddle retention itemized (16× 8992K794 saddles + 32× M6×20 91287A137 + 32× M6 nyloc; retires the M5 onto the shared M6 family). 2026-09-05: −$76 to −$135 — corner L-plate re-spec'd from a formed ¼ 6×8 plate ($58.90 ea firm ×4=$236) to stock 4×4×¼ 304 angle cut to length ($25–40/pc, re-quote); cheaper, no press-brake. 2026-08-20: −$161 — film-plane wall-seat saddles reconciled 6→4 (far-LEFT ends land on the pivot post; back-plate lengthened for the gusset; +2 far-left flange brackets w/ 8 M12). 2026-08-13: −1 — the M8 wall-fixing (bolt-m8-fixing) moved to the firm 304 A2 SKU 91310A535 $13.91/50, below the retired zinc placeholder. 2026-08-13: Belden SSNBUJ750x3/8KB needle-bearing keyed+booted U-joint (Grainger 41D816 $252.13 ea) replaces the plain UJ-SS750x375 + separate 806VF1 boot -> +~$403. # 2026-08-10 (corner blueprint): +$135 — cross-slide bars grown ~250→~345/365mm to hold ±40°/±28° (2× 8ft 304 bar, was 1×). 2026-08-01: corner L-plates firm Metal Supermarkets $58.90 ea ×4 = $236 (was $152-208 est). 2026-07-31: Ruland->Belden U-joint -$653 # 2026-07-27: blackout poly → Film-Gard 10ft 4-mil $40.12 (was 6-mil $66–70, −$26/−$30); Gorilla tape firm $9.94 ×6; saddle M8 thumbscrews ×12 McMaster $11.80. (2026-07-22: clamp → off-the-shelf nylon spring clamps + HDPE filler.)
