...
SECTIONS = [
    ...
    Section("5a", "Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)", 3246, 3253, 3261),  # KEEP IN SYNC WITH EXPECTED["power"] / total(POWER) — grand_total() sums this Section, not the POWER line items
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28771, 33346, 39975),  # 2026-07-28: external power-panel IP enclosure +$253. Earlier: spray 90° jets, tray shim, transition adapters, IBC strap, X1 cross.
    ...
    "power": (3246, 3253, 3261),   # 2026-07-28: external power panel → IP-rated McMaster enclosure $291.91 (+$253/+$232), flush plate+gasket retired. EP backboard SANDEPLY; pull-cord NEMA-4. §5a authoritative subtotal
}
