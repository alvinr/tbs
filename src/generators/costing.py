...
SHELF = [
    ...
    point("Bolt-on piano hinge, 600mm 304 SS", 6, "McMaster 1582A457 $6.23/2ft (bolt-on; replaces the weld-on LSN8-32-600)"),
    ...
    LineItem("1/4-20 SS machine screws — hinge, both leaves (×8)", 2, 4, 5, "4× shelf leaf → tee-nuts + 4× wall leaf → tapped cleat; SS wet-zone exception to the zinc ply-mount screw; SKU pending"),
