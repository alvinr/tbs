...
WATER = [
    ...
    LineItem("IBC stacking frame (RHS deep 4-leg box + 4 feet + 8 retaining bars (2/tote face) + 8 identical 2-bolt hangers + 8 backing plates + 8 weld-on lashing rings + 4× 2\" transport straps + 4 anti-slip mats + the 2 walkway center cantilever arms + J6 end/backing plates + crush sleeves + M12×100 + half-lap screws + fab)", 1310, 1590, 1871, "2026-09-07: half-lap hold-down TEK firmed (4× 90822A620 + 4× 92141A223 washers = $2.60, was est $2–4). 2026-08-19: +$116/$125/$135 — the IBC-owned walkway center arms + J6 connection reconciled here from walkway §6a (they mount on the IBC uprights). 2026-08-18b: +$10/$20 — 16 L-cleat nut backing plates (8 J2 + 8 J7). 2026-08-18: −16 — J2 cleat → L-angle + 1 horizontal bolt. Earlier cost history: RELEASE.md + git log."),
...
FILM = [
    ...
    point("Saddle + far-left-bracket fasteners — M12×65 through-bolts (×28) + M8 thumbscrews (×6) + M8×25 hex bolts (×8)", 140, "ICP-12/13/14; M12×65 91280A728 + plain nut 90591A181 + 4 flat 91166A290 + split 91202A246 per bolt; M8×25 fixing 91280A534. 2026-08-19: M12×65 ×20→×28 (+8 = the 2 far-left flange brackets, 4 bolts each). 6→4 saddles: M8 thumbscrews ×12→×6 (only the 2 left saddles are thumb-screw drop-in; the 2 TR saddles + 2 far-left brackets are permanent-bolt). M8 fixing (bolt-m8-fixing) 304 A2 SKU 91310A535 $13.91/50."),
]
