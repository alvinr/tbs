...
WATER = [
    ...
    LineItem("Filter skid (3× Big Blue 4.5×20 separate housings on mounting brackets + cartridges)", 299, 377, 458, "2026-07-22: U-bracket retired → lag screws to ply backing. 2026-07-25: housing standoff spacers → plywood offcuts. 2026-07-27: filter lag screws firm Everbilt 5-pack $7.09 ×2. 2026-07-27: skid frame → 3× Pentair 150061 zinc single-housing brackets $10.50 (was the $116.76 McMaster angle — purpose-built, −$85)"),
    LineItem("Valves and fittings (6× BV ball valves, X1 4-way cross, S60×6 adapters, CV1, SV-01 + SV-02 taps, Blue equalization tie, PVC slip tees/elbows/couplings/transition adapters, 2× service unions)", 1003, 1012, 1061, "2026-07-22: S60×6 adapter re-spec'd female-buttress×2\"NPT + 2→1\" bushing (CPP HMFN/20UD/027) +$48/+$24. 2026-07-27: Banjo valves/tees/elbows/3-ways sourced firm at US Plastic. 1\" PVC slip tees (PVC024001000HD $2.13) + elbows (PVC023001000HD $1.52) + slip×NPT transition adapters (PVC021090600HD $0.79/PVC021091000HD $1.16) firm at Home Depot; filter-jumper bundle retired into itemized pipe/elbows/adapters"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "shelf": (228, 241, 253),          # 2026-07-27: work surface → Swaner UV-White 18mm ply $73.28 (was $60). 2026-07-22: piano hinge Würth 32×600 satin SS.  §6d = chemistry-prep-shelves §7        
