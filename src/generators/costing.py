...
WATER = [
    ...
    LineItem("Spray bar assembly (40×25 SS RHS beam, side LDPE manifold, 40 jets, single center feed, 4 Ø32 wheels, ball joint, arm + turned adapter + jam nut + clamp collar, hose)", 492, 521, 552, "2026-07-22: arm jam nut/collar/self-tap/beam-clamp re-priced to real SKUs. 2026-07-25: arm tube → McMaster 9056K36 8ft stock $64.03 (was a $6 500mm cut, too short to order) +$58. 2026-07-28: Option 1 single center feed −$8 — ¾\" LDPE over-bored for the flow, so the distribution manifold + 7 feed tubes + barbed-tee taps retired. 2026-08-01: carriage plate firm Metal Supermarkets 12×20×3/16 6061 $124.88 (+$100 vs the Online Metals est; cheaper online fallback ~$35)"),
