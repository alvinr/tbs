...
LIGHTLOCK = [
    ...
    LineItem("Bearing retaining rings — 4× external Ø75 (inner) + 1× internal Ø130 (outer, upper)", 14, 14, 14, "2026-08-25: axial retention — upper outer race LOCATED, lower FLOATS. Firm: McMaster 90154A895 $7.05 (ext Ø75) + 98455A170 $7.26 (int Ø130)."),
