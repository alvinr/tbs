...
WATER = [
    ...
    LineItem("Pump-run support boards + L-brackets + P-clips (#29 — corridor side boards, spine, skid)", 33, 46, 61, "2026-08-08 (#29): 3 ply side support boards (far + near-lower + near-upper, cut from the corridor 4×8 sheet — no added ply cost) + 12 welded steel L-brackets (side-post inner faces, material est.) + 39 cushioned 3/4\" P-clips (corridor 17 + spine 10 + skid 12). Fab (cut/weld) deferred to blueprint; clips/bracket material est."),
