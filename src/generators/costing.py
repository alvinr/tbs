...
SECTIONS = [
    ...
    Section("5a", "Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)", 3235, 3239, 3243),  # KEEP IN SYNC WITH EXPECTED["power"] / total(POWER) — grand_total() sums this Section, not the POWER line items
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28760, 33332, 39957),  # 2026-07-28: standalone E-stop box retired (−$8/−$13). Earlier: external power-panel IP enclosure, spray 90° jets, tray shim.
    ...
    "power": (3235, 3239, 3243),   # 2026-07-28: standalone E-stop box retired (button now on the ep-ext-enclosure door, −$8/−$13). External power panel → McMaster IP enclosure. §5a authoritative subtotal
}
