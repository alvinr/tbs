...
WATER = [
    ...
    LineItem("IBC stacking frame (RHS deep 4-leg box + 4 feet + retaining bars + hangers + 8 weld-on lashing rings + fab)", 1000, 1255, 1510),
    ...
    LineItem("Spray bar assembly (40×25 SS RHS beam, side LDPE manifold, 26 nozzles, manifold + 7 feed tubes, 4 Ø32 wheels, ball joint, arm, hose)", 282, 322, 362, "2026-07-21: M6 fasteners re-priced (bolt 91280A330, nyloc 90576A115, plain nut) −$4"),
...
FILM = [
    ...
    point("Saddle fasteners — M12×65 through-bolts (×28) + M8 thumbscrews (×12) + M8 hex bolts (×8)", 118, "ICP-12/13/14; M12×65 bolt $1.595 (91280A728) + plain nut $0.256 (90591A181) + 4 flat $0.097 (91166A290) + split $0.120 (91202A246) per bolt"),
]
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "shelf": (202, 202, 202),          # 2026-07-21: M8 wall nut/washer re-priced −$1.  §6d = chemistry-prep-shelves §7 (point estimates)
    "interior": (950, 1138, 1350),
    "optics": (110, 185, 265),
    "film": (6103, 6577, 7051),   # 2026-07-21: M12 saddle flat washer $0.097 (91166A290) + split $0.120 (91202A246) + plain nut $0.256 (90591A181) re-price +$9.  2026-07-21: M12 saddle bolt re-sized 90→65 (91280A728 $1.595, partial) + 4 washers/bolt −$3.  2026-07-21: M12×90 saddle through-bolt verified $1.83 ea (91310A145, $18.31/pk-10; was $2.18 placeholder) −$10.  2026-07-21: U-joint boot UBOOT12/19-NI-KIT verified $30.59 ea (was $22–29) +$34/+$20/+$6.  2026-07-21: EPDM foam tape 8614K84 (3×50ft) → 8694K88 (2×25ft $22.37), right-sized to the ~43ft perimeter, −$39.  2026-07-21: clamp jaw pad 8614K44 roll ($15) → 3× 4568N57 strips ($78) + M5 fastener re-price (bolt $44→$28, nut $14→$16) = clamp mounting +$49.  2026-07-19: retired the Option-A leadscrew drive (HGR20/Acme/handwheel/rod-end) for the built U-channel + acetal skate + 316 cross-slide + Ruland USKC U-joint mechanism +$2,691/$2,924/$3,158 (U-channel $2,172 + U-joint $1,104 the drivers; skate/slide/clamp/stub estimates firm at order)
