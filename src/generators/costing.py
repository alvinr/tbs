...
WATER = [
    ...
    LineItem("IBC stacking frame (RHS deep 4-leg box + 4 feet + 8 retaining bars (2/tote face) + 8 identical 2-bolt hangers + 8 backing plates + 8 weld-on lashing rings + 4× 2\" transport straps + 4 anti-slip mats + fab)", 1193, 1465, 1737, "2026-08-18b: +$10/$20 — 16 L-cleat nut backing plates (8 J2 + 8 J7). 2026-08-18: −16 — J2 cleat → L-angle + 1 horizontal bolt (16→8 M12×65 SS). Earlier cost history: RELEASE.md + git log."),
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (26793, 31314, 37907), # 2026-08-18b: +$10/$15/$20 ibc-frame (16 L-cleat nut backing plates). 2026-08-18: −$16/$15/$16 ibc-frame (J2 corridor cleat → L + 1 horizontal bolt, 16→8 M12×65 SS). 2026-08-16c: −$10/$13/$15 walkway (J6 4→2 bolts/arm, central column). ... (earlier cost history: RELEASE.md + git log).
    ...
    "water": (6725, 7353, 7991), # 2026-08-18b: +$10/$15/$20 ibc-frame (16 L-cleat nut backing plates). 2026-08-18: −$16/$15/$16 ibc-frame (J2 corridor cleat → L-angle + 1 horizontal bolt, 16→8 M12×65 SS). ... (earlier cost history: RELEASE.md + git log).
