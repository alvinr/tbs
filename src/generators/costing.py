...
LIGHTLOCK = [
    ...
    LineItem("SS blind rivets — rim-angle→beam (McMaster 97525A425, 100-pack)", 14, 14, 14, "2026-08-25: rim-angle flat leg → steel frame beam now SS blind-riveted (was TEK, was welded Al→steel), Sheets 9/10. $13.83/100 firm; ~24 used."),
