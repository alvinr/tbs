...
FILM = [
    ...
    point("Aluminum angle 2×2×3/16 (6061-T6 anodized, expendable) 8 ft (×10)", 1163, "Metal Supermarkets $116.31/8ft; horizontals need 16 ft to drop the mid-span weld"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (26050, 31734, 39289),  # 2026-07-22: retired duplicate image-plane-backing ACM (−$490/−$620). Per-change history in git log.
    ...
    "optics": (110, 185, 265),
    "film": (6684, 6965, 7250),  # updated 2026-07-22: muslin clamp mechanism → off-the-shelf nylon spring clamps (×58) + HDPE filler; retired the custom bracket/spring/neoprene (−$189/−$531). Detail in git log.
