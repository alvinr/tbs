...
# §4 Film plane mechanism (4-corner U-channel + acetal skate + 316 cross-slide + Belden U-joint).
...
FILM = [
    # 4.1 Structural & rails (304 U-channel + acetal skate + 316 cross-slides + Belden U-joint)
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "film": (3733, 3931, 4131), # 2026-08-01: corner L-plates firm Metal Supermarkets $58.90 ea ×4 = $236 (was $152-208 est). 2026-07-31: Ruland->Belden U-joint -$653 # 2026-07-27: blackout poly → Film-Gard 10ft 4-mil $40.12 (was 6-mil $66–70, −$26/−$30); Gorilla tape firm $9.94 ×6; saddle M8 thumbscrews ×12 McMaster $11.80. (2026-07-22: clamp → off-the-shelf nylon spring clamps + HDPE filler.)
