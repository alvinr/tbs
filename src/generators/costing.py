...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28579, 33175, 39823),  # 2026-07-28: +$37 water — transition-adapter takeoff +$8, sump pickup firmed +$45, spray Option 1 single center feed −$8. Earlier: external power panel → fabricated penetration box; MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6670, 7323, 7975),  # 2026-07-28: transition-adapter takeoff +$8; sump pickup firmed +$45 (foot valve $14.23 / suction hose $65.65 25ft); spray Option 1 single center feed −$8 (manifold + 7 feed tubes + barbed taps retired, ¾" LDPE roll $31.24). Earlier: 90° down-jets 26→39; carbon Aquaboon; SV taps 36903; nitrile; tray shims $295.96.
