...
WATER = [
    ...
    LineItem("Captive tee-nut ply-mount hardware (#30 — ¼-20 + 5/16 pronged tee-nuts + zinc machine screws, all ply interfaces)", 29, 32, 34, "2026-08-07 (#30): every REMOVABLE ply-mount joint converts from a wood/lag screw to a zinc machine screw into a back-face 4-prong tee-nut (re-torqueable, no thread-strip). Firm: tnut-quarter Everbilt 825001 $1.57/4pk ×10 + tnut-fivesixteen Everbilt 825091 $1.57/4pk ×2. EST (zinc machine screws, price TBC): 5/16-18×2½\" (filters) + ¼-20×1\" (rest). Interfaces: skid row, ACC-01/02, 5× pump shirt, valve brackets, EP, shelf, Fan-B band, 3× filter housings."),
