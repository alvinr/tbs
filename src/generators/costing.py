...
WATER = [
    ...
    LineItem("IBC stacking frame (RHS deep 4-leg box + 4 feet + 8 retaining bars (2/tote face) + 8 identical 2-bolt hangers + 8 backing plates + 8 weld-on lashing rings + 4× 2\" transport straps + 4 anti-slip mats + fab)", 1175, 1441, 1709, "2026-08-14: front-bar→upright cleat bolts M12×40 doubled 8→16 with the 8 bars (+$12, Phase-A miss caught in Phase B). 2026-08-14: hangers/backing plates DOUBLED 4→8 (identical 2-bolt per-bar units for fab simplicity; wall penetrations unchanged at 16) +~$38/$66. 2026-08-14: front retaining bars DOUBLED 4→8 (+~$40 steel) + 4 certified anti-slip mats (+$40–80) after the EN 12195-1 loaded-transport case — a single weak-axis bar failed (SF 0.79); 2 bars/tote + mat give SF 1.59 bar-alone / 4.77 (ibc_frame_load.py). 2026-08-01: front-bar cleat bolts M12×40 firm McMaster 92314A744 $14.73/10. 2026-07-22: floor anchors → #14×3¼″ 410 SS self-drillers (land feet over crossmembers) −$14/−$44. 2026-07-25: wall-hanger through-bolts M12×40→M12×65 ×16 (grip fix) + M12 nuts/washers + 4 exterior 100×135×8 backing plates (+$59/+$72); front-bar cleats stay M12×40 ×8."),
