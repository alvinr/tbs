...
SHELF = [
    ...
    LineItem("Wall backing plates, 8mm steel welded (×3: cleat + 2 chain anchors)", 18, 24, 30, "flat load anchors on the corrugated end wall"),
    point("M8 hinge-cleat bolts + nuts/washers (×4)", 2, "M8×25 91280A534 + nut 90591A161 + washer 91166A270 — 1 per hinge bolt"),
