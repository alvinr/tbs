...
FILM = [
    ...
    LineItem("Belden UJ-SS750x375 U-joints (×4) + boots (×4)", 611, 611, 611, "2026-07-31: switched Ruland USKC12-6-6-SS ($276) -> Belden UJ-SS750x375 $112.68 ea (3/8in, 45deg, 303/416 SS; MROSupply, backup Grainger 806V18) -> -$653; boot -> Belden 806VF1 nitrile $40.25 ea (+$39)"),
