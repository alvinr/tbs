...
LIGHTLOCK = [
    ...
    LineItem("Rim-angle → beam TEK screws (~24× #14 self-drilling)", 8, 10, 12, "2026-08-25: rim-angle flat leg → steel frame beam now TEK-screwed (was welded Al→steel), Sheets 9/10. Est."),
