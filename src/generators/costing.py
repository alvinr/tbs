...
SECTIONS = [
    ...
    Section("5a", "Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)", 3353, 3386, 3418),  # KEEP IN SYNC WITH EXPECTED["power"] / total(POWER) — grand_total() sums this Section, not the POWER line items
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (26282, 30823, 37414),  # 2026-07-31: electrical re-price (ground-wire 20ft MTW $52, mppt ANL60 $6.99, led-connectors LDK-8A dimmers, dielectric-grease, powerpole housings). 2026-07-29: +$16 1" PVC recount 2→4 sticks. 2026-07-28: +$37 water (transition-adapter +$8, sump pickup +$45, spray Option 1 −$8). Earlier: external power panel penetration box; MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
    ...
    "film": (4361, 4587, 4815),  # 2026-07-27: blackout poly → Film-Gard 10ft 4-mil $40.12 (was 6-mil $66–70, −$26/−$30); Gorilla tape firm $9.94 ×6; saddle M8 thumbscrews ×12 McMaster $11.80. (2026-07-22: clamp → off-the-shelf nylon spring clamps + HDPE filler.)
    ...
    "power": (3353, 3386, 3418),   # 2026-07-31: mppt-charge-fuse itemized (Powerwerx 5005 block + ANL60), dielectric-grease $8.99, powerpole housings $0.55. 2026-07-28: external power panel FINAL — fabricated flanged wall-penetration box + flashing (weatherproof components exposed on the face, wired from inside), disconnect relocated to the EP. McMaster IP enclosure + wall gland retired (−$229/−$182). §5a authoritative subtotal
}
