...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28534, 33130, 39778),  # 2026-07-28: external power panel → fabricated penetration box + flashing (McMaster IP enclosure retired, −$229 low). Earlier: MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
