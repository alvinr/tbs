...
WATER = [
    ...
    LineItem("Filter skid (3× Big Blue 4.5×20 separate housings on mounting brackets + cartridges)", 451, 471, 492, "2026-07-22: U-bracket retired → lag screws to ply backing. 2026-07-25: housing standoff spacers → plywood offcuts. 2026-07-27: filter lag screws firm Everbilt 5-pack $7.09 ×2. 2026-07-27: skid frame → 3× Pentair 150061 zinc single-housing brackets $10.50 (was the $116.76 McMaster angle — purpose-built, −$85)"),
    LineItem("Valves and fittings (6× BV ball valves, X1 4-way cross, S60×6 adapters, CV1, SV-01 + SV-02 taps, Blue equalization tie, PVC slip tees/elbows/couplings/transition adapters, 2× service unions)", 1015, 1020, 1065, "2026-07-22: S60×6 adapter re-spec'd female-buttress×2\"NPT + 2→1\" bushing (CPP HMFN/20UD/027) +$48/+$24. 2026-07-27: Banjo valves/tees/elbows/3-ways sourced firm at US Plastic. 1\" PVC slip tees (PVC024001000HD $2.13) + elbows (PVC023001000HD $1.52) + slip×NPT transition adapters (PVC021090600HD $0.79/PVC021091000HD $1.16) firm at Home Depot; filter-jumper bundle retired into itemized pipe/elbows/adapters"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28300, 32973, 39736),  # 2026-07-27: filter cartridges (sediment +$38, KDF −$21) + X1 cross + piano hinge firm. Earlier: canopy 1" EMT, Big Blue 150234, the Home Depot/McMaster/Pentair sourcing run.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6407, 7147, 7923),  # 2026-07-27: sediment → Pentek DGD-5005-20 $30.83 ×2 (+$38 low); KDF cartridge → VEVOR $43.90 (−$21, verify media); X1 cross → Formufit furniture-grade 4-way $15.99. Earlier: Big Blue 150234; PVC run + Banjo firm.
