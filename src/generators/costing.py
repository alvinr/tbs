...
WATER = [
    LineItem("Water storage (4× IBC totes @ $150, 3× PP bulkhead fittings @ ~$18-35 ea, X1 fill tee)", 654, 680, 705, "2026-07-23: IBC totes firm ~$150/ea (reconditioned food-grade SoCal). 2026-07-29 SS audit: 2\" bulkheads 304 SS $136.70 → PP ~$18-35 (plain water port, SS over-spec) −$330."),
