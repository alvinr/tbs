...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28518, 33104, 39743),  # 2026-07-28: spray nozzles → 90° down-jets (39 @ 100mm pitch). Earlier: carbon/SV/nitrile, tray shim, transition adapters, IBC strap, X1 cross.
