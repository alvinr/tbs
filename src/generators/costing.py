...
WATER = [
    ...
    LineItem("Spray bar assembly (40×25 SS RHS beam, side LDPE manifold, 30 jets, manifold + 7 feed tubes, 4 Ø32 wheels, ball joint, arm + turned adapter + jam nut + clamp collar, hose)", 382, 418, 454, "2026-07-22: arm jam nut/collar/self-tap/beam-clamp re-priced to real SKUs. 2026-07-25: arm tube → McMaster 9056K36 8ft stock $64.03 (was a $6 500mm cut, too short to order) +$58"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28515, 33101, 39740),  # 2026-07-28: carbon cartridges +$48, SV taps +$19, nitrile firm; spray nozzles → DIG 90° jets −$20/−$40. Earlier: tray shim, transition adapters, IBC strap, X1 cross.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6622, 7275, 7927),  # 2026-07-28: carbon cartridges → Aquaboon $39.90 ×2 (+$48); SV-01/SV-02 taps → US Plastic 36903 $19.26 (+$19); nitrile gloves TitanFlex $14.99. Tray shims $295.96; transition adapters ½"/1"; IBC strap; X1 cross.
