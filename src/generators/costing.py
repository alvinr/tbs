...
WATER = [
    ...
    LineItem("Captive tee-nut ply-mount hardware (#30 — ¼-20 + 5/16 pronged tee-nuts + zinc machine screws, all ply interfaces)", 46, 46, 46, "2026-08-07 (#30): every REMOVABLE ply-mount joint converts from a wood/lag screw to a zinc machine screw into a back-face 4-prong tee-nut (re-torqueable, no thread-strip). All firm (Home Depot): tnut-quarter 825001 $1.57/4pk ×10 + tnut-fivesixteen 825091 $1.57/4pk ×2 + panel-machine-screws ¼-20×1\" 826771 $1.57/4pk ×10 + filter-machine-screws 5/16-18×2½\" 831121 $1.57 ea ×8. Interfaces: skid row, ACC-01/02, 5× pump shirt, valve brackets, EP, shelf, Fan-B band, 3× filter housings."),
...
FILM = [
    ...
    LineItem("Corner mechanism fasteners — M4 cam-clamp (×24) + M8 J1/J2 cross-slide (×32) + ACM→frame TEK (×30)", 51, 51, 51, "2026-09-06: itemized the last film-fab fastener gaps, all SKUs sourced except the M8 split washer (est). M4×12 91280A134 + M4 nut 91828A231; M8×20 92314A698 (J1/J2, tapped) + M8 flat washer 98689A673 + M8 split (est); SS self-drilling ACM screw 90599A716"),
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "film": (4058, 4286, 4520), # 2026-09-06: +$11 — M4 nut/M8 bolt/M8 flat washer SKUs firmed (up from est). 2026-09-06: +$40 — corner mechanism fasteners itemized (M4 cam-clamp ×24 + M8 J1/J2 ×32 + ACM→frame TEK ×30; several SKUs est pending). 2026-09-05: +$32 — skate axle-saddle retention itemized (16× 8992K794 saddles + 32× M6×20 91287A137 + 32× M6 nyloc; retires the M5 onto the shared M6 family). 2026-09-05: −$76 to −$135 — corner L-plate re-spec'd from a formed ¼ 6×8 plate ($58.90 ea firm ×4=$236) to stock 4×4×¼ 304 angle cut to length ($25–40/pc, re-quote); cheaper, no press-brake. 2026-08-20: −$161 — film-plane wall-seat saddles reconciled 6→4 (far-LEFT ends land on the pivot post; back-plate lengthened for the gusset; +2 far-left flange brackets w/ 8 M12). 2026-08-13: −1 — the M8 wall-fixing (bolt-m8-fixing) moved to the firm 304 A2 SKU 91310A535 $13.91/50, below the retired zinc placeholder. 2026-08-13: Belden SSNBUJ750x3/8KB needle-bearing keyed+booted U-joint (Grainger 41D816 $252.13 ea) replaces the plain UJ-SS750x375 + separate 806VF1 boot -> +~$403. # 2026-08-10 (corner blueprint): +$135 — cross-slide bars grown ~250→~345/365mm to hold ±40°/±28° (2× 8ft 304 bar, was 1×). 2026-08-01: corner L-plates firm Metal Supermarkets $58.90 ea ×4 = $236 (was $152-208 est). 2026-07-31: Ruland->Belden U-joint -$653 # 2026-07-27: blackout poly → Film-Gard 10ft 4-mil $40.12 (was 6-mil $66–70, −$26/−$30); Gorilla tape firm $9.94 ×6; saddle M8 thumbscrews ×12 McMaster $11.80. (2026-07-22: clamp → off-the-shelf nylon spring clamps + HDPE filler.)
