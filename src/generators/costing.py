...
WATER = [
    ...
    LineItem("IBC tote flexible connections (8× S60→2\"MNPT tote adapter + 2→1\" reducer + 1\" hose barbs M+F + SS clamps; hose off the tray-suction coil)", 216, 216, 216, "2026-07-29: flexible-jumper design (Alvin) — a semi-rigid panel flexing against fixed totes would fatigue a solvent-weld PVC joint, so a short 1\" flex hose de-couples each tote outlet. Granatan S60→2\"MNPT $13 + 2→1 reducer ~$4.50 + Banjo barbs (31527 $1.79 / 31544 $3.00) + Apollo SS clamps — ×8, hose cut from the tray-suction-hose 25ft coil. Research-sourced, confirm at order"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28700, 33280, 39912),  # 2026-07-29: +$16 1" PVC recount 2→4 sticks. 2026-07-28: +$37 water (transition-adapter +$8, sump pickup +$45, spray Option 1 −$8). Earlier: external power panel penetration box; MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6791, 7428, 8064),  # 2026-07-29: 1" PVC recount 2→4 sticks (+$16, IBC internal fill/drain). 2026-07-28: transition-adapter takeoff +$8; sump pickup firmed +$45; spray Option 1 single center feed −$8. Earlier: 90° down-jets 26→39; carbon Aquaboon; SV taps 36903; nitrile; tray shims $295.96.
