...
LIGHTLOCK = [
    ...
    LineItem("Stainless bolts (cap/ring/edge/stile/grab) + M10 rivet-nuts + nylon isolation washers", 45, 58, 70, "no galvanic couple; rivets/M8/M12 on separate lines"),
