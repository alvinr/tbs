...
WALKWAY = [
    ...
    LineItem("Right walkway center arms, solid 2×1 flat bar (×2)", 36, 48, 60, "2026-08-16: split out of the frame + switched hollow tube → SOLID 2×1 mild-steel flat bar (each arm is half-lapped over both long beams; a notched partial section must be solid). Notch rebalanced to the moment — deep at the tip, shallow at the post end (arm SF≈1.6; the outer beam takes the deep notch as a bearing seat, spanning SS on its full section). ~3ft cut ~$13/ft; ESTIMATE, firm at fab."),
