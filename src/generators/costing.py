...
LIGHTLOCK = [
    ...
    LineItem("M10 twist-resistant rivet-nuts ×20 (95105A199) + setting tool (96349A866)", 53, 53, 53, "$53 firm; 14 into the 3mm RHS beam wall (ring/collar→beam)"),
