...
WATER = [
    ...
    LineItem("Electrical (wiring only — fuse block in Electrical Report)", 36, 36, 36, "2026-07-31: powerpole 30A firm Powerwerx 10-pair pack $12.99 ($1.30/pair); blade fuse firm Amazon B07WP5FWJJ 100-pack $7.99"),
    LineItem("Processing consumables (6-mil poly, pH meter, citric acid, nitrile gloves)", 255, 255, 255, "2026-07-27: 6-mil poly firm Film-Gard $54.85; pH meter Apera AI311 $79.76. 2026-07-28: nitrile gloves firm TitanFlex $14.99 ×2. 2026-07-31: citric acid re-priced Amazon B0F1CKRT7G 6 lb $29.98 ×2 (+$32)"),
]
