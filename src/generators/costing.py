...
SECTIONS = [
    ...
    Section("5a", "Power & electrical system (solar · 1× LiFePO4 · MPPT · distribution · lighting · protection · master pump switch)", 3238, 3242, 3246),  # KEEP IN SYNC WITH EXPECTED["power"] / total(POWER) — grand_total() sums this Section, not the POWER line items
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28763, 33335, 39960),  # 2026-07-28: MC4 bulkheads → Powerwerx passthrough $2.99/pair (−$16). Earlier: cooler AC outlet, PV disconnect Blue Sea 6006, ext power-panel IP enclosure.
    ...
    "power": (3238, 3242, 3246),   # 2026-07-28: MC4 bulkheads firm — Powerwerx passthrough $2.99/pair ×3 (was $8.33, −$16). Cooler AC outlet added; PV disconnect Blue Sea 6006; external power panel → McMaster IP enclosure. §5a authoritative subtotal
}
