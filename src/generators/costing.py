...
LIGHTLOCK = [
    ...
    LineItem("Bolts/nuts/isolation washers — cap/ring/collar/stile/handle/edge/housing (SS)", 87, 87, 87, "≈$91 firm, McMaster (F1–F7 + W; one pack per line). 2026-08-25: F2/F3 ring/collar→beam → CSK M10 91294A334 $5.22/10 (was hex 91280A634 $16.64/25), −$6."),
    ...
    LineItem("1/8\" blind rivets — brush-holder → drum OD (97447A015, 250-pack)", 11, 11, 11, "$10.78 firm; ~72 fastening the Al holder flanges to the drum"),
