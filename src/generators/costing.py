...
WALKWAY = [
    ...
    LineItem("Right walkway cantilever frame, 2×1×0.120in steel (~6m)", 125, 139, 153, "#26 (2026-08-07): 2×⅞ non-stock → 2×1×0.120 (MetalsDepot $76.20/12ft = $6.35/ft; 2 sticks). Closed rectangle + 2× 325mm center arms picking it up at mid-span. Old $28-40 was a guess for the non-stock section."),
