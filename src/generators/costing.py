...
LIGHTLOCK = [
    ...
    LineItem("Al straight-flange holders for the #4 wiper brush ×4 (8 ft)", 72, 116, 159, "flange-riveted to the drum OD — rivets clear of the brush; est. (rounds to registry)"),
    ...
    LineItem("Ø25 SS grab bar — 16\" bolt-on (marine)", 25, 35, 45, "off-the-shelf; BOLTED to the stile (2× M8 tapped per foot), not welded"),
    LineItem("40×40×5 SS RHS grab-bar stile (cap→cap) + M12 cap bolts", 50, 73, 95, "carries the pull load into the Al caps (not the HDPE wall); est."),
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "lightlock": (2818, 3363, 3902), # 2026-08-24b: drum-brush/holder re-spec + off-the-shelf grab bar — wiper 74715T2→#4 strip brush (4× $22–40) + NEW Al straight-flange holders (4× $18–40); grab bar bolted (not welded); stile 40×40×3→×5. Was (2761, 3223, 3681). Earlier 2026-08-24: metal-cap / lap-joint / edge-channel / drum-brush / stile batch — added Al caps (est $400–700), rim-angle (est $45–90), SS rivets, DP8010, Al edge channels, handle stile; caps HDPE→Al, wiper felt→brush. Al-plate/rim-angle/DP8010/edge/stile/brush/holder prices are ESTIMATES (firm at the Aug-2026 re-price). Was (2046, 2280, 2516)
