...
WALKWAY = [
    ...
    LineItem("Walkway-arm J6 end-plate hardware (8× M12×100 + 4 plates 70×130×8 + 8 crush sleeves)", 33, 44, 55, "2026-08-16: the arm→upright joint is a bolted END-PLATE (welded to arm) + rear backing plate + 4 M12/arm through the upright, with an internal crush sleeve/bolt (mirrors the container-wall cantilever detail). ESTIMATE — firm SKUs at fab."),
