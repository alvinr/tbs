...
WATER = [
    ...
    LineItem("Spray bar assembly (1½×1½ SS square beam full-width, side LDPE manifold, 44 jets, single center feed, 4 Ø32 wheels, ball joint, arm + turned adapter + jam nut + clamp collar, hose)", 584, 587, 596, "2026-08-03: beam → 1½×1½×0.062 single 17ft4in Metals Depot $183 (was 40×25 $153.80) + nozzles 4→5×10-pk (44 used, full beam width) = +$34. 2026-07-28: Option 1 single center feed −$8 — ¾\" LDPE over-bored for the flow. 2026-08-01: carriage plate firm Metal Supermarkets 12×20×3/16 6061 $124.88."),
