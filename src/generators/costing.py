...
FILM = [
    ...
    point("Saddle fasteners — M12×90 through-bolts (×28) + M8 thumbscrews (×12) + M8 hex bolts (×8)", 112, "ICP-12/13/14; M12×90 verified $1.83 ea (91310A145, $18.31/pk-10)"),
]
