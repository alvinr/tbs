...
FILM = [
    ...
    LineItem("Acetal skates (×4) — Ø32/Ø20 acetal rollers + Ø10 316 axles + fab carriage plates", 332, 383, 436, "2026-07-22: decomposed to off-the-shelf rollers/axles + fab plate; Ø10 316 axle rod 1265K81 $88.13/600mm firm"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (25257, 30944, 38500),  # 2026-07-22: retired duplicate image-plane-backing ACM (−$490/−$620). Per-change history in git log.
    ...
    "optics": (110, 185, 265),
    "film": (5891, 6175, 6461),  # updated 2026-07-22: muslin clamp mechanism → off-the-shelf nylon spring clamps (×58) + HDPE filler; retired the custom bracket/spring/neoprene (−$189/−$531). Detail in git log.
