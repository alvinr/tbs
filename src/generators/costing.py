...
LIGHTLOCK = [
    ...
    LineItem("Bearing retaining rings — 4× DIN 471 (inner) + 1× DIN 472 (outer, upper)", 8, 11, 15, "2026-08-25: axial retention — upper outer race LOCATED (shoulder + DIN 472), lower FLOATS; previously uncosted. Est."),
