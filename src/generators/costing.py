...
LIGHTLOCK = [
    ...
    LineItem("Al U-channel opening-edge stiffeners (×4) + L-clips + M8", 55, 83, 110, "housing free-edge stiffeners (replaces the jamb posts); rivet-only 2026-09-08; est."),
