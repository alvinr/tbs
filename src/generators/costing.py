...
SHELF = [
    point("UV-coated white plywood, 18mm (4×8 sheet, cut to 300×600)", 74, "2026-07-27: Swaner UV-White ply $73.28, Home Depot"),
    point("25×25×3mm steel SHS — frame + spill lip (6m)", 30, "Online Metals / Metal Supermarkets"),
    LineItem("Continuous (piano) hinge, 600mm", 23, 23, 23, "2026-07-27: firm — Würth LSN8-32-600 weld-on $23.56, Wurth Baer Supply (32mm open × 600mm)"),
    ...
    point("½\" PVC Sch-40 pipe — TAP-01 trunk extension (~1.5m)", 4, "2026-07-27: IPEX ½\" 30-05010HD $4.81, Home Depot"),
]
