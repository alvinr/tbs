...
WATER = [
    ...
    LineItem("Filter skid (3× Big Blue 4.5×20 separate housings on mounting brackets + cartridges)", 435, 477, 521, "2026-07-22: U-bracket retired → lag screws to ply backing. 2026-07-25: housing standoff spacers → plywood offcuts. 2026-07-27: filter lag screws firm Everbilt 5-pack $7.09 ×2. 2026-07-27: skid frame → 3× Pentair 150061 zinc single-housing brackets $10.50 (was the $116.76 McMaster angle — purpose-built, −$85)"),
    LineItem("Valves and fittings (6× BV ball valves, X1 4-way cross, S60×6 adapters, CV1, SV-01 + SV-02 taps, Blue equalization tie, PVC slip tees/elbows/couplings/transition adapters, 2× service unions)", 1007, 1015, 1063, "2026-07-22: S60×6 adapter re-spec'd female-buttress×2\"NPT + 2→1\" bushing (CPP HMFN/20UD/027) +$48/+$24. 2026-07-27: Banjo valves/tees/elbows/3-ways sourced firm at US Plastic. 1\" PVC slip tees (PVC024001000HD $2.13) + elbows (PVC023001000HD $1.52) + slip×NPT transition adapters (PVC021090600HD $0.79/PVC021091000HD $1.16) firm at Home Depot; filter-jumper bundle retired into itemized pipe/elbows/adapters"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28177, 32882, 39677),  # 2026-07-27: Big Blue housings → verified Pentek 150234 $83.30 (+$35). Earlier: canopy 1" EMT; the Home Depot/McMaster/Pentair sourcing run.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6383, 7148, 7950),  # 2026-07-27: Big Blue housings verified Pentair Pentek 150234 $83.30 ×3 (1" NPT + standard cartridges, was 150468 $71.51). pH meter Apera AI311 $79.76; SeaFlo $35.99; filter-skid Pentair brackets; PVC run + Banjo firm.
    ...
    "shelf": (222, 235, 247),          # 2026-07-27: TAP-01 PVC extension firm IPEX ½" $4.81. Earlier: Swaner UV-White work surface $73.28.
