...
WATER = [
    ...
    LineItem("Pumps and accumulator (P-01..P-05 + ACC-01; mount bracket ships with each pump)", 536, 536, 536, "2026-07-27: 5× Shurflo 2088 consolidated → 1 line, firm $100 ea (Amazon B00C1M6B1C, was $80–89). 2026-07-31: shurflo-bracket retired — integral to the 2088 pump (−$50)"),
    ...
    LineItem("Spray bar assembly (40×25 SS RHS beam, side LDPE manifold, 40 jets, single center feed, 4 Ø32 wheels, ball joint, arm + turned adapter + jam nut + clamp collar, hose)", 551, 554, 563, "2026-07-22: arm jam nut/collar/self-tap/beam-clamp re-priced to real SKUs. 2026-07-25: arm tube → McMaster 9056K36 8ft stock $64.03 (was a $6 500mm cut, too short to order) +$58. 2026-07-28: Option 1 single center feed −$8 — ¾\" LDPE over-bored for the flow, so the distribution manifold + 7 feed tubes + barbed-tee taps retired. 2026-08-01: carriage plate firm Metal Supermarkets 12×20×3/16 6061 $124.88 (+$100 vs old est; cut-to-size retail, online sheet likely cheaper — compare at purchase)"),
