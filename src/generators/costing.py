...
LIGHTLOCK = [
    ...
    LineItem("Formed-Al strip channel-support beams (×4) + rivets", 20, 32, 45, "one across each housing opening top+bottom, rail-to-rail (~962mm) so the U-channels rivet to a member; SS blind-riveted to the frame beams; smallest formed section (SKU pending); est."),
