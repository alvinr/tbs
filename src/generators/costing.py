...
SHELF = [
    ...
    point("1/4-20 pronged tee-nuts — ply attach (×3 4-pack)", 4, "825001 $1.57/4pk — ply-mount standard, replaces the M5 CSK"),
    LineItem("1/4-20 SS machine screws — hinge (×8)", 3, 4, 5, "SS wet-zone exception to the zinc ply-mount screw; SKU pending"),
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "shelf": (223, 230, 237), # 2026-09-07: ply-primary redesign — steel frame/stays/M5/gussets out, SS chain stays + tee-nut attach + bolt-on hinge + cam latch in. 2026-07-27: piano hinge firm Würth LSN8-32-600 weld-on $23.56 (was $22.68–35.72). Earlier: Swaner UV-White work surface $73.28.
