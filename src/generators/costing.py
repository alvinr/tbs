...
WATER = [
    ...
    LineItem("Valves and fittings (6× BV ball valves, X1 4-way cross, S60×6 adapters, CV1, SV-01 + SV-02 taps, Blue equalization tie, PVC slip tees/elbows/couplings/transition adapters, 2× service unions)", 1005, 1010, 1055, "2026-07-22: S60×6 adapter re-spec'd female-buttress×2\"NPT + 2→1\" bushing (CPP HMFN/20UD/027) +$48/+$24. 2026-07-27: Banjo valves/tees/elbows/3-ways sourced firm at US Plastic. 1\" PVC slip tees (PVC024001000HD $2.13) + elbows (PVC023001000HD $1.52) + slip×NPT transition adapters (PVC021090600HD $0.79/PVC021091000HD $1.16) firm at Home Depot; filter-jumper bundle retired into itemized pipe/elbows/adapters"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (28326, 32999, 39762),  # 2026-07-27: KDF Aquaboon +$36, X1 cross re-sourced $5.99. Earlier: canopy 1" EMT, Big Blue 150234, the Home Depot/McMaster/Pentair sourcing run.
    "walkway": (1979, 2395, 2825),  # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6433, 7173, 7949),  # 2026-07-27: KDF cartridge → Aquaboon KDF-55 $79.83 (proper media, +$36); X1 4-way cross confirmed (recycle joins X1) re-sourced Amazon $5.99 (−$10 vs furniture-grade). Earlier: sediment Pentek $30.83; Big Blue 150234.
