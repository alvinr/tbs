...
WATER = [
    ...
    LineItem("Valves and fittings (6× BV ball valves, X1 4-way cross, CV1, SV-01 + SV-02 taps, Blue equalization tie, PVC slip tees/elbows/couplings/transition adapters, 2× service unions)", 802, 802, 802, "2026-08-07: 2-way BVs re-sourced Banjo V050FP → Grainger 803HZ1 $24.14 (was US Plastic $44.27), −$121 across 6. BV-05 spray selector still a 2-way placeholder (real 3/4\" 3-way L-port V075BL price TBC). 2026-08-04: +2× ½\" adapters for ACC-02's inline IN+OUT landings (+$2). 2026-07-27: Banjo valves/tees/elbows/3-ways sourced firm at US Plastic. 1\" PVC slip tees (PVC024001000HD $2.13) + elbows (PVC023001000HD $1.52) + slip×NPT transition adapters (PVC021090600HD $0.79/PVC021091000HD $1.16) firm at Home Depot; filter-jumper bundle retired into itemized pipe/elbows/adapters. 2026-07-28: transition-adapter P&ID takeoff — ½\" 18→22, 1\" 22→26 (+$8). 2026-07-29: the S60×6 IBC-tote adapters moved to their own 'IBC tote flexible connections' line (below); line firmed"),
