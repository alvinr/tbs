...
FILM = [
    ...
    LineItem("Acetal skates (×4) — Ø32/Ø20 acetal rollers + Ø10 316 axles + fab carriage plates", 221, 290, 361, "2026-07-22: decomposed to off-the-shelf rollers/axles (8576K23 etc.) + fab plate"),
...
EXPECTED = {                       # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (25146, 30851, 38425),  # 2026-07-22: retired duplicate image-plane-backing ACM (−$490/−$620). Per-change history in git log.
    ...
    "optics": (110, 185, 265),
    "film": (5780, 6082, 6386),  # updated 2026-07-22: muslin clamp mechanism → off-the-shelf nylon spring clamps (×58) + HDPE filler; retired the custom bracket/spring/neoprene (−$189/−$531). Detail in git log.
