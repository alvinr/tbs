...
WALKWAY = [
    ...
    LineItem("Right walkway center arms, solid 2×1 flat bar (×2)", 91, 91, 91, "2026-08-16: FIRM — Metal Supermarkets 2×1 solid bar $91.32 / 36in cut (one stick covers both arms + spare). Retail cut-to-size (steel-yard bulk cheaper, but min-cut fine for 2 short pieces). SOLID (not tube) so the half-lap notch keeps its strength; notch rebalanced to the moment — deep at the tip, shallow at the post end (arm SF≈1.6; outer beam takes the deep notch as a bearing seat)."),
    ...
    LineItem("M12×70 partial-thread bolts + nuts/washers (~20)", 53, 53, 53, "91280A732 $1.736 + plain nut + 4 flat + split /bolt; wall cleats + combined plates (the 2 center arms moved to the J6 end-plate line below, −4 bolts)"),
    LineItem("Walkway-arm J6 end-plate hardware (4× M12×100 + 4 plates 55×130×8 + 4 crush sleeves)", 23, 31, 40, "2026-08-16c: 2 bolts/arm (central vertical column) not 4 — the couple is the vertical spacing, so a central column keeps max edge distance on the plate + post (−4 bolts, −4 sleeves, plate 70→55). 2026-08-16: bolted END-PLATE (welded to arm) + rear backing plate + M12 through the upright, internal crush sleeve/bolt. ESTIMATE — firm SKUs at fab."),
    LineItem("Half-lap hold-down screws (#14 TEK + washer, ×4)", 2, 3, 4, "2026-08-16: 1 self-drilling TEK screw per half-lap (2 arms × 2 crossings), from the underside through a Ø7 clearance hole in the beam into the solid arm — positively secures the beam to the bearing seat (410 SS, J8/J9 family)."),
...
WATER = [
    ...
    LineItem("IBC stacking frame (RHS deep 4-leg box + 4 feet + 8 retaining bars (2/tote face) + 8 identical 2-bolt hangers + 8 backing plates + 8 weld-on lashing rings + 4× 2\" transport straps + 4 anti-slip mats + fab)", 1183, 1450, 1717, "2026-08-18: −$16 — J2 corridor cleat redesigned to an L-angle + 1 HORIZONTAL bolt per cleat (16→8 M12×65 SS; the bar drops into the L and the single bolt goes through the tall 50mm web for proper edge distance — Alvin). 2026-08-17b: J2/J7 M12×65 SS FIRM — McMaster 92800A481 partial-thread $9.95/5 ($1.99/ea, was est $2.00-2.80). 2026-08-17: +$13/$32 — J2 corridor cleat + J7 wall-end bolts M12×40→M12×65 (both span the ~58mm bar per Detail B / the 3D). 2026-08-15: J7 wall-end retention REVERTED to 1 centered/bar (16→8 M12×40; the 2nd was redundancy not strength + crowded the seat; −$12). 2026-08-14: +8 M12×40 wall-end bar RETENTION bolts (J7, 1/bar — the bar is bolted, not welded, to the hanger pocket; +$12). 2026-08-14: front-bar→upright cleat bolts M12×40 doubled 8→16 with the 8 bars (+$12, Phase-A miss caught in Phase B). 2026-08-14: hangers/backing plates DOUBLED 4→8 (identical 2-bolt per-bar units for fab simplicity; wall penetrations unchanged at 16) +~$38/$66. 2026-08-14: front retaining bars DOUBLED 4→8 (+~$40 steel) + 4 certified anti-slip mats (+$40–80) after the EN 12195-1 loaded-transport case — a single weak-axis bar failed (SF 0.79); 2 bars/tote + mat give SF 1.59 bar-alone / 4.77 (ibc_frame_load.py). 2026-08-01: front-bar cleat bolts M12×40 firm McMaster 92314A744 $14.73/10. 2026-07-22: floor anchors → #14×3¼″ 410 SS self-drillers (land feet over crossmembers) −$14/−$44. 2026-07-25: wall-hanger through-bolts M12×40→M12×65 ×16 (grip fix) + M12 nuts/washers + 4 exterior 100×135×8 backing plates (+$59/+$72); front-bar cleats stay M12×40 ×8."),
...
FILM = [
    ...
    point("Saddle fasteners — M12×65 through-bolts (×28) + M8 thumbscrews (×12) + M8×25 hex bolts (×8)", 211, "ICP-12/13/14; M12×65 91280A728 + plain nut 90591A181 + 4 flat 91166A290 + split 91202A246 per bolt; M8×25 fixing 91280A534 $0.37. 2026-07-27: M8 thumbscrews ×12 sourced McMaster 92581A540 $11.80 ea (was $3 est, +$106). 2026-08-13: −1 reconcile — the M8 fixing (bolt-m8-fixing) moved to the firm 304 A2 SKU 91310A535 $13.91/50, below the retired zinc placeholder."),
]
...
EXPECTED = { # the figures the docs are reconciled to (this session)
    ...
    "grand_total": (26783, 31299, 37887), # 2026-08-18: −$16/$15/$16 ibc-frame (J2 corridor cleat → L + 1 horizontal bolt, 16→8 M12×65 SS). 2026-08-16c: −$10/$13/$15 walkway (J6 4→2 bolts/arm, central column). 2026-08-16b: +$2/$3/$4 walkway (4× #14 TEK half-lap hold-down). 2026-08-16: +$62/$85/$108 walkway (RWK center arms → solid 2×1 flat bar + J6 end-plate hardware). 2026-08-15: +$11/$20 water (36 TEK bracket→post screws, J8/J9). 2026-08-15: −$12 ibc-frame (J7 reverted to 1 centered/bar, 16→8 M12×40). 2026-08-14: +$12 ibc-frame (8 M12×40 wall-end bar retention bolts J7 — bar bolted, not welded, to the hanger). 2026-08-14: +$38/$66 ibc-frame (hangers/plates doubled to identical 2-bolt per-bar units). 2026-08-14: +$40/$80 ibc-frame (doubled retaining bars + anti-slip mats, EN 12195-1 loaded case). 2026-08-13: net +2 — M6 spray fasteners +3 (304 A2 91287A137) less M8 film fixing −1 (304 A2 91310A535). 2026-08-13: +~$403 film — Belden SSNBUJ750x3/8KB needle-bearing keyed+booted U-joint (41D816) replaces plain UJ-SS750x375 + separate boot. 2026-08-10 (corner blueprint): +$135 film — cross-slide bars grown for ±40°/±28°. 2026-08-08 (#29): +$33/$46/$61 pump-run supports. 2026-08-07 (#26): +$107/+$123 walkway — real 2×1 section pricing. # 2026-08-07 (#29): +$54 water — pump flex both ports. # 2026-08-07 (#30): +$32/+$32/+$32 water — captive tee-nut ply-mount hardware (¼-20 + 5/16 pronged tee-nuts firm $1.57/4pk + zinc machine screws est) less the retired filter lag screws. 2026-08-07: −$120 water — 2-way BVs re-sourced to Grainger 803HZ1 $24.14 (was US Plastic $44.27), 6× valves. 2026-08-05: +$58 water — pinhole-wall filter-skid backing ply (previously uncosted). 2026-08-04: +$38 water — 2nd accumulator ACC-02 (recycle-spray damper, $36) + 2× ½" adapters ($2). 2026-08-02: tray SS sheet #4→2B mill finish (−$110/−$150 est, drain pan needs no brush — tray-research.md). 2026-08-01: ibc-frame M12×40 cleat bolts firm McMaster 92314A744 $14.73/10. 2026-08-01: corner L-plates firm $58.90 ea ×4 (+$28-84). 2026-08-01: GHS labels firm $23.99 (pictogram perforated); spray zip ties HF $2.68; SS beam → single 16ft 0.062in Metals Depot $153.80 (no butt weld, sag-checked; −$394) + carriage plate $124.88. 2026-07-31: water re-price round 2 — shurflo-bracket retired (ships w/ pump −$50), pipe clips/wire/pH buffers firmed −$15. 2026-07-31: citric acid +$31; electrical section CLOSED — all parts sourced (bonding-kit Panduit $95.79, wet-zone DT pairs $27.42, ground-wire MTW $52, mppt ANL60 $6.99, led-connectors, dielectric-grease, powerpole). 2026-07-29: +$16 1" PVC recount 2→4 sticks. 2026-07-28: +$37 water (transition-adapter +$8, sump pickup +$45, spray Option 1 −$8). Earlier: external power panel penetration box; MC4 bulkheads, cooler outlet, PV disconnect, spray 90° jets.
    "walkway": (2195, 2623, 3076), # 2026-08-16d: +$55/+$43/+$31 — arm FIRM price (Metal Supermarkets $91.32/36in cut vs the $36-60 est). 2026-08-16c: −$10/−$13/−$15 — J6 4→2 bolts/arm (central column) less 4 M12×100 + 4 crush sleeves. 2026-08-16b: +$2/+$3/+$4 — 4× #14 TEK half-lap hold-down screws. 2026-08-16: +$62/+$85/+$108 — RWK center arms hollow tube → SOLID 2×1 flat bar (split out) + J6 end-plate hardware (8× M12×100 + 4 plates + 8 crush sleeves) less 4 arm-clamp M12×70. # 2026-08-07 (#26): +$107/+$123 — RWK frame 2×⅞ (non-stock) → 2×1×0.120 real MetalsDepot price + floor-leg arms 2×1. # 2026-07-23b: bump extended 2nd rib toward IBC — 1 near bracket std->widened (+$12/$22)
    "water": (6715, 7338, 7971), # 2026-08-18: −$16/$15/$16 ibc-frame (J2 corridor cleat → L-angle + 1 horizontal bolt, 16→8 M12×65 SS). 2026-08-15: +$11/$20 — 36 TEK bracket→post screws (J8/J9, brackets no longer welded). 2026-08-15: −$12 ibc-frame — J7 reverted to 1 centered/bar (16→8 M12×40). 2026-08-14: +$12 ibc-frame — 8 M12×40 wall-end bar retention bolts (J7; bar bolted, not welded, to the hanger). 2026-08-14: +$38/$66 ibc-frame — hangers/backing plates doubled to 8 identical 2-bolt per-bar units (fab simplicity). 2026-08-14: +$40/$80 ibc-frame — 8 retaining bars (doubled) + 4 anti-slip mats (EN 12195-1 loaded-transport case). 2026-08-13: +3 spray — carriage/beam-clamp/saddle M6 fasteners (bolt-m6x20) upgraded zinc→304 A2 (McMaster 91287A137 $17.77/50). 2026-08-08 (#29): +$33/$46/$61 — pump-run support boards + 12 L-brackets + 39 P-clips (corridor/spine/skid). 2026-08-07 (#29): +$54 pump flex both ports (braided +1 length + barbs + clamps). # 2026-08-07 (#30): +$32/+$32/+$32 — captive tee-nut ply-mount hardware (tee-nuts firm + zinc machine screws est) less retired filter lag screws. 2026-08-05: +$58 — pinhole-wall filter-skid backing ply (previously uncosted, ~1795×1440 exterior, pieced 2 sheets @ $29.30). 2026-08-04: +$38 — 2nd accumulator ACC-02 (recycle-spray damper on the filter skid, $36) + 2× ½" adapters for its inline landings ($2). 2026-08-01: §5 — tray SS sheet #4→2B finish (−$110/−$150 est); ibc-frame front-bar bolts M12×40 firm McMaster 92314A744 $14.73/10; GHS labels firm $23.99 (pictogram perforated); spray zip ties HF $2.68, SS beam single 16ft 0.062in Metals Depot $153.80 (no weld, −$394), carriage plate $124.88. 2026-07-31: water re-price — shurflo-bracket retired (−$50), clips/wire/pH buffers firmed; net −$34 from citric acid +$31. 2026-07-29: 1" PVC recount 2→4 sticks (+$16, IBC internal fill/drain). 2026-07-28: transition-adapter takeoff +$8; sump pickup firmed +$45; spray Option 1 single center feed −$8. Earlier: 90° down-jets 26→39; carbon Aquaboon; SV taps 36903; nitrile; tray shims $295.96.
