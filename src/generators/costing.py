...
WALKWAY = [
    ...
    LineItem("M12×65 partial-thread bolts + nuts + washers (×58)", 118, 118, 118, "91280A728 $1.595 ea + M12 nuts + 4 washers/bolt; 3 per std bracket (42) + 4 per widened (16)"),
    ...
    LineItem("M12×70 partial-thread bolts + nuts/washers (~24)", 52, 52, 52, "91280A732 $1.736 ea + M12 nuts + 4 washers/bolt; wall cleats + combined plates + 2 center-arm U-clamps"),
...
FILM = [
    ...
    point("Saddle fasteners — M12×65 through-bolts (×28) + M8 thumbscrews (×12) + M8 hex bolts (×8)", 109, "ICP-12/13/14; M12×65 partial-thread verified $1.595 ea (91280A728, $15.95/pk-10) + 4 washers/bolt"),
]
