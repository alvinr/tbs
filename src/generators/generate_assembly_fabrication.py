...
from tbs_constants import C_LEN, C_WID, C_HGT, FP_X_L, FP_X_R, FP_Y, PH_X, PH_H, ZONE_L_END, ZONE_R_START, DRUM_CX, DRUM_D, DRUM_R, DRUM_H_LT, EVAP_DUCT_X, EVAP_DUCT_D, EVAP_DUCT_Z, EP_X, EP_W, EP_H_LO, EP_H_HI, BA_X, BA_W, BA_H_LO, BA_H_HI, PUMP_X, PUMP_W, PUMP_H_LO, PUMP_H_HI, PWR_PANEL_X, PWR_PANEL_W, PWR_PANEL_H, PWR_PANEL_Z, IBC_COL_X, IBC_W, IBC_H_STK_1000, IBC_H_1000, PANEL_CORNER_T, PANEL_CENTER_T, PIVOT_X, PIVOT_YD, SWING_LOCK_DEG, RAIL_X_L, RAIL_X_R, FAN_A_H, FAN_B_H, FAN_B_YD, FAN_DIAM, DUCT_HEIGHT, DIAGRAMS_DIR, C_OUT, C_CL, C_DIM, C_WASTE_IBC, C_LT_DRUM, C_BLUE_IBC, C_BROWN_IBC, C_ELEC, C_BATT, C_PUMP
