...
# ── Mini-TBS geometry — single-sourced (shared with the 3D model) ────────────
# All box/panel/paper/pinhole dimensions live in mini_tbs_constants.py so the 2D
# drawing and the SketchUp model (src/models/generate_mini_tbs_model.py) can't drift.
from mini_tbs_constants import *  # noqa: F401,F403 (BOX_*, PANEL_*, PAPER_*, SLEEVE_*, WALL_T, PH_D, …)
