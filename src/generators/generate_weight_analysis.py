...
def _lighttrap_weight():
    ...
    # Rotating drum: HDPE C-shell Ø864 (one 80° opening) + 2 C-shaped caps
    ...
    drum_cap_kg = 2 * cap_area * (LT_CAP_T / 1000.0) * RHO_HDPE   # 3/16" caps (thicker than shell — hub/bearing load path)
...
def build_components():
    ...
    components = [
        ...
        Component("Film depth rails", "structure",
                  ...
                  100, C_HGT - 100, color=C_ALUM,
                  calc_note="4× 6061-T6 Al U-channel 76×38×4.78mm × 2,362mm (fixed film-plane depth rails, wall-to-wall along the optical axis) — 681mm²×2362mm×4×2.70 g/cc ≈ 17.4 kg. Previously OMITTED from the mass model; added SS audit 2026-07-29 (was ~51 kg in 304 SS before the Al downgrade)."),
