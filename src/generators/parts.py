...
PARTS: list[Part] = [
    ...
    Part("corner-l-plate", "Corner bracket L-plate (6061, anodized)", "aluminum",
         "film", 4, "ea", 20, 20, "Metal Supermarkets", "Online Metals",
         spec='¼" 6061-T6 alum. plate, clear-anodized, 6"×8" — the frame-corner ↔ U-joint bracket. EXPENDABLE, same wet-zone caveat as the frame angle: anodized 6061, inspect-annually / replace-on-pitting.'),
