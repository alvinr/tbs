...
PARTS: list[Part] = [
    ...
    Part("tsb-wave-spring", "Annular wave spring — carrier preload (ICP-03)", "bearings-motion",
         ...
         spec="ICP-03 preload: ~Ø300 mean-dia crest-to-crest wave spring (17-7 PH SS), bears on the carrier interior rim to seat it on the 4 adjuster balls (zero backlash). Replaces the former central GE50 bearing — the carrier is now rim-supported and the optical axis is clear. Large-dia custom coil — SKU pending (Smalley / Associated Spring)."),
    Part("tsb-retaining-ring", "Preload retaining ring — Al (ICP-03)", "aluminum",
         "front-board", 1, "ea", 30, 60, "local machine shop",
         spec="ICP-03 preload: 6061-T6 annular ring Ø470 OD × Ø286 ID × 8mm, standoff-mounted to ICP-01's interior face (6× M5 @ Ø450, outside the bellows) to react the wave-spring preload. Waterjet blank + light machining. SKU pending — fab quote."),
    Part("tsb-ring-screws", "M5×30 SHCS 18-8 SS (retaining-ring standoff)", "fasteners-hardware",
         "front-board", 1, "pack", 8, 8, "McMaster-Carr", "Bolt Depot",
         spec="6 off — standoff screws mounting the preload retaining ring to ICP-01 at Ø450 (tapped). M5×30 SHCS 18-8 SS, pack of 25 — SKU pending (source)."),
    ...
    Part("tsb-delrin-bushing", "Delrin/POM guide bushing rod", "plastics-sheet",
         ...
         spec="Ø30×200mm Delrin/POM rod — machine the 4 adjustment-screw guide bushings. McMaster 8573K75."),
    ...
    Part("tsb-cnc", "CNC machining — ICP-01 + ICP-02 (service)", "fabrication-labor",
         ...
         spec="All-aluminum machining of both plates (Ø380 bore, kinematic-seat + insert bores, wave-spring land, retaining-ring standoff tap pattern, PCDs, labyrinth, counterbore). SKU pending — get a fab quote (Fictiv / ProtoLabs)."),
