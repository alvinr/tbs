...
PARTS: list[Part] = [
    ...
    Part("fp-skate-axle", "Ø10 316 SS rod — skate axles (cut ×16)", "steel-structural",
         "film", 2, "1 ft rod", 33, 50, "McMaster-Carr",
         spec="Ø10 316 SS rod for the skate axles — 4 per skate × 4 = 16, cut to ~30mm; ~2 ft total. 316 for the wet cyanotype zone. Pin the McMaster Ø10 316-rod SKU at order."),
