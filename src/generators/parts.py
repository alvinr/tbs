...
PARTS: list[Part] = [
    ...
    Part("bolt-m6-tray", "M6×16 hex bolt, 316 SS — tray center-seam lap joint", "fasteners-hardware",
         "tray", 12, "ea", 0.92, 0.92, "McMaster-Carr", spec="Tray center-seam LAP-joint bolts (316 SS, wet zone) + M6 serrated flange nuts underneath. Through both overlapped 1.5mm panels + silicone bed. Grip ≈ 4mm → M6×16 (short → fully threaded). Needs an M6×16 316-SS SKU at re-price."),
