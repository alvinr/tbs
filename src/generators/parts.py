...
PARTS: list[Part] = [
    ...
    Part("mppt-charge-fuse", "MPPT charge-line fuse — 60A ANL + holder", "electrical-distribution",
         "electrical", 1, "ea", 15, 15, "Blue Sea", "Amazon", part_no="5005", url="https://www.bluesea.com/products/5005",
         spec="Blue Sea 5005 ANL fuse block/holder + Blue Sea 5123 60A ANL fuse (bluesea.com/products/5123). Protects the MPPT→battery 6 AWG charge lead close to the battery (§7.3). Price held at $15 est — CONFIRM at order: the 5005 holder alone typically runs ~$26 + the 5123 fuse ~$8, so this line may rise to ~$34."),
    Part("shore-output-fuse", "Shore-charger output fuse — 20A inline (sealed holder + fuse)", "electrical-distribution",
         "electrical", 1, "ea", 5, 5, "Waytek Wire", part_no="46047", url="https://www.waytekwire.com/product/sealed-ato-atc-fuse-holder-assembly-46047",
         spec="Waytek 46047 sealed (waterproof) in-line ATO/ATC fuse-holder assembly + Waytek 47020 20A ATOF blade fuse (Littelfuse 0287020). On the shore-charger output lead. Price $5 est — confirm at order."),
    Part("battery-terminal-covers", "Battery terminal covers (pair), insulating boots", "electrical-distribution",
         "electrical", 1, "pair", 10, 10, "Waytek Wire", part_no="23501", url="https://www.waytekwire.com/product/23501-straight-in-battery",
         spec="Waytek 23501 (VTE 415N6V02) red + 23500 (VTE 415N6V14) black straight-in battery boots, 6-4 Ga — insulate the +/− post terminals. Price $10 est — confirm at order."),
