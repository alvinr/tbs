...
PARTS: list[Part] = [
    ...
    Part("ll-pp-drum", "1/8\" black HDPE sheet — 48×96 (×3)", "plastics-sheet",
         ...
         spec="Ø864 revolving drum shell (~65 ft²) — rolled + extrusion-welded 1/8\" HDPE (106.9\" circ needs 3× 48\" widths). A light-tight cover over the steel/Al structure; its 1/8\" is non-structural (lighter = easier revolve, less bearing load). The 2 end caps are now 8mm 6061-T6 ALUMINUM (ll-caps-al) — NOT HDPE — since they carry the stub-shaft hubs into the SKF 6215 bearings. US Plastics 46684 $123.34/sheet."),
    Part("ll-caps-al", "8mm 6061-T6 aluminum plate — 2 drum caps (Ø855)", "aluminum",
         "lightlock", 1, "lot", 400, 700, "Online Metals", "Industrial Metal Supply",
         spec="Both drum end caps (8mm 6061-T6, Ø855, identical) — waterjet 2 discs + the 4×M10 hub bolt circle (Ø120 PCD) + the 280° rim-angle rivet holes. STRUCTURAL: carry the bolted stub-shaft flanges into the SKF 6215 bearings. Est. material + waterjet (Online Metals); firm at order.", note="PRICE-VERIFY (Aug-2026 re-price)"),
