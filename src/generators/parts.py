...
PARTS: list[Part] = [
    ...
    Part("sp-sleeve-bearings", "DU self-lubricating sleeve (journal) bearing, Ø90 bore", "bearings-motion",
         ...
         spec="Top + bottom radial location of the post. GGB DU steel-backed PTFE, Ø90 ID × Ø95 OD × 60L (0.796 lb). Cylindrical — pressed into the hub bores (H7/r6); thrust is on the turntable bearing so no flange needed. Maintenance-free (dry-running), no oil to re-embed. Service pressure ≈2 N/mm² vs 140 N/mm² dynamic (>60× margin). Price TBD from Applied — placeholder band."),
