...
PARTS: list[Part] = [
    ...
    Part("cable-grommets", "Cable grommets / glands — steel-shell penetrations", "electrical-distribution",
         "electrical", 1, "lot", 13, 30, "Amazon", part_no="B09K5GNFHF",
         url="https://www.amazon.com/YUFANNET-Assortment-Grommets-Automotive-Electrical/dp/B09K5GNFHF",
         spec="200-pc rubber grommet assortment (8 sizes, ~$13) to protect wires through drilled steel + a strain-relief NPT cable-gland kit (Amazon B08R84YJ7X, nylon IP68, ~$15) for sealed wall/enclosure entries."),
    ...
    Part("pvc-trunking", "40×25mm PVC cable trunking, 5m", "electrical-distribution",
         "electrical", 4, "ea", 4.5, 6.25, "Amazon", "Home Depot (Wiremold)", part_no="B0DK6GMHGL",
         url="https://www.amazon.com/GenSDH-Raceway-Speaker-Concealer-Coffee-Width/dp/B0DK6GMHGL",
         spec="40mm PVC raceway + snap cover — one 5 m channel (~$18–25) cut into the 4 runs. Electrical-grade alt: Legrand Wiremold NMW1 $13.57/5 ft stick (Home Depot)."),
    Part("corrugated-conduit", "10mm split corrugated wire loom, drop runs", "electrical-distribution",
         "electrical", 10, "m", 2, 2.3, "Amazon", part_no="B017L3GWIW",
         url="https://www.amazon.com/Split-Wire-Loom-Tubing-Polyethylene/dp/B017L3GWIW",
         spec="Electriduct 3/8\" (10mm ID) pre-slit PE convoluted loom — sold in 20/50/100 ft rolls (~$12–14/20 ft); buy 2× 20 ft for the ~10 m of drop runs. ~$2/m."),
    ...
    Part("dibond-acm-film", "Dibond ACM panel 4mm (black)", "plastics-sheet",
         "film", 6, "sheet", 50, 85, "Grimco", "Curbell / Central Coast Plastics", part_no="MAXMETAL",
         url="https://www.grimco.com/catalog/products/maxmetal",
         spec="4 ft × 8 ft black ACM sheets — single rigid backing, {{fact:film_plane_width_mm}}×{{fact:film_plane_height_mm}}mm. Grimco MAXMETAL 4mm 48×96 (account-gated ~$45–75, SoCal pickup) or Curbell DIBOND Jet Black 4mm (~$80–110); confirm TRUE 4mm black is stocked (3mm/6mm are the common black thicknesses). Central Coast Plastics does cut-to-size."),
    ...
    Part("ll-silicone-sealant", "Silicone bead sealant (black, UV-stable) — DOWSIL 795", "adhesives-finishes",
         "lightlock", 1, "ea", 9, 12, "Metro Sealant", "Amazon", part_no="DOWSIL 795",
         url="https://metrosealant.com/product/dowsil-795-silicone-sealant-10-oz-tube/",
         spec="Bearing-housing / light-trap seam seal. DOWSIL 795 black neutral-cure structural silicone, 10 oz — permanently flexible, UV/weather-rated, bonds metal/aluminum (NOT a mildewcide bath caulk). $9.15/tube."),
