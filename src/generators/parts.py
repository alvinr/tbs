...
PARTS: list[Part] = [
    ...
    Part("spray-skate-wheel", "Nylon skate wheel, 32mm × 20mm, 8mm bore", "bearings-motion",
         "spray", 4, "ea", 3, 5, "McMaster-Carr",
         url="https://www.mcmaster.com/products/rollers/skate-wheels-1~/", spec="Flat tread, ≥25 kg rated (2 per carriage) — low-profile for grate clearance"),
