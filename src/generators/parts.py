...
PARTS: list[Part] = [
    ...
    Part("spray-skate-wheel", "Nylon skate wheel, 32mm × 20mm, 10mm bore", "bearings-motion",
         "spray", 4, "ea", 3, 5, "Amazon",
         url="https://www.amazon.com/uxcell-Plastic-Roller-Bearings-Guiding/dp/B0GXVT88Y5", spec="Flat tread, ≥25 kg rated (2 per carriage) — low-profile for grate clearance; 10mm bore takes the 10mm axle"),
