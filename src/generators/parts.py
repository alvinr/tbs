...
PARTS: list[Part] = [
    ...
    Part("fp-skate-axle", "Ø10 316 SS rod — skate axles (2× 600mm)", "steel-structural",
         "film", 2, "600mm rod", 88.13, 88.13, "McMaster-Carr", part_no="1265K81",
         url="https://www.mcmaster.com/1265K81/",
         spec="Ø10 316 SS rod for the skate axles — 4 per skate × 4 = 16 axles at ~60mm each (spray-skate precedent). 2× 600mm: 60mm tiles into 600 exactly (10 axles/stick, ZERO cut waste) → 20 axles = 16 + 4 spare. 316 (not free-machining 303 — sulfur inclusions corrode in the wet cyanotype zone). $88.13/600mm firm (1265K81)."),
