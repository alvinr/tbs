...
PARTS: list[Part] = [
    ...
    Part("coiled-cable-16awg", "16 AWG coiled (retractile) cable, 2-cond", "electrical-distribution",
         "ventilation", 1, "ea", 17.83, 17.83, "Grainger", "Amazon", part_no="3AY41", url="https://www.grainger.com/product/Coiled-Power-Cord-10-ft-Lg-3AY41",
         spec="Coiled/retractile flex for Fan B (mounted on the swinging hinged panel — must take the ~56° transport swing without binding). Grainger 3AY41 coiled power cord, 10 ft (Alvin 2026-07-30), ~$17.83. ⚠ CONFIRM: a 'power cord' is usually 3-conductor AC with a molded plug — for the 12V DC 2-conductor Fan-B flex you'd cut the plug + use 2 conductors (or pick a bare 2-cond coiled cable). Amazon alt: Unique Dynamics B00BSORUSW (16AWG 2-cond, PVC)."),
