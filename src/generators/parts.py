...
PARTS: list[Part] = [
    ...
    Part("tsb-440c-bar", "440C SS round bar (ball-socket inserts)", "stainless-sheet",
         ...
         spec="Ø20×100mm 440C SS bar — machine the 4 hardened hemispherical ball-socket inserts (ICP-08), Ra 0.4 ground. McMaster 1765T17."),
    ...
    Part("tsb-bellows", "Custom photographic bellows (ICP-10)", "seals-gaskets",
