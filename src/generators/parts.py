...
PARTS: list[Part] = [
    ...
    Part("coiled-cable-16awg", "16 AWG coiled (retractile) cable, 2-cond", "electrical-distribution",
         ...
         spec="MECCANIXITY retractable coiled cable, 16 AWG 2-conductor, 10 ft extended (B0GYFNXM9Z), $25.99 firm (Alvin 2026-07-30). Fan B flex on the swinging hinged panel — takes the ~56° transport swing. Proper 2-conductor (supersedes the Grainger 3AY41, which was a 3-cond AC power cord). Deutsch DT 2-pin ends."),
    ...
    Part("dibond-acm-film", "Dibond ACM panel 3mm (black), 4×8 sheet", "plastics-sheet",
         ...
         spec="4× 48×96\" black 3mm ACM sheets as full-height VERTICAL STRIPS (Option A) — 3 vertical butt seams, splice-battened behind; no horizontal seam (2094mm plane height fits one 2438mm sheet). Covers the {{fact:film_plane_width_mm}}×{{fact:film_plane_height_mm}}mm rigid backing (4499 ÷ 1219 = 4 strips). Curbell w01-05317 (jet black) — only 3mm is stocked black (was speced 4mm); 3mm is slightly less stiff but flatness is carried by the 6061 frame + clamps and is optically irrelevant at f/1088. $95/sheet est (quote); qty 4."),
