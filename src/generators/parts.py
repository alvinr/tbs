...
PARTS: list[Part] = [
    ...
    Part("dibond-acm-film", "Dibond ACM panel 4mm (black)", "plastics-sheet",
         ...
         spec="4 ft × 8 ft black ACM sheets — single rigid backing, {{fact:film_plane_width_mm}}×{{fact:film_plane_height_mm}}mm. ⚠ SOURCING UNRESOLVED (2026-07-22): true 4mm black is scarce — Grimco MAXMETAL is a wholesaler (may not sell direct); Curbell + Central Coast stock only 3mm black (Central ~$160/sheet retail). DECISION: accept 3mm (price jumps to ~$160/sheet, ×6 ≈ $960) or find a 4mm retail source. Price band below is the stale estimate — NOT firmed pending that call (also check whether this overlaps 'image-plane-backing')."),
