...
PARTS: list[Part] = [
    ...
    Part("led-flat-panel", "12V LED task panel 6×6in, 4000K (412 lm, flush-mount)", "electrical-distribution",
         "electrical", 3, "ea", 49.99, 49.99, "Super Bright LEDs", part_no="VTL-NW1515", url="https://www.superbrightleds.com/vehicle-lights/interior-and-utility-led-vehicle-lights/vehicle-led-dome-lights/square-led-panel-light-vehicle-and-trailer-12v-led-task-light-6in-x-6in-412-lumens-flush-mount+color-natural~4000k",
         spec="Super Bright LEDs VTL-NW1515 — 6\"×6\" flush-mount 12V LED task panel, 412 lm, 4000K natural white. TRUE 12V DC (no inverter needed) — supersedes the 300×600 40W panel that required an AC supply. $49.99 firm (Alvin 2026-07-30). Circuit G general lighting, ×3. NOTE: 412 lm ea (~1,240 lm total across 3) is modest for a 20ft interior — bump qty if more output is wanted."),
