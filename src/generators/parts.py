...
PARTS: list[Part] = [
    ...
    Part("ll-bearing-rings", "Bearing retaining rings — DIN 471 (inner) + DIN 472 (outer, upper)", "fasteners-hardware",
         "lightlock", 1, "lot", 8, 15, "McMaster-Carr",
         spec="Axial retention for the 2× SKF 6215: 4× DIN 471 external circlips on the Ø75 stub shafts (2 per bearing — INNER-race capture) + 1× DIN 472 internal retaining ring in the Ø130 upper-ring bore (OUTER race of the LOCATED upper bearing, beam side; the LOWER bearing floats — plain H7 bore). Ø75 external + Ø130 internal spring-steel rings; buy a pack of each. Est.; firm SKU at order.", note="PRICE-VERIFY (est — new 2026-08-25 outer-race retention)"),
