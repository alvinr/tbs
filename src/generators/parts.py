...
PARTS: list[Part] = [
    ...
    Part("shelf-tnut", "1/4\"-20 pronged tee-nut (ply attach)", "fasteners-hardware",
         "shelf", 3, "4-pack", 1.57, 1.57, "Home Depot", part_no="825001", url="https://www.homedepot.com/p/Everbilt-1-4-in-20-Zinc-Plated-Tee-Nut-4-Pack-825001/317478995", spec="1/4-20 4-prong tee-nut (the ply-mount standard SKU 825001) seated in the ply underside — the hinge screw row (~6-8) + 2 front-corner eye bolts ≈ 10 → 3× 4-pack. Reuses the project ply-mount tee-nut; replaces the retired M5 CSK ply attach."),
    Part("shelf-hinge-screws", "1/4\"-20 SS machine screws — hinge → tee-nuts", "fasteners-hardware",
         "shelf", 8, "ea", 0.40, 0.60, "McMaster-Carr", spec="1/4-20 × ~3/4in SS machine screw — hinge leaf into the ply tee-nut row. SS is the splash-zone exception to the zinc ply-mount screw (panel-machine-screws). ~8 off. SKU pending — source a 1/4-20 × 3/4 SS machine screw."),
