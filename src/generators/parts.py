...
PARTS: list[Part] = [
    ...
    Part("pdh-washer", "Neoprene light-seal washer (Ø56×Ø40×1.5)", "seals-gaskets",
         "front-board", 1, "ea", 3, 6, "McMaster-Carr", "Grainger",
         spec="Neoprene washer Ø56 OD × Ø40 ID × 1.5mm — the disc presses against it under the retaining ring, sealing the aperture. Cut from neoprene sheet or a stock washer. SKU pending — source."),
    Part("pdh-pinhole-discs", "Pinhole disc set — SS-302 (Ø2.17 / Ø1.5 / Ø3.0)", "optics",
         "front-board", 3, "ea", 20, 40, "Lenox Laser", "Edmund Optics", url="https://lenoxlaser.com/",
         spec="Ø50 × 0.1mm SS-302 laser-drilled pinhole discs — Ø2.17 (Rayleigh optimum), Ø1.5 (sharper), Ø3.0 (brighter). 3 off (the interchangeable set). SKU pending — quote (Lenox Laser)."),
    Part("pdh-lens-cell", "Lens cell in Ø50 carrier (optional)", "optics",
         "front-board", 1, "ea", 40, 120, "Edmund Optics", "Thorlabs",
         spec="A small lens cell in a Ø50 carrier — drops into the holder in place of a pinhole disc to run the camera as a lens optic. Optional. SKU pending — spec + source."),
    Part("pdh-thumb-screws", "M5 knurled thumb screws, 4× (retaining ring)", "fasteners-hardware",
         "front-board", 4, "ea", 2, 4, "McMaster-Carr", "Bolt Depot", url="https://www.mcmaster.com/products/thumb-screws/",
         spec="M5 knurled-head thumb screws — clamp the retaining ring, finger-tightened for quick disc change. 4 off. SKU pending — source."),
