...
PARTS: list[Part] = [
    ...
    Part("tsb-bellows", "Custom photographic bellows (ICP-04)", "seals-gaskets",
         ...
         spec="Ø290 ID × Ø360 OD × 60mm free length, 4-pleat, matte-black neoprene — the primary zero-friction light seal. Custom order — SKU pending (Micro-Tools / Ames Camera Repair)."),
    Part("tsb-neoprene-cord", "Neoprene cord seal Ø3mm", "seals-gaskets",
         ...
         spec="70 Shore, 1.5m — bellows flange gaskets + Ø420 loop (same spec as the wall-frame seal). McMaster 1834K22."),
