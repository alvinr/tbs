...
PARTS: list[Part] = [
    ...
    Part("nut-m6-nyloc", "M6×1.0 hex nut, nyloc SS", "fasteners-hardware",
         "spray", 16, "ea", 4.77 / 100, 4.77 / 100, "McMaster-Carr", part_no="90576A115", url="https://www.mcmaster.com/90576A115/", spec="Nyloc nut — M6×20 spray fasteners. Pitch M6×1.0 coarse — 90576A115 datasheet NOT on file; save it to confirm (must match the M6×1.0 bolt). $4.77/pack of 100."),
