...
PARTS: list[Part] = [
    ...
    Part("ll-grab-rail", "Ø25 SS grab bar — 16\" bolt-on (marine)", "fasteners-hardware",
         "lightlock", 1, "ea", 25, 45, "Marine Fiberglass Direct", spec="Interior handle — off-the-shelf 16\" (406mm) bolt-on marine SS grab bar, Ø25 (1\") tube. BOLTED at its two feet to the handle stile (ll-handle-stile) — 2× M8 tapped per foot — NOT welded, and not to the drum wall.", url="https://www.marinefiberglassdirect.com/products/16-stainless-steel-safety-grab-bar-bolt-on-for-marine-dock-deck-boat-pool-hot-tub"),
    Part("ll-handle-stile", "40×40×5 SS RHS grab-bar stile (cap→cap) + M12 cap bolts", "steel-structural",
         "lightlock", 1, "lot", 50, 95, "Metal Supermarkets", "Online Metals",
         spec="Steel stile (40×40×5 SS RHS, ~2.1 m) spanning + bolted between the two Al caps (4× M12 SHORT bolts TAPPED into the caps) — carries the grab-bar pull load into the structural caps, NOT the thin HDPE wall. The off-the-shelf grab bar (ll-grab-rail) bolts to the stile (2× M8 tapped per foot). Est.; firm at order.", note="PRICE-VERIFY (Aug-2026 re-price)"),
    ...
    Part("ll-fabrication", "Fabrication — roll + weld 2 HDPE cylinders, roll rim-angle, fit metal caps/bearings", "fabrication-labor",
         "lightlock", 1, "lot", 800, 1150, "Local plastic + metal fab", spec="~16–22 hrs: roll + hot-air/extrusion-weld the 2 HDPE cylinders, roll the Al rim-angle rings, fit the metal caps + SKF 6215 bearings + stub shafts, rivet the lap joints, mount the drum brush holders + edge channels + grab-bar stile."),
