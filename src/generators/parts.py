...
PARTS: list[Part] = [
    ...
    Part("ll-bearing-rings", "Bearing retaining rings — external Ø75 (inner) + internal Ø130 (outer, upper)", "fasteners-hardware",
         "lightlock", 1, "lot", 14, 14, "McMaster-Carr", part_no="90154A895", url="https://www.mcmaster.com/90154A895/",
         spec="Axial retention for the 2× SKF 6215: 4× EXTERNAL retaining rings on the Ø75 stub shafts (2 per bearing — INNER-race capture; McMaster 90154A895, for OD 75mm, $7.05/pack — shaft groove Ø72.0 × 2.65mm, ring 2.5mm) + 1× INTERNAL retaining ring in the Ø130 upper-ring bore (OUTER race of the LOCATED upper bearing, beam side; McMaster 98455A170, for ID 130mm, $7.26/pack — bore groove Ø134.0 × 4.15mm, ring 4.0mm). The LOWER bearing FLOATS (plain Ø130 H7 bore, no ring). ≈$14 firm.", note="confirmed 2026-08-25 (SKUs 90154A895 + 98455A170, verified vs datasheets — SKUs were transposed in the source msg)"),
