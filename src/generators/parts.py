...
PARTS: list[Part] = [
    ...
    Part("bolt-m12x40", "M12×40 hex bolt, 18-8 SS", "fasteners-hardware",
         "ibc-frame", 32, "ea", 14.73 / 10, 14.73 / 10, "McMaster-Carr", part_no="92314A744",
         url="https://www.mcmaster.com/92314A744/",
         spec="Front-bar fasteners, 2 per bar-end BOTH ends: 16 = corridor-end cleats (J2, 2 each × 8 bars) + 16 = wall-end vertical retention bolts (J7, 2 each × 8 bars, down through the bar into the pocket seat — anti-rotation + redundant, the bar is bolted not welded to the hanger; 2nd bolt added 2026-08-14). Short grip → M12×40 fully threaded is correct. McMaster 92314A744: M12×1.75 × 40mm 18-8 stainless hex head screw — confirmed vs the eng-specs PDF (M12×1.75, 40mm, 18-8 SS). $14.73/pack of 10 firm (2026-08-01; 32 used → 4 packs). (Wall-hanger through-bolts are the M12×65 below.)"),
