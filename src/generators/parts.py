...
PARTS: list[Part] = [
    ...
    Part("filter-machine-screws", "Zinc machine screws — filter housings to ply tee-nuts (1/4-20)", "fasteners-hardware",
         "water", 8, "ea", 1.57, 1.57, "Home Depot", spec="2 per housing × 3 = 6 needed (+2 spare) — 1/4\"-20 × 2½\" ZINC round-head machine screw, a 1/4 flat washer under each head, through the 150061 bracket ear + 25mm standoff + 18mm ply into a back-face pronged tee-nut (tnut-quarter). Downsized from 5/16\"-18 (2026-09-07) to fold the filter mount into the 1/4-20 ply-mount standard — the bracket ear already passes 5/16, so 1/4 + washer clamps with the washer spanning the ear bore; retires the 5/16-18 family. Re-torqueable, serviceable. ZINC not SS (dry backboard mount behind the housings — not immersion). SKU pending — source a 1/4-20 × 2½ zinc round-head machine screw + 1/4 flat washer; conservative $1.57 ea placeholder.", panel="Pinhole Wall"),
    ...
    Part("ll-rivets-shell", "1/8\" 18-8 SS multigrip blind rivets — shell→cap lap (100-pack)", "fasteners-hardware",
         "lightlock", 1, "pack-100", 12.59, 12.59, "McMaster-Carr", part_no="97525A420",
         url="https://www.mcmaster.com/97525A420/",
         spec="Shell→cap lap rivets (~35/cap ×2 ≈ 70 → 1 pack of 100). 1/8\" (Ø3.18) 18-8 SS multigrip low-profile head, drill #30 (Ø3.3). 97525A420 is ONE multigrip SKU consolidating the former shell/rim (0.188–0.25\") + housing/surround (0.313–0.375\") grip pair — its range spans both the ~6mm and ~8–9.5mm laps (per the 97525A420 datasheet). Wet in DP8010 for light-tightness. $12.59/100 firm (2026-09-07).", note="2026-09-07 consolidated 97525A425/A435 → one multigrip 97525A420 (sourced)"),
    Part("ll-rivets-housing", "1/8\" 18-8 SS multigrip blind rivets — housing→frame lap (100-pack)", "fasteners-hardware",
         "lightlock", 1, "pack-100", 12.59, 12.59, "McMaster-Carr", part_no="97525A420",
         url="https://www.mcmaster.com/97525A420/",
         spec="Housing→frame lap rivets (~26/edge ×2 ≈ 52 → 1 pack of 100). 1/8\" (Ø3.18) 18-8 SS multigrip, drill #30. Same one multigrip SKU 97525A420 as the shell/rim laps (spans the 0.313–0.375\" housing grip and the thinner shell/rim laps). $12.59/100.", note="2026-09-07 consolidated 97525A425/A435 → multigrip 97525A420"),
    ...
    Part("ll-rim-rivets", "1/8\" 18-8 SS multigrip blind rivets — rim-angle → frame beam (100-pack)", "fasteners-hardware",
         "lightlock", 1, "pack-100", 12.59, 12.59, "McMaster-Carr", part_no="97525A420", url="https://www.mcmaster.com/97525A420/",
         spec="~24× 1/8\" (Ø3.18) 18-8 SS multigrip blind rivets fastening the rolled Al rim-angle flat legs to the steel frame top + bottom beams (2× 100° arcs each, ~150mm pitch). A blind rivet suits the CLOSED 3mm RHS beam: the set head forms inside the bore (no internal access) and bears on the full wall, vs only ~2 threads for a self-driller; 18-8 SS bites the 3mm steel far better than an aluminum rivet. The ~6mm (3mm Al leg + 3mm steel wall) lap sits inside the multigrip range; drill #30 (Ø3.3). Same one multigrip SKU 97525A420 as the shell/housing laps. $12.59/100 firm.", note="confirmed 2026-08-25 (18-8 SS per eng-specs datasheet); 2026-09-07 SKU → multigrip 97525A420"),
    ...
    Part("panel-surround-rivets", "1/8\" 18-8 SS multigrip blind rivets — HDPE surround → frame lap (100-pack ×2)", "fasteners-hardware",
         "panel", 2, "pack", 12.59, 12.59, "McMaster-Carr", part_no="97525A420", url="https://www.mcmaster.com/97525A420/",
         spec="Fasten the HDPE surround (B2 bay walls + upper/lower floor caps + center-zone face skins) to the steel center-zone frame at the panel-plane lap — ~140 rivets over the lap edges (2 jamb lines ~35 each + cap/skin laps) → 2× 100-pack. 1/8\" (Ø3.18) 18-8 SS multigrip blind rivet, drill #30 (Ø3.3), set with a DP8010 sealant bead for light-tightness. Same one multigrip SKU 97525A420 as the light-trap laps (its range spans this ~8–9.5mm surround lap). Hingepanel Sheet 7. $12.59/100.", note="2026-08-28 (hingepanel-bp) surround→frame blind-riveted lap; 2026-09-07 SKU → multigrip 97525A420 (shared with the light-trap rivets)"),
