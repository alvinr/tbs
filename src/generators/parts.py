...
PARTS: list[Part] = [
    ...
    Part("washer-m8-flat-shelf", "M8 flat washer, SS", "fasteners-hardware",
         "shelf", 12, "ea", 3.32 / 100, 3.32 / 100, "McMaster-Carr", part_no="91166A270", url="https://www.mcmaster.com/91166A270/", spec="Flat washer (1/bolt) — shelf wall bolts (dry). Distinct SKU from the film-plane wet-zone washer-m8-flat (98689A673): separate keys so the by-type BOM doesn't blend the two M8 flat washers. $3.32/pack of 100."),
