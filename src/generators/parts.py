...
PARTS: list[Part] = [
    ...
    Part("led-channel", "LED Profiles 981 slimline channel + diffuser, 10 ft", "electrical-distribution",
         "electrical", 1, "10ft length", 27.00, 27.00, "LED Profiles", part_no="981ASL", url="https://ledprofiles.com/collections/all-led-channels/products/slimline-ultra-low-profile-led-channel-981-series",
         spec="Alberko/LED Profiles 981ASL Ultra-Low-Profile aluminum LED channel (6063-T5 clear-anodized, 14.9×6.86mm) with snap-in FROSTED diffuser (D34) — houses the Circuit-G 12V COB strip, giving the even hot-spot-free wash. Fits strips up to 12.70mm (spec-sheet confirmed 2026-07-30), so the ~8mm HitLights strip seats fine. Sold in 8 ft or 10 ft lengths at $27.00 ($25.65 @5+): ONE 10 ft stick covers the ~10 ft lit run (WHITE_LIGHT_W=42W). Full-reel wall-to-wall = 2× 10 ft = $54. End caps + mounting clips are listed as accessories — confirm bundled or add (~$5)."),
