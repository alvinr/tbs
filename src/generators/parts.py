...
PARTS: list[Part] = [
    ...
    Part("estop-external", "External emergency cut-off — red mushroom IP66/NEMA 4X + control loop", "electrical-distribution",
         "electrical", 1, "ea", 17.5, 30, "McMaster-Carr", part_no="6741K41", url="https://www.mcmaster.com/6741K41/", spec="McMaster 6741K41 — BACO 22mm plastic red mushroom, pull-to-release, SPST-NC, IP66/IP69K/NEMA 4X (weather + corrosion). ⚠ price PENDING (ALVIN to quote)."),
    Part("estop-internal", "Interior emergency cut-off — red mushroom IP66 metal (paralleled to exterior)",
         "electrical-distribution", "electrical", 1, "ea", 17.5, 25, "McMaster-Carr", part_no="8382K45", url="https://www.mcmaster.com/8382K45/", spec="McMaster 8382K45 — 22mm metal red mushroom, pull-to-release, SPST-NC, IP66/NEMA 4. ⚠ price PENDING (ALVIN to quote)."),
