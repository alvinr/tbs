...
PARTS: list[Part] = [
    ...
    Part("shurflo-2088-p3", "Shurflo 2088-554-144 pump (P-03 waste evacuation)", "water-equipment",
         "water", 1, "ea", 80, 89, "Amazon", spec="12VDC, 3.5 GPM, 45 PSI; empties IBC-4 residual below X4 (~120L)", panel="Corridor"),
    Part("shurflo-2088-p4", "Shurflo 2088-554-144 pump (P-04 tray drain transfer)", "water-equipment",
         "water", 1, "ea", 80, 89, "Amazon", spec="12VDC, 3.5 GPM, 45 PSI; tray drain to IBC-3 (~900mm lift)", panel="Corridor"),
    Part("shurflo-2088-p5", "Shurflo 2088-554-144 pump (P-05 Brown drain)", "water-equipment",
         "water", 1, "ea", 80, 89, "Amazon", spec="12VDC, 3.5 GPM, 45 PSI; evacuates IBC-3 (Brown) residual to the X3 end-wall port", panel="Corridor"),
    Part("seaflo-accumulator", "SeaFlo accumulator (0.75 L)", "water-equipment",
         "water", 1, "ea", 30, 41, "Amazon",
    ...
    Part("cartridge-kdf", 'KDF-55 heavy-metal cartridge 4.5"×20"', "water-equipment",
         "water", 1, "ea", 65, 95, "Amazon", spec="KDF-55 media for dissolved iron/metal removal (F-2 stage); ~60-print interval", panel="Pinhole Wall"),
    ...
    Part("valve-v050fp-corridor", 'Banjo V050FP ball valve 1/2" FNPT', "plumbing-fittings",
         "water", 3, "ea", 30, 45, "Amazon", spec="PP full-port quarter-turn; pump-suction isolation BV-01 (P-01), BV-02 (P-05), BV-06 (P-03)", panel="Corridor"),
    Part("valve-v050fp-wall", 'Banjo V050FP ball valve 1/2" FNPT', "plumbing-fittings",
         "water", 1, "ea", 30, 45, "Amazon", spec="PP full-port quarter-turn; pump-suction isolation BV-03 (P-02)", panel="Pinhole Wall"),
    Part("valve-v050fp-supply", 'Banjo V050FP ball valve 1/2" FNPT', "plumbing-fittings",
         "water", 2, "ea", 30, 45, "Amazon", spec="PP full-port; supply isolation BV-04 (TAP-01 chem tap), BV-05 (spray-bar feed)"),
    Part("valve-v100fp", 'Banjo V100FP ball valve 1" FNPT', "plumbing-fittings",
         "water", 6, "ea", 33, 55, "Amazon", spec="PP full-port; V1/V3/V4, VB1–VB3 (IBC fill/drain)"),
    ...
    Part("elbow-el100", 'Banjo EL100-90 elbow 1" NPT', "plumbing-fittings",
         "water", 4, "ea", 4, 6, "Amazon", spec="PP 90°; IBC bends, filter outlet to DV-01"),
    ...
    Part("tee-100", 'Banjo TEE100 equal tee 1" NPT', "plumbing-fittings",
         "water", 3, "ea", 5, 7, "Amazon", spec="PP; IBC drain tees (the X1 fill is now a 4-way cross)"),
    ...
    Part("tee-100-hdpe", 'Banjo TEE100 equal tee, 1" HDPE NPT', "plumbing-fittings",
         "water", 1, "ea", 5, 7, "Amazon", spec="X1 fill tee — splits the fill to both Blue totes"),
    ...
    Part("spray-saddle-clamp", "Formed 2mm 304 SS saddle clamp (axle retainer)", "fasteners-hardware",
         "spray", 8, "ea", 10 / 8, 10 / 8, "McMaster-Carr",
         url="https://www.mcmaster.com/products/multipurpose-304-stainless-steel/", spec='Axle retention — 2mm 304 SS flat bar formed to a saddle over the Ø10 axle (1mm cradle clearance), 2 bolt feet through the carriage plate. A stamped conduit saddle clamp is only ~0.5mm — too thin for a rolling-carriage axle retainer. Alt: 304 SS + EPDM Adel loop clamp ~3/8–7/16\" ID.'),
    ...
    Part("wire-label-kit", "Brady M210 wire label kit", "electrical-distribution",
         "electrical", 1, "ea", 199, 211, "Amazon"),
