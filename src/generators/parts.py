...
PARTS: list[Part] = [
    ...
    # ═══ front-board (pinhole-disc-holder-report.md) — the quick-change PINHOLE DISC HOLDER (Ø180 plate +
    ...
    Part("pdh-plate-stock", "ICP-01 front-plate stock — 6061-T6 round bar Ø190×22", "aluminum",
         ...
         spec="6061-T6 round bar Ø190×22mm — machined to the Ø180×18 front plate (Ø65 aperture, Ø110 scene taper, Ø82 carrier seat 6 deep, 4× M6 mount @ Ø150 + 4× M6 tap). SKU pending — source."),
    Part("pdh-ring-stock", "ICP-03 retaining-ring stock — 6061-T6", "aluminum",
         "front-board", 1, "ea", 8, 8, "Metal Supermarkets", "Online Metals",
         spec="6061-T6 stock — machined to the Ø100 OD × Ø70 bore × 6 retaining ring (4× M6 clearance @ Ø85). Can be cut from the plate offcut. SKU pending — source."),
    Part("pdh-washer", "Neoprene light-seal washer (Ø82×Ø65×1.5)", "seals-gaskets",
         "front-board", 1, "ea", 3, 6, "McMaster-Carr", "Grainger",
         spec="Neoprene washer Ø82 OD × Ø65 ID × 1.5mm — the carrier presses against it under the retaining ring, sealing the aperture. Cut from neoprene sheet or a stock washer. SKU pending — source."),
    Part("pdh-pinhole-discs", "Pinhole board set — SS-302 (Ø2.17 / Ø1.5 / Ø3.0)", "optics",
         "front-board", 3, "ea", 20, 40, "Lenox Laser", "Edmund Optics", url="https://lenoxlaser.com/",
         spec="Ø80 × 0.1mm SS-302 laser-drilled pinhole boards — Ø2.17 (Rayleigh optimum), Ø1.5 (sharper), Ø3.0 (brighter). 3 off (the interchangeable set). SKU pending — quote (Lenox Laser)."),
    Part("pdh-lens-board", "Ø80 lens board — Copal/Compur 0/1/3 (optional)", "optics",
         "front-board", 1, "ea", 10, 30, "SK Grimes", "local fab",
         spec="Ø80 × ~4mm 6061 lens board drilled for a Copal/Compur 0 (34.6), 1 (41.6) or 3 (61.5) shutter — drops into the holder to run the camera as a lens optic. The large-format LENS itself is user-supplied (out of BOM). Optional. SKU pending — source."),
    Part("pdh-thumb-screws", "M6 knurled thumb screws, 4× (retaining ring)", "fasteners-hardware",
         "front-board", 4, "ea", 2, 4, "McMaster-Carr", "Bolt Depot", url="https://www.mcmaster.com/products/thumb-screws/",
         spec="M6 knurled-head thumb screws — clamp the retaining ring (lens-board clamp force), finger-tightened for quick carrier change. 4 off. SKU pending — source."),
    ...
    Part("pdh-cnc", "CNC machining — front plate + retaining ring (service)", "fabrication-labor",
         ...
         spec="Machine the Ø180 front plate (Ø65 aperture, Ø110 scene taper, Ø82 counterbore 6 deep, 4× M6 mount @ Ø150 + 4× M6 tap) and the Ø100 retaining ring from 6061-T6. SKU pending — fab quote."),
...
SYSTEM_DOC = {
    ...
    "front-board": "pinhole-disc-holder-report.md",
}
