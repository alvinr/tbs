...
PARTS: list[Part] = [
    ...
    Part("bolt-m12x40", "M12×40 hex bolt, Grade 8.8", "fasteners-hardware",
         ...
         spec="Front-bar → upright angle cleats (2 each × 4 bars = 8). Short grip (bar + cleat + upright flange) → M12×40 fully threaded is correct. M12×1.75×40 8.8 zinc DIN933 (pitch M12×1.75 coarse — confirmed vs the FMW listing 2026-07-29, matches nut-m12-plain); FMW 1634027 $1.44ea / US Bolt Kits $0.71ea. (Wall-hanger through-bolts are the M12×65 below.)"),
