...
PARTS: list[Part] = [
    ...
    Part("shelf-piano-hinge", "Bolt-on continuous (piano) hinge, 600 mm, SS", "fasteners-hardware",
         "shelf", 1, "ea", 6.23, 6.23, "McMaster-Carr", part_no="1582A457", url="https://www.mcmaster.com/1582A457-1582A452/", spec="304 SS BOLT-ON continuous hinge, 25.4mm open / 12.7mm leaf (1582A452 datasheet), 2ft (610mm) stock cut to 600, supplied BLANK (undrilled) — drill both leaves to the 150mm tee-nut pitch (4 bolts), the row 7mm off the edge (mid-leaf) so the hinge, the ply tee-nuts and the cleat all align. Shelf leaf 1/4-20 SS machine-screwed (pan/truss head — a CSK head overhangs the 12.7mm leaf) into the ply tee-nut row; wall leaf to the 6mm cleat/backing plate. $6.23/2ft (1582A457) — replaces the retired weld-on LSN8-32-600 ($23.56), cheaper."),
    ...
    Part("shelf-hinge-screws", "1/4\"-20 SS machine screws — hinge leaves (both)", "fasteners-hardware",
         "shelf", 8, "ea", 0.40, 0.60, "McMaster-Carr", spec="1/4-20 SS machine screws — BOTH hinge leaves at 4 each (Sheet 5 drilling detail): 4× ~3/4in shelf leaf → the ply tee-nut row (board); 4× ~5/16in wall leaf → the TAPPED 6mm cleat (short, no protrusion past the cleat back onto the backing plate). SS is the splash-zone exception to the zinc ply-mount screw (panel-machine-screws). ~8 off. SKU pending — source 1/4-20 SS pan/truss-head (a CSK head overhangs the 12.7mm leaf)."),
