...
PARTS: list[Part] = [
    ...
    Part("bolt-m12x90", "M12×90 hex through-bolt, 18-8 SS", "fasteners-hardware",
         "film", 28, "ea", 18.31 / 10, 18.31 / 10, "McMaster-Carr", "Amazon", part_no="91310A145",
         url="https://www.mcmaster.com/91310A145/",
         spec="ICP-12: wall sandwich through-bolt; 4/saddle ×6 + 4 spare. $18.31/pack of 10 → 3 packs for 28."),
