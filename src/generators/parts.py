...
PARTS: list[Part] = [
    ...
    Part("coiled-cable-16awg", "16 AWG coiled (retractile) cable, 2-cond", "electrical-distribution",
         "ventilation", 1, "ea", 17.83, 17.83, "Grainger", "Amazon", url="https://www.grainger.com/category/electrical/power-strips-extension-cords-cord-reels/power-cords?searchQuery=16+awg%2C+2-conductor+coiled+cable",
         spec="1m, 2-conductor coiled/retractile — Fan B flex. Grainger $17.83 (Alvin 2026-07-30) — confirm the exact Grainger SKU (a search URL was given). Amazon alt: Unique Dynamics B00BSORUSW (PVC). Silicone jacket rare; PVC fine for this dry interior flex."),
