...
PARTS: list[Part] = [
    ...
    Part("pdh-lens-board", "Ø80 lens board — Copal/Compur 0/1/3 (optional)", "optics",
         ...
         spec="Ø80 × ~4mm 6061 lens board drilled for a Copal/Compur 0 (34.6), 1 (41.6) or 3 (65.0) shutter — drops into the holder to run the camera as a lens optic. The large-format LENS itself is user-supplied (out of BOM). Optional. SKU pending — source."),
