...
PARTS: list[Part] = [
    ...
    Part("filter-machine-screws", "Zinc machine screws — filter housings to ply tee-nuts", "fasteners-hardware",
         "water", 2, "5-pack", 2.5, 3.5, "Home Depot", spec="2 per housing × 3 = 6 needed — 5/16\"-18 × 2½\" ZINC-plated steel hex bolts through the 150061 bracket ear + 25mm standoff + 18mm ply into a back-face pronged tee-nut (tnut-fivesixteen). Machine-screw joint replaces the 5/16 lag screws (#30, 2026-08-07) — re-torqueable, serviceable. ZINC not SS (dry backboard mount behind the housings — not immersion; Alvin 2026-08-07). 5-packs → 2 (10, 4 spare). ⚠ price EST — confirm zinc HD SKU + price.", panel="Pinhole Wall"),
