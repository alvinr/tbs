...
PARTS: list[Part] = [
    ...
    Part("ll-pp-drum", "1/8\" black PP sheet — 48×96 (×3)", "plastics-sheet",
         "lightlock", 3, "sheet", 123.34, 123.34, "US Plastics", "TAP Plastics",
         spec="Ø864 revolving drum shell (~65 ft²) + 2 end caps from the 3rd-sheet offcut — rolled + extrusion-welded. 1/8\" is nearest stock to the 4mm LT_DRUM_T nominal; the skin is a light-tight cover over the steel shaft + caps + edge-stiffening, so the 0.8mm is non-structural (and lighter = easier revolve, less bearing load). 106.9\" circ needs 3× 48\" widths. US Plastics 1/8\" black PP $123.34/sheet — SKU pending."),
    ...
    Part("panel-pp-skins", "1/8\" black PP sheet (48×96)", "plastics-sheet",
         "panel", 4, "sheet", 123.34, 123.34, "US Plastics", "TAP Plastics", spec="Panel skins, both faces (~12 m², 4× 4×8 ft sheets) — rev11, replaces 18mm ply. 1/8\" is nearest stock to the 4mm PANEL_SKIN_T nominal; the U-channel grid (~400–450mm centers) keeps the skin flat, so the 0.8mm is immaterial. US Plastics 1/8\" black PP $123.34/sheet — SKU pending."),
    ...
    Part("panel-b2-bay", "1/8\" black PP sheet (48×96, ×2)", "plastics-sheet",
         "panel", 2, "sheet", 123.34, 123.34, "US Plastics", "TAP Plastics", spec="B2 punch-out bay — 4-wall light-tight tube (~890mm deep) around the housing (rev11); 4 walls, 2 per 4×8 sheet. 1/8\" nearest stock to 4mm; EPDM lip cut from the panel-epdm perimeter roll (not billed here). US Plastics 1/8\" black PP $123.34/sheet — SKU pending."),
