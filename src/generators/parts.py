...
PARTS: list[Part] = [
    ...
    Part("ge50-bearing", "GE50-DO-2RS spherical plain bearing", "bearings-motion",
         "front-board", 1, "ea", 90, 90, "Bearing Headquarters", "Applied Industrial",
         spec="ICP-03 pivot: Ø50 bore × Ø80 OD × 46mm W, ±15° misalignment, PTFE-lined self-lubricating (chemistry-safe). Same bearing family as the film plane. SKU pending — source (Bearing Headquarters, Buena Park / Applied Industrial, LA)."),
    ...
    Part("tsb-icp02-bar", "ICP-02 inner carrier stock (6061-T6 round bar)", "aluminum",
         ...
         spec="6061-T6 round bar Ø340×35mm (13.5in OD × 1.5in) — machined to the Ø320×25 carrier. SKU pending — source (Metal Supermarkets, Chatsworth / Online Metals)."),
    ...
    Part("tsb-440c-bar", "440C SS round bar (ball-socket inserts)", "stainless-sheet",
         ...
         spec="Ø20×100mm 440C SS bar — machine the 4 hardened hemispherical ball-socket inserts (ICP-05), Ra 0.4 ground. McMaster 1765T17."),
    ...
    Part("tsb-central-screw", "M8×1.0×50 SHCS 18-8 SS (central retention)", "fasteners-hardware",
         "front-board", 1, "ea", 0.642, 0.642, "McMaster-Carr", "Bolt Depot", part_no="91180A352", url="https://www.mcmaster.com/91180A352/",
         spec="1 off — non-structural central retention/preload, downsized from M16 (reuses the M8×1.0 fine thread of the adjustment screws). McMaster 91180A352 $6.42/10."),
    ...
    Part("tsb-loctite638", "Loctite 638 retaining compound (10mL)", "adhesives-finishes",
         ...
         spec="Bearing outer-ring + ball-socket insert retention. McMaster 1832A1."),
    ...
    Part("tsb-cnc", "CNC machining — ICP-01 + ICP-02 (service)", "fabrication-labor",
         ...
         spec="All-aluminum machining of both plates (bores, H7 seat, k5 shank, PCDs, labyrinth, counterbore). SKU pending — get a fab quote (Fictiv / ProtoLabs)."),
