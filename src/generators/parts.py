...
PARTS: list[Part] = [
    ...
    Part("ll-dp8010", "3M Scotch-Weld DP8010 structural adhesive (green, 45 mL)", "adhesives-finishes",
         ...
         spec="Structural LSE acrylic — bonds + light-seals the HDPE lap joints (shell→cap, housing→frame, edge channels) and wets the open rivet mandrel bore for light-tightness. 45 mL cartridge + mixing nozzle. $76.29 firm.", note="confirmed 2026-08-24 (SKU+URL+price)"),
    Part("ll-edge-channel", "6063-T5 Al U-channel opening-edge stiffeners (×4) + L-clips", "aluminum",
         ...
         spec="4× bonded Al U-channel (~20×18×3, ~2.1 m each ≈ 8.5 m) stiffening the housing's two free HDPE opening edges — replaces the steel jamb posts — + 8× L-clip + 8× M8 end bolts (channel ends bolt to the top/bottom beams). Est.; confirm stocked section.", note="PRICE-VERIFY (Aug-2026 re-price)"),
