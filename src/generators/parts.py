...
PARTS: list[Part] = [
    ...
    Part("fp-skate-keeper", "3/4\" OD acetal keeper rollers — Delrin rod (cut ×8)", "bearings-motion",
         "film", 1, "4 ft rod", 8, 12, "McMaster-Carr", part_no="8497K276",
         url="https://www.mcmaster.com/8497K276-8497K273/",
         spec="Keeper rollers — 2 per skate × 4 = 8, cut 20mm wide from a 3/4\" OD (Ø19.05 ≈ Ø20) Delrin rod (8497K276, 4 ft — min stock, ample spare), each drilled Ø10 bore; captive under the U-channel top flange. Price TBD — confirm the 4 ft rod price at order."),
