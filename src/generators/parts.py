...
PARTS: list[Part] = [
    ...
    Part("bolt-m12x40", "M12×40 hex bolt, Grade 8.8", "fasteners-hardware",
         ...
         spec="Front-bar → upright angle cleats (2 each × 4 bars = 8). Short grip (bar + cleat + upright flange) → M12×40 fully threaded is correct. McMaster 92314A744: M12×1.75×40 hex bolt (matches nut-m12-plain). $14.73/pack of 10 firm (2026-08-01; 8 used). (Wall-hanger through-bolts are the M12×65 below.)"),
