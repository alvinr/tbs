...
PARTS: list[Part] = [
    ...
    Part("tray-silicone-gasket", "Silicone gasket strip", "seals-gaskets",
         "tray", 1, "ea", 20, 20, "McMaster-Carr", spec="Silicone sealant bed in the center-seam lap joint (between the overlapped panels) + a top bead — the seam seal"),
    ...
    Part("sp-pivot-post", "Ø89×8mm CHS pivot post + machined hub / thrust collar", "steel-structural",
         ...
         spec="Upgrades the reused film far-left upright; carries the ~3.6 kN·m swing cantilever — SF 3.7 in S355. Two journal bands (where the DU sleeves ride) turned/ground to Ra ≤0.5 µm — unhardened S355 acceptable per GGB DU (hardening improves life)."),
    Part("sp-thrust-bearing", "Thrust ball bearing, 51118 (Ø90 bore, single-direction)", "bearings-motion",
         "swing", 1, "ea", 40, 60, "VXB", "Amazon / Bearings Direct", part_no="51118",
         url="https://vxb.com/products/51118-single-thrust-ball-bearing-90x120x22mm",
    ...
    Part("sp-sleeve-bearings", "DU self-lubricating sleeve (journal) bearing, Ø90 bore", "bearings-motion",
         "swing", 2, "ea", 30, 55, "Applied", "Isostatic (TU equiv.)", part_no="MB9060DU",
         url="https://www.applied.com/c-brands/c-ggb/mb9060du/DU-Self-Lubricating-Bearing/p/102013642",
         spec="Top + bottom radial location of the post. GGB DU steel-backed PTFE, Ø90 ID × Ø95 OD × 60L (0.796 lb). Cylindrical — pressed into the hub bores (H7/r6); the axial load is on the 51118 thrust bearing so no flange needed. Maintenance-free (dry-running), no oil to re-embed. Service pressure ≈2 N/mm² vs 140 N/mm² dynamic (>60× margin). Price TBD from Applied — placeholder band."),
