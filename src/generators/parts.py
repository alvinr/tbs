...
PARTS: list[Part] = [
    ...
    Part("estop-external", "External emergency cut-off — red mushroom switch", "electrical-distribution",
         ...
         spec="uxcell a19061100ux1510 red mushroom E-stop switch, $12.74 (Harfington, firm 2026-07-25). Switch element ONLY — the EXTERIOR unit still needs a weatherproof (IP66) enclosure for outdoor mounting (TBD).",
         note="Alvin 2026-07-25: 'just the switch' — spec a weatherproof enclosure for the external mount (the old McMaster 6741K41 was a rated IP66/NEMA-4X unit)."),
