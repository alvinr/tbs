...
PARTS: list[Part] = [
    ...
    Part("bolt-m6x20", "M6×1.0 × 20 hex bolt, 304 SS (A2-70)", "fasteners-hardware",
         "electrical", 4, "ea", 17.86 / 100, 17.86 / 100, "McMaster-Carr", part_no="", url="https://www.mcmaster.com/", spec="Power-panel bolt: face plate 3mm + gasket 3mm into the welded raised frame's M6 weld-nut (~12mm grip → M6×20). GRADE 2026-08-13: 304 SS A2-70 — the panel face is exterior/weather-facing, so upgraded from zinc; 304 is adequate (no chloride). SKU TODO: re-source the retired 91280A330 (zinc) to a 304 A2 M6×1.0×20 ~2× the retired zinc price; priced at the zinc placeholder here, re-price + re-SKU at order."),
    ...
    Part("bolt-m8-fixing", "M8×1.25 × 25 hex bolt, 304 SS (A2-70) — right-rail end fixing (ICP-14)", "fasteners-hardware",
         "film", 8, "ea", 18.51 / 50, 18.51 / 50, "McMaster-Carr", part_no="", url="https://www.mcmaster.com/", spec="ICP-14: right depth-rail end flange → wall seat hold-down (does NOT cross the wall). Grip = 0.2\" (5.08mm) 795M51 channel base + 10mm seat ≈ 15mm → M8×25 (short → fully threaded). Pitch M8×1.25 coarse (matches the M8 plain nut). GRADE 2026-08-13: 304 SS A2-70 — the film plane wets during development, so upgraded from zinc; 304 is adequate (no chloride). SKU TODO: re-source the retired 91280A534 (zinc) to a 304 A2 M8×1.25×25 ~2× the retired zinc price; priced at the zinc placeholder here, re-price + re-SKU at order."),
