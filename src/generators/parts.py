...
PARTS: list[Part] = [
    ...
    Part("corner-l-plate", "Corner plate 304 SS (U-joint mount)", "steel-structural",
         ...
         spec='¼" 304 SS plate, ~6"×8" L-bracket — the frame-corner ↔ U-joint mount. Carries the concentrated U-joint corner load in STEEL, not aluminum; stainless for the cyanotype splash zone + galvanic match to the 303 SS U-joint. NOT expendable (the perimeter angle stays expendable 6061). Firm the 304 SS cut-plate price at the §7 corner-hardware re-price.'),
