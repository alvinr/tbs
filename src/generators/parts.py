...
PARTS: list[Part] = [
    ...
    Part("ll-fasteners", "Bolts/nuts/isolation washers — cap/ring/collar/stile/handle/edge/housing", "fasteners-hardware",
         "lightlock", 1, "lot", 97, 97, "McMaster-Carr", part_no="91280A634", url="https://www.mcmaster.com/91280A634/",
         spec="18-8 SS, buy one pack per line (generous spares): F1 cap→flange 8× M10×1.5 CSK (91294A328, $11.58/25); F2/F3 ring/collar→beam 14× M10×1.5 hex into the rivet-nuts (91280A634, $16.64/25); F4 stile→cap 4× M12×1.75 (91180A743, $12.40/10); F5 pull-handle feet 4× 1/4\"-20 (90272A537, $7.21/100); F6 edge-channel→beam 8× M8×1.25 (91280A083, $11.17/50); F7 housing→panel 8× M10×1.5 CSK (91280A370, $10.55/25) + 8× M10 nuts (90576A118, $9.53/50); W ~22× M10 nylon isolation shoulder washers (95610A400, $18.39/100) at every steel↔Al/HDPE joint. Rivet-nuts + blind rivets are separate lines. ≈$97 firm.", note="confirmed 2026-08-24 (SKU+URL+price)"),
