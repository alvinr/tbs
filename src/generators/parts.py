...
PARTS: list[Part] = [
    ...
    Part("elbow-el100", 'Banjo EL100-90 elbow 1" NPT', "plumbing-fittings",
         "water", 4, "ea", 4.59, 4.59, "US Plastic Corp", "Amazon", spec="PP 90°; IBC bends, filter outlet to DV-01", part_no="31187", url="https://www.usplastic.com/catalog/item.aspx?itemid=31187"),
    ...
    Part("tee-100", 'Banjo TEE100 equal tee 1" NPT', "plumbing-fittings",
         "water", 3, "ea", 14.19, 14.19, "US Plastic Corp", "Amazon", spec="PP; IBC drain tees (the X1 fill is now a 4-way cross)", part_no="36358", url="https://www.usplastic.com/catalog/item.aspx?itemid=36358"),
    ...
    Part("pvc-half", '1/2" PVC Sch-40 pipe', "plumbing-fittings",
         ...
         spec="All pump-driven runs (~80 ft), PVC Sch-40 solvent-weld; matches pump port size. Re-price/re-count when sourced (PVC = 10-ft sticks)"),
    ...
    Part("tee-100-hdpe", 'Banjo TEE100 equal tee, 1" HDPE NPT', "plumbing-fittings",
         "water", 1, "ea", 14.19, 14.19, "US Plastic Corp", "Amazon", spec="X1 fill tee — splits the fill to both Blue totes", part_no="36358", url="https://www.usplastic.com/catalog/item.aspx?itemid=36358"),
