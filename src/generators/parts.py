...
PARTS: list[Part] = [
    ...
    Part("bolt-m12x40", "M12×40 hex bolt, Grade 8.8", "fasteners-hardware",
         "ibc-frame", 8, "ea", 6.66 / 10, 6.66 / 10, "McMaster-Carr", part_no="91280A206",
         url="https://www.mcmaster.com/91280A206/",
         spec="Front-bar → upright angle cleats (2 each × 4 bars = 8). Short grip (bar + cleat + upright flange) → M12×40 fully threaded is correct. McMaster 91280A206: M12×1.75×40, Class 8.8 zinc, fully threaded (matches nut-m12-plain). $6.66/pack of 10 firm (2026-08-01; 8 used). (Wall-hanger through-bolts are the M12×65 below.)"),
