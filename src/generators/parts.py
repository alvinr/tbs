...
PARTS: list[Part] = [
    ...
    Part("pdh-cnc", "CNC machining — front plate + retaining ring (service)", "fabrication-labor",
         ...
         spec="Machine the Ø180 front plate (Ø65 aperture, Ø110 scene taper, Ø82 counterbore 6 deep, 4× M6 mount @ Ø150 + 4× M6 tap @ Ø94) and the Ø110 retaining ring from 6061-T6. SKU pending — fab quote."),
