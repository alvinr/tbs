...
PARTS: list[Part] = [
    ...
    Part("ll-edge-channel", "6063-T5 Al U-channel opening-edge stiffeners (×4) + L-clips", "aluminum",
         ...
         spec="4× RIVETED Al U-channel (~20×18×3, ~2.1 m each ≈ 8.5 m) stiffening the housing's two free HDPE opening edges — replaces the steel jamb posts — + 8× L-clip + 8× M8 end bolts (channel ends bolt to the top/bottom beams). RIVET-ONLY as of 2026-09-08 (Ø3.18 SS blind @120mm thru both legs + HDPE; no DP8010 — the opaque channel wraps the edge). Est.; confirm stocked section.", note="PRICE-VERIFY (Aug-2026 re-price)"),
    ...
    Part("ll-rim-rivets", "1/8\" 18-8 SS blind rivets — rim-angle → frame beam (100-pack)", "fasteners-hardware",
         "lightlock", 1, "pack-100", 13.83, 13.83, "McMaster-Carr", part_no="97525A425", url="https://www.mcmaster.com/97525A425/",
         spec="~24× 1/8\" (Ø3.18) 18-8 SS blind rivets fastening the rolled Al rim-angle flat legs to the steel frame top + bottom beams (2× 100° arcs each, ~150mm pitch). A blind rivet suits the CLOSED 3mm RHS beam: the set head forms inside the bore (no internal access) and bears on the full wall, vs only ~2 threads for a self-driller; 18-8 SS bites the 3mm steel far better than an aluminum rivet. Grip 0.188–0.25\" (4.8–6.35mm) fits the 3mm Al leg + 3mm steel wall; drill #30 (Ø3.3). Same SS rivet as the shell→cap lap (97525A425). $13.83/100 firm.", note="confirmed 2026-08-25 (97525A425 = 18-8 SS per eng-specs datasheet; TEK→SS blind rivet)"),
