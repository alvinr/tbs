...
PARTS: list[Part] = [
    ...
    Part("ll-dp8010", "3M Scotch-Weld DP8010 structural adhesive (green)", "adhesives-finishes",
         "lightlock", 1, "ea", 48, 68, "McMaster-Carr", "3M",
         url="https://www.3m.com/3M/en_US/p/d/b40071180/",
         spec="Structural LSE acrylic — bonds + light-seals the HDPE lap joints (shell→cap, housing→frame, edge channels) and wets the open rivet mandrel bore for light-tightness. 45 mL cartridge + mixing nozzle. Est.; firm at order.", note="PRICE-VERIFY (Aug-2026 re-price)"),
    ...
    Part("ll-fasteners", "Stainless bolts (cap/ring/edge/stile/grab) + M10 rivet-nuts + nylon isolation washers", "fasteners-hardware",
         "lightlock", 1, "lot", 45, 70, "US Plastic + McMaster", spec="Cap→flange 4×M10 ×2 (tapped steel flange, Ø120 PCD); ring→beam 6×M10 + collar→beam 8×M10 into M10 RIVET-NUTS (blind threaded inserts set in the 3mm RHS beam wall — too thin to tap, no internal access; mechanism per Sheets 5/10); stile→cap 4×M12 tapped + pull-handle feet 4×1/4\" tapped; nylon isolation shoulder washers at every steel↔Al/HDPE joint (no galvanic couple). Rivets and edge-channel M8 are separate lines.", part_no="92674", url="https://www.usplastic.com/catalog/item.aspx?itemid=155501"),
