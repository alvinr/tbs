...
PARTS: list[Part] = [
    ...
    Part("ll-hdpe-housing", "3/16\" UV-stab HDPE sheet, black — 48×96 (×3)", "plastics-sheet",
         ...
         spec="Ø800 fixed housing shell (~56 ft², ~2062mm tall — spans beam-to-beam), rolled + extrusion-welded from 3× 4×8 ft 3/16\" (≈5mm) UV-stab HDPE sheets — the 99\" circumference needs 3× 48\" sheet widths (2 fall ~15\" short). ~33% offcut on the 3rd sheet; a 5×10 ft sheet would cut to 2 (optimize at order). US Plastics 46685 $184.99/sheet."),
