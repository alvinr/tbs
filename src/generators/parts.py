...
PARTS: list[Part] = [
    ...
    Part("washer-m8-flat", "M8 flat washer, 304 SS", "fasteners-hardware",
         ...
         spec="Flat washer under each J1/J2 M8×20 head (Sheet 8). 304 SS, wet zone. McMaster 98689A673 $13.59/pack of 50 (sourced 2026-09-06)."),
    Part("washer-m8-split", "M8 split lock washer, 304 SS", "fasteners-hardware",
         ...
         spec="Split lock washer under each J1/J2 M8×20 (with Loctite 243 — belt + suspenders vs transport vibration; Sheet 8). 304 SS, wet zone. McMaster 91111A132 $11.19/pack of 100 (sourced 2026-09-06)."),
