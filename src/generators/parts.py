...
PARTS: list[Part] = [
    ...
    Part("canopy-emt-conduit", '1.5" EMT conduit, 10 ft', "steel-structural",
         "ventilation", 6, "stick", 12, 16, "Home Depot", spec='Shade-canopy frame legs + top rails. 1" EMT, 6× 10-ft sticks (downsized from 1.5" 2026-07-27 — adequate for a shade-cloth canopy). Source SKU/price.'),
    Part("canopy-emt-fittings", "EMT canopy fittings (couplings, corner ells, connectors)", "steel-structural",
         "ventilation", 8, "ea", 1.5, 2.5, "Home Depot", spec="1\" EMT set-screw couplings joining the frame runs (×8). Corner turns via field-bent EMT or add 1\" 90° ells (extra if used). Source SKU/price."),
    Part("canopy-emt-base", "EMT canopy base plates + ground stakes (×4)", "steel-structural",
         "ventilation", 4, "ea", 6, 10, "Home Depot", spec="1\" floor flange (black iron or EMT base) at each leg base (×4). Add ground stakes/guys if free-standing. Source SKU/price."),
