...
PARTS: list[Part] = [
    ...
    Part("canopy-emt-conduit", '1.5" EMT conduit, 10 ft', "steel-structural",
         "ventilation", 6, "stick", 42.42, 42.42, "Home Depot", part_no="8511-107HD", url="https://www.homedepot.com/p/330385401", spec='Shade-canopy frame legs + top rails. 1.5" EMT, 6× 10-ft sticks. ⚠ 1.5" EMT is heavy-gauge for a shade canopy — a lighter ¾"/1" run would cut this ~60%; confirm 1.5" is intended (wind loading?).'),
    Part("canopy-emt-fittings", "EMT canopy fittings (couplings, corner ells, connectors)", "steel-structural",
         "ventilation", 8, "ea", 3.24, 3.24, "Home Depot", part_no="62815", url="https://www.homedepot.com/p/100537119", spec="Halex 1.5\" EMT set-screw couplings joining the frame runs (×8). Corner turns via field-bent EMT or add 90° ells (extra if used)."),
    Part("canopy-emt-base", "EMT canopy base plates + ground stakes (×4)", "steel-structural",
         "ventilation", 4, "ea", 14.74, 14.74, "Home Depot", part_no="310-F-112", url="https://www.homedepot.com/p/302074522", spec="STZ 1.5\" black-iron floor flange at each leg base (×4). Add ground stakes/guys if free-standing."),
    ...
    Part("pvc-1in", '1" PVC Sch-40 pipe', "plumbing-fittings",
         "water", 2, "stick", 8.65, 8.65, "Home Depot", part_no="PVC040100600RS", url="https://www.homedepot.com/p/100348473", spec="PVC Sch-40, ~20 ft = 2× 10-ft sticks; filter outlet + IBC lines. ⚠ Charlotte listing is DWV (drain-waste-vent), not pressure — physically fine at 45 PSI (same Sch-40 wall), but a pressure-rated pipe is the by-the-book pick for the pumped filter section. Re-count vs routing."),
