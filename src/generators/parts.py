...
PARTS: list[Part] = [
    ...
    Part("bolt-m6-panel", "M6×20 hex bolt, SS — power-panel mount", "fasteners-hardware",
         "electrical", 4, "ea", 1.13, 1.13, "McMaster-Carr", spec="Power-panel bolt (A2/304 SS): face plate 3mm + gasket 3mm into the welded raised frame's M6 weld-nut. Grip ≈ 12mm → M6×20 (short → fully threaded). Needs an M6×20 SS SKU at re-price."),
    ...
    Part("bolt-m8-wall", "M8×25 hex bolt, SS — shelf cleat + stay mount", "fasteners-hardware",
         "shelf", 12, "ea", 0.84, 0.84, "McMaster-Carr", spec="Clamps the shelf hinge cleat (6mm) + 2 stay anchors to their welded 8mm backing plates (M8 weld-nut). Grip ≈ 14mm → M8×25 (short → fully threaded). Needs an M8×25 SS SKU at re-price."),
    Part("nut-m8-plain", "M8×1.25 hex nut, plain SS", "fasteners-hardware",
