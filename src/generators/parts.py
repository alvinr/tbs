...
PARTS: list[Part] = [
    ...
    Part("mppt-charge-fuse", "MPPT charge-line fuse — 60A ANL + holder", "electrical-distribution",
         "electrical", 1, "ea", 71.38, 71.38, "Powerwerx", part_no="5005-BSS", url="https://powerwerx.com/blue-sea-5005-anl-fuse-block-cover",
         spec="Blue Sea 5005 ANL fuse block + cover ($36.39, Powerwerx 5005-BSS) + Eaton Bussmann ANL 60A fuse ($34.99, powerwerx.com/eaton-bussman-anl-fuses). Protects the MPPT->battery 6 AWG charge lead close to the battery (§7.3). $71.38 firm (Alvin 2026-07-31). NOTE: the ANL-60 fuse at $34.99 is high for a single (typical ~$8) — confirm it isn't a multipack."),
    ...
    Part("led-connectors", "LED strip connectors + 12V PWM dimmers (Circuits G + D)", "electrical-distribution",
         "electrical", 1, "lot", 15, 30, "Super Bright LEDs", "Amazon", part_no="solderless-clamp-8mm",
         url="https://www.superbrightleds.com/solderless-clamp-on-led-strip-light-to-pigtail-adaptor-8mm-single-color-strips-22-awg",
         spec="Solderless clamp-on strip->pigtail connectors, 8mm single-color 22AWG ($1.49 ea, Super Bright LEDs) + 2x inline 12V PWM dimmers (Circuit-G white, Circuit-D red — still to price). Connector firm; DIMMER price outstanding (Alvin 2026-07-31)."),
