...
PARTS: list[Part] = [
    ...
    Part("valve-3way-half", '3-way diverter valve 1/2" FNPT', "plumbing-fittings",
         "water", 1, "ea", 23.99, 23.99, "US Plastic Corp", spec="L/T-port HDPE-compatible; 3W-DV-02 (tray drain)", panel="Corridor", part_no="22365", url="https://www.usplastic.com/catalog/item.aspx?itemid=22365"),
    ...
    Part("camlock-2in", '2" polypropylene camlock pairs (M+F)', "plumbing-fittings",
         "water", 4, "pair", 5, 8, "US Plastic Corp", spec="External bulkhead connections (X1/X3/X4 + spare)"),
    Part("elbow-half", '1/2" NPT 90° elbow polypropylene', "plumbing-fittings",
         "water", 14, "ea", 2, 4, "US Plastic Corp", spec="All pump-driven run bends"),
    ...
    Part("tee-half", '1/2" NPT polypropylene tee', "plumbing-fittings",
         "water", 6, "ea", 2, 4, "US Plastic Corp", spec="Blue suction/discharge tees, branches"),
    ...
    Part("cross-100", '1" NPT 4-way cross fitting', "plumbing-fittings",
         "water", 1, "ea", 8, 14, "US Plastic Corp", spec="X1 fresh-fill 4-way: X1 inlet + IBC-1 + IBC-2 + DV-01 blue recycle return (was a 3-way tee). Cost est."),
    Part("union-half", '1/2" NPT polypropylene union', "plumbing-fittings",
         "water", 6, "ea", 4, 6, "US Plastic Corp", spec="Maintenance disconnects on pump runs"),
    Part("bushing-reducer", '1/2"×1" NPT bushing reducer', "plumbing-fittings",
         "water", 1, "ea", 3, 5, "US Plastic Corp", spec="P-02 riser to F1 filter inlet"),
    ...
    Part("blue-equalization-tie", '1" bulkhead tank-body fittings (Blue equalization cross-tie)', "plumbing-fittings",
         "water", 2, "ea", 6, 12, "US Plastic Corp", spec='Low tank-body penetration in each Blue tote (IBC-1 + IBC-2) for the 1" equalization cross-tie that self-balances the two Blue levels (run made from the 1" HDPE stock). Cost est.'),
    Part("check-valve-1in", '1" NPT spring check valve (CV1 — X1 gravity fill)', "plumbing-fittings",
         "water", 1, "ea", 8, 14, "US Plastic Corp", spec='PVC body, EPDM seal, 1" FNPT × FNPT. Only CV-1 (X1 fill) remains — the Shurflo 2088 pumps have integral check valves, so CV-2/CV-3/CV-4 are redundant and dropped'),
    ...
    Part("braided-hose", '1/2" ID reinforced braided PVC hose', "plumbing-fittings",
         "water", 2, "length", 12, 24, "US Plastic Corp", spec="Pump inlet flexible connection, 6 ft per pump"),
