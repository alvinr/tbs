...
PARTS: list[Part] = [
    ...
    Part("spray-arm-jamnut", "M12×1.75 jam nut, SS", "fasteners-hardware",
         "spray", 1, "ea", 0.4, 0.4, "McMaster-Carr", spec="Locks the arm adapter on the ball-joint M12 stud (M12×1.75 coarse)."),
    Part("spray-arm-collar", "Clamp-style shaft collar, 25mm/1\" bore, SS", "fasteners-hardware",
         "spray", 1, "ea", 8, 15, "McMaster-Carr", spec="Over the slit arm-tube bottom; its integral clamp screw squeezes the Ø25×2 tube onto the adapter's Ø21 spigot — rotational adjust + lift-off for transport. Replaces the loose M6 pinch bolt. Confirm SKU/bore/price at order."),
