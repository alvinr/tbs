...
PARTS: list[Part] = [
    ...
    Part("elbow-half", '1/2" NPT 90° elbow polypropylene', "plumbing-fittings",
         "water", 14, "ea", 2, 4, "Home Depot", spec="All pump-driven run bends"),
    ...
    Part("tee-half", '1/2" NPT polypropylene tee', "plumbing-fittings",
         "water", 6, "ea", 2, 4, "Home Depot", spec="Blue suction/discharge tees, branches"),
    ...
    Part("union-half", '1/2" NPT polypropylene union', "plumbing-fittings",
         "water", 6, "ea", 4, 6, "Home Depot", spec="Maintenance disconnects on pump runs"),
    Part("bushing-reducer", '1/2"×1" NPT bushing reducer', "plumbing-fittings",
         "water", 1, "ea", 3, 5, "Home Depot", spec="P-02 riser to F1 filter inlet"),
