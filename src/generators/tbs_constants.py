...
LT_HOUSING_T   = 5        # housing wall (mm) — 3/16" UV-HDPE (US Plastics 46685, ≈5mm; modeled as 5) [rev9 B2: 3mm Al → 3/16" UV-HDPE plastic skin]
...
LT_RIVET_D     = 3.18     # 1/8" 18-8 SS multigrip blind rivet, low-profile head (McMaster 97525A420 — one grip spans both the shell→cap and housing→frame laps)
