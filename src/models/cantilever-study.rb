...
# ── Subsystems ──
  ...
  face = grp.entities.add_face([0.mm,0.mm,-40.mm], [1750.mm,0.mm,-40.mm], [1750.mm,2362.mm,-40.mm], [0.mm,2362.mm,-40.mm])
  ...
  face = grp.entities.add_face([0.mm,0.mm,2388.mm], [1750.mm,0.mm,2388.mm], [1750.mm,2362.mm,2388.mm], [0.mm,2362.mm,2388.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(40.mm)
  ...
  face = grp.entities.add_face([150.mm,80.mm,100.mm], [190.mm,80.mm,100.mm], [190.mm,2280.mm,100.mm], [150.mm,2280.mm,100.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(40.mm)
  ...
  face = grp.entities.add_face([150.mm,600.mm,100.mm], [162.mm,600.mm,100.mm], [162.mm,1762.mm,100.mm], [150.mm,1762.mm,100.mm])
  face.reverse! if face.normal.z < 0
  ...
  face = grp.entities.add_face([165.mm,177.mm,52.mm], [470.mm,177.mm,52.mm], [470.mm,217.mm,52.mm], [165.mm,217.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  # Cantilever 2 arm (to X470)
  grp = ents.add_group
  grp.name = "Cantilever 2 arm (to X470)"
  face = grp.entities.add_face([165.mm,570.mm,52.mm], [470.mm,570.mm,52.mm], [470.mm,610.mm,52.mm], [165.mm,610.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  # Cantilever 3 arm (to X470)
  grp = ents.add_group
  grp.name = "Cantilever 3 arm (to X470)"
  face = grp.entities.add_face([165.mm,964.mm,52.mm], [470.mm,964.mm,52.mm], [470.mm,1004.mm,52.mm], [165.mm,1004.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  # Cantilever 4 arm (to X470)
  grp = ents.add_group
  grp.name = "Cantilever 4 arm (to X470)"
  face = grp.entities.add_face([165.mm,1358.mm,52.mm], [470.mm,1358.mm,52.mm], [470.mm,1398.mm,52.mm], [165.mm,1398.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  face = grp.entities.add_face([165.mm,1752.mm,52.mm], [470.mm,1752.mm,52.mm], [470.mm,1792.mm,52.mm], [165.mm,1792.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  # Cantilever 6 arm (to X470)
  grp = ents.add_group
  grp.name = "Cantilever 6 arm (to X470)"
  face = grp.entities.add_face([165.mm,2145.mm,52.mm], [470.mm,2145.mm,52.mm], [470.mm,2185.mm,52.mm], [165.mm,2185.mm,52.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(13.mm)
  mat = model.materials["Cantilever 1 post (50x50 SHS)"] || model.materials.add("Cantilever 1 post (50x50 SHS)")
  mat.color = Sketchup::Color.new(200, 120, 30)
  ...
  face = grp.entities.add_face([880.mm,0.mm,80.mm], [920.mm,0.mm,80.mm], [920.mm,653.mm,80.mm], [880.mm,653.mm,80.mm])
  face.reverse! if face.normal.z < 0
  ...
  face = grp.entities.add_face([880.mm,653.mm,80.mm], [1000.mm,653.mm,80.mm], [1000.mm,1709.mm,80.mm], [880.mm,1709.mm,80.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(2220.mm)
  mat = model.materials["Panel corner near (40mm)"] || model.materials.add("Panel corner near (40mm)")
  mat.color = Sketchup::Color.new(156, 123, 77)
  ...
  face = grp.entities.add_face([880.mm,1709.mm,80.mm], [920.mm,1709.mm,80.mm], [920.mm,2362.mm,80.mm], [880.mm,2362.mm,80.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(2220.mm)
  mat = model.materials["Panel corner near (40mm)"] || model.materials.add("Panel corner near (40mm)")
  mat.color = Sketchup::Color.new(156, 123, 77)
  ...
  # Panel swept path (Z80 clearance band)
  grp = ents.add_group
  grp.name = "Panel swept path (Z80 clearance band)"
  face = grp.entities.add_face([0.mm,0.mm,80.mm], [1000.mm,0.mm,80.mm], [1000.mm,2362.mm,80.mm], [0.mm,2362.mm,80.mm])
  face.reverse! if face.normal.z < 0
  face.pushpull(60.mm)
  mat = model.materials["Panel swept path (Z80 clearance band)"] || model.materials.add("Panel swept path (Z80 clearance band)")
...
anc = Geom::Point3d.new(140.mm, 197.mm, 65.mm)
...
anc = Geom::Point3d.new(470.mm, 984.mm, 52.mm)
txt = entities.add_text("ARM depth limited Z52-65
(spray bar below / grate above)", anc, Geom::Vector3d.new(500.mm, -650.mm, 350.mm))
txt.layer = model.layers["Labels"] rescue nil
anc = Geom::Point3d.new(770.mm, 1180.mm, 65.mm)
txt = entities.add_text("PUNCH-OUT cantilevers 300mm
over spray bar — NO support below
(open issue: stiffness)", anc, Geom::Vector3d.new(650.mm, -300.mm, 450.mm))
txt.layer = model.layers["Labels"] rescue nil
anc = Geom::Point3d.new(470.mm, 1180.mm, 60.mm)
txt = entities.add_text("SPRAY BAR Z20-60
sweeps under the punch-out", anc, Geom::Vector3d.new(-300.mm, 600.mm, -250.mm))
txt.layer = model.layers["Labels"] rescue nil
anc = Geom::Point3d.new(1000.mm, 1180.mm, 80.mm)
txt = entities.add_text("PANEL transport: rides Z80
clears bracket tops Z65 by 15mm", anc, Geom::Vector3d.new(500.mm, -500.mm, 700.mm))
txt.layer = model.layers["Labels"] rescue nil

model.definitions.purge_unused
model.materials.purge_unused

keep_tags = ["Context", "Processing Tray", "Film Plane Rails", "Spray Bar", "Cantilevers", "Grate (lift-out)", "Hinge Panel (transport)", "Labels"]
...
[["Operating", ["Processing Tray", "Film Plane Rails", "Spray Bar", "Cantilevers", "Grate (lift-out)"]], ["Transport clearance", ["Processing Tray", "Film Plane Rails", "Cantilevers", "Hinge Panel (transport)"]], ["Punch-out + spray bar", ["Processing Tray", "Spray Bar", "Cantilevers", "Grate (lift-out)"]], ["Combined", ["Context", "Processing Tray", "Film Plane Rails", "Spray Bar", "Cantilevers", "Grate (lift-out)", "Hinge Panel (transport)"]], ["Labeled", ["Context", "Processing Tray", "Film Plane Rails", "Spray Bar", "Cantilevers", "Grate (lift-out)", "Hinge Panel (transport)", "Labels"]]].each { |name, tags|
