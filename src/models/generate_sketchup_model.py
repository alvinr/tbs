...
def pinhole_assembly():
    ...
    # Exterior pinhole disc holder (front board) — a compact Ø180 plate + Ø90 retaining ring on the
    # wall-frame adapter (replaces the retired tilt-swing board; a pinhole board is optically fixed).
    ext = -WALL_T                      # exterior wall face
    parts.append(ruby_cylinder("Pinhole disc-holder plate", PH_X, ext - PDH_PLATE_T, PH_H,
                               PDH_PLATE_OD / 2, PDH_PLATE_T, axis="y", color=C_ALUM))
    parts.append(ruby_cylinder("Disc-holder retaining ring", PH_X, ext - PDH_PLATE_T - PDH_RING_T, PH_H,
