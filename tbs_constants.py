...
Redesign basis (2026-05-20 rev 7 — walkway reorg):
  ...
  200mm duct penetration at X=1420, Z=1440.  EP raised to Z=1600–2200.
...
# through pinhole wall, X-centered on ext power panel, 200mm above it.
EVAP_DUCT_X  = 1420    # duct penetration center X (mm) — aligned with ext power panel center
EVAP_DUCT_Z  = 1440    # duct penetration center Z (mm) — 200mm above ext power panel top
