...
| 36× #14 self-drilling TEK screws (bracket → post, J8/J9) | #14 × 1in HWH self-drilling TEK screw, #4/5 point (drills the ~6–8mm steel-to-steel: angle leg + the 3mm RHS post wall), 410 SS for the damp container. Attach the corridor-panel L-brackets (J8, 2×6=12) + the side-panel pipe-run L-brackets (J9, 2×12=24) to the IBC posts — NO weld, so the brackets bolt onto a pre-painted frame with no hot work. Price est. per-ea (sold in 100-boxes). | 36 ea | Home Depot / McMaster-Carr | $11–$20 |
...
| Zinc machine screws — filter housings to ply tee-nuts (1/4-20) | 2 per housing × 3 = 6 needed (+2 spare) — 1/4"-20 × 2½" ZINC round-head machine screw, a 1/4 flat washer under each head, through the 150061 bracket ear + 25mm standoff + 18mm ply into a back-face pronged tee-nut (tnut-quarter). Downsized from 5/16"-18 (2026-09-07) to fold the filter mount into the 1/4-20 ply-mount standard — the bracket ear already passes 5/16, so 1/4 + washer clamps with the washer spanning the ear bore; retires the 5/16-18 family. Re-torqueable, serviceable. ZINC not SS (dry backboard mount behind the housings — not immersion). SKU pending — source a 1/4-20 × 2½ zinc round-head machine screw + 1/4 flat washer; conservative $1.57 ea placeholder. | 8 ea | Home Depot | $13 |
