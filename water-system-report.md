...
| 1/4"-20 zinc machine screws (ply-mount interfaces) | ¼-20 × 1" ZINC-plated steel machine screws into the tnut-quarter pronged tee-nuts — the machine-screw half of every ¼-20 ply-mount joint (36 + spare ≈ 40). Length 1" gives full tee-nut engagement with ~3mm back protrusion; 1¼" only where ≥12mm back clearance. ZINC not SS (dry backboard mounts; Alvin 2026-08-07). ⚠ price EST — confirm zinc HD SKU + price (#30). | 1 lot | Home Depot | $6–$9 |
