...
marine plywood 600 kg/m³, HDPE (all light-lock plastic skin) 950 kg/m³,
water 1,000 kg/m³.
...
|-----------|------------|-------------|---------------|-------------------|
| Hinged panel (incl. Ø800 housing + punch-out bay) | 161 | 0–80 (deployed); swung ~56° about the pivot (transport) | 0–2,362 | Framed panel: 1/8" HDPE plastic skins + 18mm-ply Fan-B mount band + 3mm-Al corner cores + 2×2×0.120in steel SHS center ≈ 119 kg + bolted 5mm (3/16in) HDPE Ø800 housing ≈ 22 kg + 1/8"-HDPE punch-out bay ≈ 21 kg (first-principles). The Ø89 pivot post + bearings + cage are counted under "Swing pivot + cage hardware". See [Hinged Panel Report §2.4–2.5](hinged-panel-report.md) for the full movable-assembly breakdown |
| Light-trap drum (rotating) | 69 | 0–40 (deployed); swung ~56° about the pivot (transport) | 653–1,709 | Ø764 C-shell, 1/8" HDPE plastic skin, no fins (suspended with panel) + 2× 8mm 6061-T6 Al end caps + rolled rim-angles + steel Ø75 stub shafts + 2× SKF 6215 bearings + the interior 40×40×5 SS pull-handle stile (bolts to the caps → rotates with the drum) + plugs + pull handle |
| Processing tray | 114 | 280–4,629 | 80–2,280 | 304 SS 1.5mm, 2 panels × 57 kg ([Water System Report](water-system-report.md) §4) |
...
| Right walkway | 44 | 4,329–4,629 | 0–2,362 | Cantilever-rectangle: closed frame (2 long + 2 end beams) + 2 center cantilever arms off the IBC uprights (2×1×0.120in steel) + wall cleats + combined corner plates (shared with the BR film rail) + GRP grating |
| Left walkway | 25 | 170–470 | 0–2,362 | Removable lift-out: GRP grating + 5 floor-leg cantilever brackets (2×2 post + arm on bare floor outside the tray) + drum-exit punch-out (deeper grating) |
...
| **Structure subtotal** | **<!-- BEGIN weight:wt-cat-structure -->585<!-- END weight:wt-cat-structure -->** | | | |
...
| IBC restraint frame | 123 | 4,654–5,104 | 1,046–1,316 | 2×2×0.120in steel restraint-only deep 4-leg box (totes direct-stack cage-on-cage): 4 full-height uprights (front pair X4654 + back pair X5104) + top/bottom rings + 4 floor flange feet + **8 front retaining bars (2/tote face — doubled for the loaded-transport case)** + **8 identical 2-bolt wall joist hangers (through-bolted to 8 exterior backing plates, 16 penetrations)** + rear-panel brackets + **4 anti-slip mats** ([Equipment Layout](equipment-layout-report.md) §5) |
| **Equipment subtotal** | **<!-- BEGIN weight:wt-cat-equipment -->515<!-- END weight:wt-cat-equipment -->** | | | |

### 3.4 Dry Weight Summary

| Category | Weight (kg) | % of Dry Total |
|----------|------------|---------------|
| Container (shell + doors) | <!-- BEGIN weight:wt-cat-container -->2,200<!-- END weight:wt-cat-container --> | <!-- BEGIN weight:wt-pct-container -->66.7<!-- END weight:wt-pct-container -->% |
| Structure | <!-- BEGIN weight:wt-cat-structure -->585<!-- END weight:wt-cat-structure --> | <!-- BEGIN weight:wt-pct-structure -->17.7<!-- END weight:wt-pct-structure -->% |
| Equipment | <!-- BEGIN weight:wt-cat-equipment -->515<!-- END weight:wt-cat-equipment --> | <!-- BEGIN weight:wt-pct-equipment -->15.6<!-- END weight:wt-pct-equipment -->% |
| **Total dry** | **<!-- BEGIN weight:wt-total-dry -->3,300<!-- END weight:wt-total-dry -->** | **100%** |
...
**Total loaded weight: <!-- BEGIN weight:wt-total-loaded -->5,100<!-- END weight:wt-total-loaded --> kg** (<!-- BEGIN weight:wt-total-dry -->3,300<!-- END weight:wt-total-dry --> dry + 1,800 liquid)

### 4.2 Materials Exhausted (Ready for Resupply)

After a full session, wash water has been consumed and redistributed.
Blue IBCs are empty; Brown (recycled) and Waste IBCs hold the ~<!-- BEGIN fact:recovered_l -->1,245<!-- END fact:recovered_l -->L
recovered (~<!-- BEGIN fact:collection_fill_l -->622<!-- END fact:collection_fill_l -->L each). The processing tray has been drained; the other
~<!-- BEGIN fact:lost_l -->465<!-- END fact:lost_l -->L was lost to the open process (evaporation, wet-print carryout,
...
**Total exhausted weight: <!-- BEGIN weight:wt-total-exhausted -->4,560<!-- END weight:wt-total-exhausted --> kg** (<!-- BEGIN weight:wt-total-dry -->3,300<!-- END weight:wt-total-dry --> dry + 1,260 liquid)

### 4.3 State Comparison

| State | Total (kg) | X_cg (mm) | Yd_cg (mm) | Z_cg (mm) | Front/Rear | Near/Far |
|-------|-----------|-----------|------------|-----------|------------|----------|
| Dry (Transport) | <!-- BEGIN weight:wt-dry-total -->3,300<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-dry-x -->2,752<!-- END weight:wt-dry-x --> | <!-- BEGIN weight:wt-dry-yd -->1,198<!-- END weight:wt-dry-yd --> | <!-- BEGIN weight:wt-dry-z -->1,098<!-- END weight:wt-dry-z --> | <!-- BEGIN weight:wt-dry-fr -->53.4<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.6<!-- END weight:wt-dry-rr -->% | <!-- BEGIN weight:wt-dry-nr -->48.2<!-- END weight:wt-dry-nr -->/<!-- BEGIN weight:wt-dry-fa -->51.8<!-- END weight:wt-dry-fa -->% |
| Loaded Transport (Blue full) | <!-- BEGIN weight:wt-loadedtx-total -->5,100<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-loadedtx-x -->3,646<!-- END weight:wt-loadedtx-x --> | <!-- BEGIN weight:wt-loadedtx-yd -->1,192<!-- END weight:wt-loadedtx-yd --> | <!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z --> | <!-- BEGIN weight:wt-loadedtx-fr -->34.5<!-- END weight:wt-loadedtx-fr -->/<!-- BEGIN weight:wt-loadedtx-rr -->65.5<!-- END weight:wt-loadedtx-rr -->% | <!-- BEGIN weight:wt-loadedtx-nr -->48.8<!-- END weight:wt-loadedtx-nr -->/<!-- BEGIN weight:wt-loadedtx-fa -->51.2<!-- END weight:wt-loadedtx-fa -->% |
| Camera Ready (Deployed) | <!-- BEGIN weight:wt-ready-total -->5,100<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x --> | <!-- BEGIN weight:wt-ready-yd -->1,178<!-- END weight:wt-ready-yd --> | <!-- BEGIN weight:wt-ready-z -->1,340<!-- END weight:wt-ready-z --> | <!-- BEGIN weight:wt-ready-fr -->34.5<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.5<!-- END weight:wt-ready-rr -->% | <!-- BEGIN weight:wt-ready-nr -->50.1<!-- END weight:wt-ready-nr -->/<!-- BEGIN weight:wt-ready-fa -->49.9<!-- END weight:wt-ready-fa -->% |
| Materials Exhausted (Transport) | <!-- BEGIN weight:wt-exhausted-total -->4,560<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-exhausted-x -->3,452<!-- END weight:wt-exhausted-x --> | <!-- BEGIN weight:wt-exhausted-yd -->1,193<!-- END weight:wt-exhausted-yd --> | <!-- BEGIN weight:wt-exhausted-z -->928<!-- END weight:wt-exhausted-z --> | <!-- BEGIN weight:wt-exhausted-fr -->38.6<!-- END weight:wt-exhausted-fr -->/<!-- BEGIN weight:wt-exhausted-rr -->61.4<!-- END weight:wt-exhausted-rr -->% | <!-- BEGIN weight:wt-exhausted-nr -->48.7<!-- END weight:wt-exhausted-nr -->/<!-- BEGIN weight:wt-exhausted-fa -->51.3<!-- END weight:wt-exhausted-fa -->% |
...
closed. The water sits in the **top** tier, so its vertical CG is **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z -->mm —
<!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm higher** than the exhausted state (<!-- BEGIN weight:wt-exhausted-z -->928<!-- END weight:wt-exhausted-z -->mm), making it the **highest-CG
transport case** that governs road-transport stability (tie-down and cornering).
The exhausted (return) state is both lighter — **<!-- BEGIN weight:wt-total-exhausted -->4,560<!-- END weight:wt-total-exhausted --> kg**, since ~<!-- BEGIN fact:lost_l -->465<!-- END fact:lost_l --> kg of the
...
tip threshold is **~41°** (½-width 1,181mm ÷ Z_cg <!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z -->mm), so the deliberate
...
|------------------|-----------:|-----:|---------------------:|
| Standard Blue fill (1,800L) | 5,086 kg | 1,341mm | 41.4° |
| **Max Blue fill (1,900L)** | **5,186 kg** | **1,358mm** | **41.0°** |
...
The dry state is nearly balanced; the camera-ready/loaded states shift the CG rearward by ~<!-- BEGIN weight:wt-cg-shift -->895<!-- END weight:wt-cg-shift -->mm (the lighter exhausted return state by ~<!-- BEGIN weight:wt-cg-shift-ex -->700<!-- END weight:wt-cg-shift-ex -->mm).
...
CG marker shows the loaded center of gravity at X=<!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x -->, Yd=<!-- BEGIN weight:wt-ready-yd -->1,178<!-- END weight:wt-ready-yd -->.
...
Water has migrated from top-tier Blue IBCs to bottom-tier Brown/Waste IBCs, and ~<!-- BEGIN fact:lost_l -->465<!-- END fact:lost_l --> kg of it has
been lost to the open process (evaporation, wet-print carryout, unrecovered residual — see
[water-system report §4](water-system-report.md)), so only ~<!-- BEGIN fact:recovered_l -->1,245<!-- END fact:recovered_l --> kg is recovered. The hinged panel
is swung ~56° about the pivot to its transport position. Total mass therefore drops to **<!-- BEGIN weight:wt-total-exhausted -->4,560<!-- END weight:wt-total-exhausted --> kg**
(~<!-- BEGIN weight:wt-mass-drop -->540<!-- END weight:wt-mass-drop --> kg below the loaded state), and the vertical CG drops by <!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm (Z: <!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z --> → <!-- BEGIN weight:wt-exhausted-z -->928<!-- END weight:wt-exhausted-z -->mm) as the
...
the **top** tier, raising the vertical CG to **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z -->mm** (+<!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm vs the lighter
exhausted state at <!-- BEGIN weight:wt-exhausted-z -->928<!-- END weight:wt-exhausted-z -->mm). This is the worst-case transport vertical CG.
...
|-------|-----------|------------|-------------|
| Dry | <!-- BEGIN weight:wt-dry-total -->3,300<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-iso-dry-margin -->20,700<!-- END weight:wt-iso-dry-margin --> | <!-- BEGIN weight:wt-iso-dry-util -->13.8<!-- END weight:wt-iso-dry-util -->% |
| Camera Ready | <!-- BEGIN weight:wt-ready-total -->5,100<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-iso-ready-margin -->18,900<!-- END weight:wt-iso-ready-margin --> | <!-- BEGIN weight:wt-iso-ready-util -->21.2<!-- END weight:wt-iso-ready-util -->% |
| Materials Exhausted | <!-- BEGIN weight:wt-exhausted-total -->4,560<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-iso-exhausted-margin -->19,440<!-- END weight:wt-iso-exhausted-margin --> | <!-- BEGIN weight:wt-iso-exhausted-util -->19.0<!-- END weight:wt-iso-exhausted-util -->% |
| Loaded Transport | <!-- BEGIN weight:wt-loadedtx-total -->5,100<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-iso-loadedtx-margin -->18,900<!-- END weight:wt-iso-loadedtx-margin --> | <!-- BEGIN weight:wt-iso-loadedtx-util -->21.2<!-- END weight:wt-iso-loadedtx-util -->% |
...
The near/far split stays close to balanced in all states (<!-- BEGIN weight:wt-near-lo -->48.2<!-- END weight:wt-near-lo -->–<!-- BEGIN weight:wt-near-hi -->50.1<!-- END weight:wt-near-hi -->% near). The
transport states lean slightly far (up to ~<!-- BEGIN weight:wt-far-hi -->51.8<!-- END weight:wt-far-hi -->% far) because the swung panel + drum carry
their mass toward the far/pivot side. This is by
design: equipment on the pinhole wall (near side) is lightweight (electrical
panel, battery, and solar controller totaling ~<!-- BEGIN weight:wt-near-elec -->28<!-- END weight:wt-near-elec --> kg), the pump manifold is on the Corridor Plumbing Panel
centered in the IBC corridor (Yd=1,046), and the IBC stack is centered
across the container width. The film plane carriage contributes ~<!-- BEGIN weight:wt-comp-film -->51<!-- END weight:wt-comp-film --> kg to
the far side but is offset by the tilt-swing board on the near side.

### 6.3 Front-Rear Balance

The dry/transport state has a front-biased split (<!-- BEGIN weight:wt-dry-fr -->53.4<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.6<!-- END weight:wt-dry-rr -->%), with CG at
X=<!-- BEGIN weight:wt-dry-x -->2,752<!-- END weight:wt-dry-x -->mm. This front bias comes from the cargo doors (<!-- BEGIN weight:wt-doors-total -->280<!-- END weight:wt-doors-total --> kg total) being
...
the CG shifts rearward to X=<!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x -->mm (~<!-- BEGIN weight:wt-cg-shift -->895<!-- END weight:wt-cg-shift -->mm past the dry CG). The doors
...
zone (X=4,674–5,893mm). This creates a <!-- BEGIN weight:wt-ready-fr -->34.5<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.5<!-- END weight:wt-ready-rr -->% front/rear split — the heavy
1,000L totes sit at the sealed end.

**Transport implication:** When loaded for transport (materials exhausted,
doors closed), the container's CG is at <!-- BEGIN weight:wt-cg-lengthpct -->58.6<!-- END weight:wt-cg-lengthpct -->% of the length from the cargo
...
- **Loaded (top-tier water):** Z_cg = <!-- BEGIN weight:wt-loadedtx-z -->1,341<!-- END weight:wt-loadedtx-z -->mm (1,800 kg of water in top-tier IBCs)
- **Materials Exhausted:** Z_cg = <!-- BEGIN weight:wt-exhausted-z -->928<!-- END weight:wt-exhausted-z -->mm (<!-- BEGIN fact:recovered_l -->1,245<!-- END fact:recovered_l --> kg of recovered water in bottom-tier IBCs)
- **ΔZ = −<!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm** (CG drops ~<!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm during a session)
...
session; ~<!-- BEGIN fact:recovered_l -->1,245<!-- END fact:recovered_l --> kg is recovered into the bottom-tier Brown/Waste IBCs and ~<!-- BEGIN fact:lost_l -->465<!-- END fact:lost_l --> kg is
lost to the open process, so total mass drops from <!-- BEGIN weight:wt-total-loaded -->5,100<!-- END weight:wt-total-loaded --> to **<!-- BEGIN weight:wt-total-exhausted -->4,560<!-- END weight:wt-total-exhausted --> kg**. The water that
remains migrates from the top tier to the bottom tier, dropping the center of gravity by
<!-- BEGIN weight:wt-mig-dz -->413<!-- END weight:wt-mig-dz -->mm and improving stability through the session.

### 6.5 Walkway Weight Sensitivity

The walkway system contributes <!-- BEGIN weight:wt-walkway-total -->149<!-- END weight:wt-walkway-total --> kg (<!-- BEGIN weight:wt-walkway-pct -->4.5<!-- END weight:wt-walkway-pct -->% of dry weight), making it the
