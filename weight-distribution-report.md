...
|----------|------------|---------------|
| Container (shell + doors) | <!-- BEGIN weight:wt-cat-container -->2,200<!-- END weight:wt-cat-container --> | <!-- BEGIN weight:wt-pct-container -->67.9<!-- END weight:wt-pct-container -->% |
...
| Equipment | <!-- BEGIN weight:wt-cat-equipment -->454<!-- END weight:wt-cat-equipment --> | <!-- BEGIN weight:wt-pct-equipment -->14.0<!-- END weight:wt-pct-equipment -->% |
| **Total dry** | **<!-- BEGIN weight:wt-total-dry -->3,238<!-- END weight:wt-total-dry -->** | **100%** |
...
**Total loaded weight: <!-- BEGIN weight:wt-total-loaded -->5,038<!-- END weight:wt-total-loaded --> kg** (<!-- BEGIN weight:wt-total-dry -->3,238<!-- END weight:wt-total-dry --> dry + 1,800 liquid)
...
**Total exhausted weight: <!-- BEGIN weight:wt-total-exhausted -->4,498<!-- END weight:wt-total-exhausted --> kg** (<!-- BEGIN weight:wt-total-dry -->3,238<!-- END weight:wt-total-dry --> dry + 1,260 liquid)

### 4.3 State Comparison

| State | Total (kg) | X_cg (mm) | Yd_cg (mm) | Z_cg (mm) | Front/Rear | Near/Far |
|-------|-----------|-----------|------------|-----------|------------|----------|
| Dry (Transport) | <!-- BEGIN weight:wt-dry-total -->3,238<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-dry-x -->2,725<!-- END weight:wt-dry-x --> | <!-- BEGIN weight:wt-dry-yd -->1,190<!-- END weight:wt-dry-yd --> | <!-- BEGIN weight:wt-dry-z -->1,096<!-- END weight:wt-dry-z --> | <!-- BEGIN weight:wt-dry-fr -->54.0<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.0<!-- END weight:wt-dry-rr -->% | <!-- BEGIN weight:wt-dry-nr -->48.7<!-- END weight:wt-dry-nr -->/<!-- BEGIN weight:wt-dry-fa -->51.3<!-- END weight:wt-dry-fa -->% |
| Loaded Transport (Blue full) | <!-- BEGIN weight:wt-loadedtx-total -->5,038<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-loadedtx-x -->3,639<!-- END weight:wt-loadedtx-x --> | <!-- BEGIN weight:wt-loadedtx-yd -->1,186<!-- END weight:wt-loadedtx-yd --> | <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> | <!-- BEGIN weight:wt-loadedtx-fr -->34.7<!-- END weight:wt-loadedtx-fr -->/<!-- BEGIN weight:wt-loadedtx-rr -->65.3<!-- END weight:wt-loadedtx-rr -->% | <!-- BEGIN weight:wt-loadedtx-nr -->49.1<!-- END weight:wt-loadedtx-nr -->/<!-- BEGIN weight:wt-loadedtx-fa -->50.9<!-- END weight:wt-loadedtx-fa -->% |
| Camera Ready (Deployed) | <!-- BEGIN weight:wt-ready-total -->5,038<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-ready-x -->3,636<!-- END weight:wt-ready-x --> | <!-- BEGIN weight:wt-ready-yd -->1,171<!-- END weight:wt-ready-yd --> | <!-- BEGIN weight:wt-ready-z -->1,342<!-- END weight:wt-ready-z --> | <!-- BEGIN weight:wt-ready-fr -->34.7<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.3<!-- END weight:wt-ready-rr -->% | <!-- BEGIN weight:wt-ready-nr -->50.4<!-- END weight:wt-ready-nr -->/<!-- BEGIN weight:wt-ready-fa -->49.6<!-- END weight:wt-ready-fa -->% |
| Materials Exhausted (Transport) | <!-- BEGIN weight:wt-exhausted-total -->4,498<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-exhausted-x -->3,441<!-- END weight:wt-exhausted-x --> | <!-- BEGIN weight:wt-exhausted-yd -->1,187<!-- END weight:wt-exhausted-yd --> | <!-- BEGIN weight:wt-exhausted-z -->924<!-- END weight:wt-exhausted-z --> | <!-- BEGIN weight:wt-exhausted-fr -->38.9<!-- END weight:wt-exhausted-fr -->/<!-- BEGIN weight:wt-exhausted-rr -->61.1<!-- END weight:wt-exhausted-rr -->% | <!-- BEGIN weight:wt-exhausted-nr -->49.0<!-- END weight:wt-exhausted-nr -->/<!-- BEGIN weight:wt-exhausted-fa -->51.0<!-- END weight:wt-exhausted-fa -->% |
...
<!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm higher** than the exhausted state (<!-- BEGIN weight:wt-exhausted-z -->924<!-- END weight:wt-exhausted-z -->mm), making it the **highest-CG
transport case** that governs road-transport stability (tie-down and cornering).
The exhausted (return) state is both lighter — **<!-- BEGIN weight:wt-total-exhausted -->4,498<!-- END weight:wt-total-exhausted --> kg**, since ~<!-- BEGIN fact:lost_l -->434<!-- END fact:lost_l --> kg of the
...
CG marker shows the loaded center of gravity at X=<!-- BEGIN weight:wt-ready-x -->3,636<!-- END weight:wt-ready-x -->, Yd=<!-- BEGIN weight:wt-ready-yd -->1,171<!-- END weight:wt-ready-yd -->.
...
is swung ~56° about the pivot to its transport position. Total mass therefore drops to **<!-- BEGIN weight:wt-total-exhausted -->4,498<!-- END weight:wt-total-exhausted --> kg**
(~<!-- BEGIN weight:wt-mass-drop -->540<!-- END weight:wt-mass-drop --> kg below the loaded state), and the vertical CG drops by <!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm (Z: <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> → <!-- BEGIN weight:wt-exhausted-z -->924<!-- END weight:wt-exhausted-z -->mm) as the
...
the **top** tier, raising the vertical CG to **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z -->mm** (+<!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm vs the lighter
...
|-------|-----------|------------|-------------|
| Dry | <!-- BEGIN weight:wt-dry-total -->3,238<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-iso-dry-margin -->20,762<!-- END weight:wt-iso-dry-margin --> | <!-- BEGIN weight:wt-iso-dry-util -->13.5<!-- END weight:wt-iso-dry-util -->% |
| Camera Ready | <!-- BEGIN weight:wt-ready-total -->5,038<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-iso-ready-margin -->18,962<!-- END weight:wt-iso-ready-margin --> | <!-- BEGIN weight:wt-iso-ready-util -->21.0<!-- END weight:wt-iso-ready-util -->% |
| Materials Exhausted | <!-- BEGIN weight:wt-exhausted-total -->4,498<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-iso-exhausted-margin -->19,502<!-- END weight:wt-iso-exhausted-margin --> | <!-- BEGIN weight:wt-iso-exhausted-util -->18.7<!-- END weight:wt-iso-exhausted-util -->% |
| Loaded Transport | <!-- BEGIN weight:wt-loadedtx-total -->5,038<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-iso-loadedtx-margin -->18,962<!-- END weight:wt-iso-loadedtx-margin --> | <!-- BEGIN weight:wt-iso-loadedtx-util -->21.0<!-- END weight:wt-iso-loadedtx-util -->% |
...
the CG shifts rearward to X=<!-- BEGIN weight:wt-ready-x -->3,636<!-- END weight:wt-ready-x -->mm (~<!-- BEGIN weight:wt-cg-shift -->910<!-- END weight:wt-cg-shift -->mm past the dry CG). The doors
...
- **ΔZ = −<!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm** (CG drops ~<!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm during a session)
...
lost to the open process, so total mass drops from <!-- BEGIN weight:wt-total-loaded -->5,038<!-- END weight:wt-total-loaded --> to **<!-- BEGIN weight:wt-total-exhausted -->4,498<!-- END weight:wt-total-exhausted --> kg**. The water that
remains migrates from the top tier to the bottom tier, dropping the center of gravity by
<!-- BEGIN weight:wt-mig-dz -->418<!-- END weight:wt-mig-dz -->mm and improving stability through the session.
