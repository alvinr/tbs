...
| Light-trap drum (rotating) | 35 | 0–40 (deployed); swung ~56° about the pivot (transport) | 653–1,709 | Ø864 C-shell, 1/8" HDPE plastic skin, no fins (suspended with panel) + HDPE end caps + steel Ø75 stub shafts + 2× SKF 6215 bearings |
...
| **Structure subtotal** | **<!-- BEGIN weight:wt-cat-structure -->571<!-- END weight:wt-cat-structure -->** | | | |
...
| Film plane carriage | 32 | 150–4,649 | 2,212–2,312 | Plain 6061 Al angle frame (50.8×50.8×4.8mm; EXPENDABLE — kept aluminum for weight + cost, replace on pitting) + 58 nylon muslin clamps + 4 acetal skate carriages |
...
| **Equipment subtotal** | **<!-- BEGIN weight:wt-cat-equipment -->454<!-- END weight:wt-cat-equipment -->** | | | |

### 3.4 Dry Weight Summary

| Category | Weight (kg) | % of Dry Total |
|----------|------------|---------------|
| Container (shell + doors) | <!-- BEGIN weight:wt-cat-container -->2,200<!-- END weight:wt-cat-container --> | <!-- BEGIN weight:wt-pct-container -->68.2<!-- END weight:wt-pct-container -->% |
| Structure | <!-- BEGIN weight:wt-cat-structure -->571<!-- END weight:wt-cat-structure --> | <!-- BEGIN weight:wt-pct-structure -->17.7<!-- END weight:wt-pct-structure -->% |
| Equipment | <!-- BEGIN weight:wt-cat-equipment -->454<!-- END weight:wt-cat-equipment --> | <!-- BEGIN weight:wt-pct-equipment -->14.1<!-- END weight:wt-pct-equipment -->% |
| **Total dry** | **<!-- BEGIN weight:wt-total-dry -->3,225<!-- END weight:wt-total-dry -->** | **100%** |
...
**Total loaded weight: <!-- BEGIN weight:wt-total-loaded -->5,025<!-- END weight:wt-total-loaded --> kg** (<!-- BEGIN weight:wt-total-dry -->3,225<!-- END weight:wt-total-dry --> dry + 1,800 liquid)
...
**Total exhausted weight: <!-- BEGIN weight:wt-total-exhausted -->4,485<!-- END weight:wt-total-exhausted --> kg** (<!-- BEGIN weight:wt-total-dry -->3,225<!-- END weight:wt-total-dry --> dry + 1,260 liquid)

### 4.3 State Comparison

| State | Total (kg) | X_cg (mm) | Yd_cg (mm) | Z_cg (mm) | Front/Rear | Near/Far |
|-------|-----------|-----------|------------|-----------|------------|----------|
| Dry (Transport) | <!-- BEGIN weight:wt-dry-total -->3,225<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-dry-x -->2,732<!-- END weight:wt-dry-x --> | <!-- BEGIN weight:wt-dry-yd -->1,188<!-- END weight:wt-dry-yd --> | <!-- BEGIN weight:wt-dry-z -->1,095<!-- END weight:wt-dry-z --> | <!-- BEGIN weight:wt-dry-fr -->53.8<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.2<!-- END weight:wt-dry-rr -->% | <!-- BEGIN weight:wt-dry-nr -->48.8<!-- END weight:wt-dry-nr -->/<!-- BEGIN weight:wt-dry-fa -->51.2<!-- END weight:wt-dry-fa -->% |
| Loaded Transport (Blue full) | <!-- BEGIN weight:wt-loadedtx-total -->5,025<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-loadedtx-x -->3,646<!-- END weight:wt-loadedtx-x --> | <!-- BEGIN weight:wt-loadedtx-yd -->1,186<!-- END weight:wt-loadedtx-yd --> | <!-- BEGIN weight:wt-loadedtx-z -->1,343<!-- END weight:wt-loadedtx-z --> | <!-- BEGIN weight:wt-loadedtx-fr -->34.6<!-- END weight:wt-loadedtx-fr -->/<!-- BEGIN weight:wt-loadedtx-rr -->65.4<!-- END weight:wt-loadedtx-rr -->% | <!-- BEGIN weight:wt-loadedtx-nr -->49.2<!-- END weight:wt-loadedtx-nr -->/<!-- BEGIN weight:wt-loadedtx-fa -->50.8<!-- END weight:wt-loadedtx-fa -->% |
| Camera Ready (Deployed) | <!-- BEGIN weight:wt-ready-total -->5,025<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x --> | <!-- BEGIN weight:wt-ready-yd -->1,171<!-- END weight:wt-ready-yd --> | <!-- BEGIN weight:wt-ready-z -->1,342<!-- END weight:wt-ready-z --> | <!-- BEGIN weight:wt-ready-fr -->34.6<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.4<!-- END weight:wt-ready-rr -->% | <!-- BEGIN weight:wt-ready-nr -->50.4<!-- END weight:wt-ready-nr -->/<!-- BEGIN weight:wt-ready-fa -->49.6<!-- END weight:wt-ready-fa -->% |
| Materials Exhausted (Transport) | <!-- BEGIN weight:wt-exhausted-total -->4,485<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-exhausted-x -->3,449<!-- END weight:wt-exhausted-x --> | <!-- BEGIN weight:wt-exhausted-yd -->1,186<!-- END weight:wt-exhausted-yd --> | <!-- BEGIN weight:wt-exhausted-z -->923<!-- END weight:wt-exhausted-z --> | <!-- BEGIN weight:wt-exhausted-fr -->38.7<!-- END weight:wt-exhausted-fr -->/<!-- BEGIN weight:wt-exhausted-rr -->61.3<!-- END weight:wt-exhausted-rr -->% | <!-- BEGIN weight:wt-exhausted-nr -->49.1<!-- END weight:wt-exhausted-nr -->/<!-- BEGIN weight:wt-exhausted-fa -->50.9<!-- END weight:wt-exhausted-fa -->% |
...
<!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm higher** than the exhausted state (<!-- BEGIN weight:wt-exhausted-z -->923<!-- END weight:wt-exhausted-z -->mm), making it the **highest-CG
transport case** that governs road-transport stability (tie-down and cornering).
The exhausted (return) state is both lighter — **<!-- BEGIN weight:wt-total-exhausted -->4,485<!-- END weight:wt-total-exhausted --> kg**, since ~<!-- BEGIN fact:lost_l -->434<!-- END fact:lost_l --> kg of the
...
The dry state is nearly balanced; the camera-ready/loaded states shift the CG rearward by ~<!-- BEGIN weight:wt-cg-shift -->915<!-- END weight:wt-cg-shift -->mm (the lighter exhausted return state by ~<!-- BEGIN weight:wt-cg-shift-ex -->715<!-- END weight:wt-cg-shift-ex -->mm).
...
CG marker shows the loaded center of gravity at X=<!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x -->, Yd=<!-- BEGIN weight:wt-ready-yd -->1,171<!-- END weight:wt-ready-yd -->.
...
is swung ~56° about the pivot to its transport position. Total mass therefore drops to **<!-- BEGIN weight:wt-total-exhausted -->4,485<!-- END weight:wt-total-exhausted --> kg**
(~<!-- BEGIN weight:wt-mass-drop -->540<!-- END weight:wt-mass-drop --> kg below the loaded state), and the vertical CG drops by <!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm (Z: <!-- BEGIN weight:wt-loadedtx-z -->1,343<!-- END weight:wt-loadedtx-z --> → <!-- BEGIN weight:wt-exhausted-z -->923<!-- END weight:wt-exhausted-z -->mm) as the
...
the **top** tier, raising the vertical CG to **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,343<!-- END weight:wt-loadedtx-z -->mm** (+<!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm vs the lighter
exhausted state at <!-- BEGIN weight:wt-exhausted-z -->923<!-- END weight:wt-exhausted-z -->mm). This is the worst-case transport vertical CG.
...
|-------|-----------|------------|-------------|
| Dry | <!-- BEGIN weight:wt-dry-total -->3,225<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-iso-dry-margin -->20,775<!-- END weight:wt-iso-dry-margin --> | <!-- BEGIN weight:wt-iso-dry-util -->13.4<!-- END weight:wt-iso-dry-util -->% |
| Camera Ready | <!-- BEGIN weight:wt-ready-total -->5,025<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-iso-ready-margin -->18,975<!-- END weight:wt-iso-ready-margin --> | <!-- BEGIN weight:wt-iso-ready-util -->20.9<!-- END weight:wt-iso-ready-util -->% |
| Materials Exhausted | <!-- BEGIN weight:wt-exhausted-total -->4,485<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-iso-exhausted-margin -->19,515<!-- END weight:wt-iso-exhausted-margin --> | <!-- BEGIN weight:wt-iso-exhausted-util -->18.7<!-- END weight:wt-iso-exhausted-util -->% |
| Loaded Transport | <!-- BEGIN weight:wt-loadedtx-total -->5,025<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-iso-loadedtx-margin -->18,975<!-- END weight:wt-iso-loadedtx-margin --> | <!-- BEGIN weight:wt-iso-loadedtx-util -->20.9<!-- END weight:wt-iso-loadedtx-util -->% |
...
The near/far split stays close to balanced in all states (<!-- BEGIN weight:wt-near-lo -->48.8<!-- END weight:wt-near-lo -->–<!-- BEGIN weight:wt-near-hi -->50.4<!-- END weight:wt-near-hi -->% near). The
transport states lean slightly far (up to ~<!-- BEGIN weight:wt-far-hi -->51.2<!-- END weight:wt-far-hi -->% far) because the swung panel + drum carry
...
across the container width. The film plane carriage contributes ~<!-- BEGIN weight:wt-comp-film -->21<!-- END weight:wt-comp-film --> kg to
the far side but is offset by the tilt-swing board on the near side.

### 6.3 Front-Rear Balance

The dry/transport state has a front-biased split (<!-- BEGIN weight:wt-dry-fr -->53.8<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.2<!-- END weight:wt-dry-rr -->%), with CG at
X=<!-- BEGIN weight:wt-dry-x -->2,732<!-- END weight:wt-dry-x -->mm. This front bias comes from the cargo doors (<!-- BEGIN weight:wt-doors-total -->280<!-- END weight:wt-doors-total --> kg total) being
...
the CG shifts rearward to X=<!-- BEGIN weight:wt-ready-x -->3,646<!-- END weight:wt-ready-x -->mm (~<!-- BEGIN weight:wt-cg-shift -->915<!-- END weight:wt-cg-shift -->mm past the dry CG). The doors
...
- **Materials Exhausted:** Z_cg = <!-- BEGIN weight:wt-exhausted-z -->923<!-- END weight:wt-exhausted-z -->mm (<!-- BEGIN fact:recovered_l -->1,260<!-- END fact:recovered_l --> kg of recovered water in bottom-tier IBCs)
- **ΔZ = −<!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm** (CG drops ~<!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm during a session)
...
lost to the open process, so total mass drops from <!-- BEGIN weight:wt-total-loaded -->5,025<!-- END weight:wt-total-loaded --> to **<!-- BEGIN weight:wt-total-exhausted -->4,485<!-- END weight:wt-total-exhausted --> kg**. The water that
remains migrates from the top tier to the bottom tier, dropping the center of gravity by
<!-- BEGIN weight:wt-mig-dz -->420<!-- END weight:wt-mig-dz -->mm and improving stability through the session.
