...
| Film plane carriage | 57 | 150–4,649 | 2,212–2,312 | **3mm Dibond ACM backing sheet ≈36 kg (3.80 kg/m² × the FP_W×FP_H face — moves with the plane)** + plain 6061 Al angle frame (50.8×50.8×4.8mm; EXPENDABLE — kept aluminum for weight + cost, replace on pitting) + 58 nylon muslin clamps + 4 acetal skate carriages |
...
| **Equipment subtotal** | **<!-- BEGIN weight:wt-cat-equipment -->488<!-- END weight:wt-cat-equipment -->** | | | |
...
| Structure | <!-- BEGIN weight:wt-cat-structure -->568<!-- END weight:wt-cat-structure --> | <!-- BEGIN weight:wt-pct-structure -->17.4<!-- END weight:wt-pct-structure -->% |
| Equipment | <!-- BEGIN weight:wt-cat-equipment -->488<!-- END weight:wt-cat-equipment --> | <!-- BEGIN weight:wt-pct-equipment -->15.0<!-- END weight:wt-pct-equipment -->% |
| **Total dry** | **<!-- BEGIN weight:wt-total-dry -->3,256<!-- END weight:wt-total-dry -->** | **100%** |
...
**Total loaded weight: <!-- BEGIN weight:wt-total-loaded -->5,056<!-- END weight:wt-total-loaded --> kg** (<!-- BEGIN weight:wt-total-dry -->3,256<!-- END weight:wt-total-dry --> dry + 1,800 liquid)
...
**Total exhausted weight: <!-- BEGIN weight:wt-total-exhausted -->4,516<!-- END weight:wt-total-exhausted --> kg** (<!-- BEGIN weight:wt-total-dry -->3,256<!-- END weight:wt-total-dry --> dry + 1,260 liquid)

### 4.3 State Comparison

| State | Total (kg) | X_cg (mm) | Yd_cg (mm) | Z_cg (mm) | Front/Rear | Near/Far |
|-------|-----------|-----------|------------|-----------|------------|----------|
| Dry (Transport) | <!-- BEGIN weight:wt-dry-total -->3,256<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-dry-x -->2,738<!-- END weight:wt-dry-x --> | <!-- BEGIN weight:wt-dry-yd -->1,198<!-- END weight:wt-dry-yd --> | <!-- BEGIN weight:wt-dry-z -->1,097<!-- END weight:wt-dry-z --> | <!-- BEGIN weight:wt-dry-fr -->53.6<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->46.4<!-- END weight:wt-dry-rr -->% | <!-- BEGIN weight:wt-dry-nr -->48.4<!-- END weight:wt-dry-nr -->/<!-- BEGIN weight:wt-dry-fa -->51.6<!-- END weight:wt-dry-fa -->% |
| Loaded Transport (Blue full) | <!-- BEGIN weight:wt-loadedtx-total -->5,056<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-loadedtx-x -->3,644<!-- END weight:wt-loadedtx-x --> | <!-- BEGIN weight:wt-loadedtx-yd -->1,192<!-- END weight:wt-loadedtx-yd --> | <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> | <!-- BEGIN weight:wt-loadedtx-fr -->34.5<!-- END weight:wt-loadedtx-fr -->/<!-- BEGIN weight:wt-loadedtx-rr -->65.5<!-- END weight:wt-loadedtx-rr -->% | <!-- BEGIN weight:wt-loadedtx-nr -->49.0<!-- END weight:wt-loadedtx-nr -->/<!-- BEGIN weight:wt-loadedtx-fa -->51.0<!-- END weight:wt-loadedtx-fa -->% |
| Camera Ready (Deployed) | <!-- BEGIN weight:wt-ready-total -->5,056<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-ready-x -->3,648<!-- END weight:wt-ready-x --> | <!-- BEGIN weight:wt-ready-yd -->1,179<!-- END weight:wt-ready-yd --> | <!-- BEGIN weight:wt-ready-z -->1,342<!-- END weight:wt-ready-z --> | <!-- BEGIN weight:wt-ready-fr -->34.5<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.5<!-- END weight:wt-ready-rr -->% | <!-- BEGIN weight:wt-ready-nr -->50.1<!-- END weight:wt-ready-nr -->/<!-- BEGIN weight:wt-ready-fa -->49.9<!-- END weight:wt-ready-fa -->% |
| Materials Exhausted (Transport) | <!-- BEGIN weight:wt-exhausted-total -->4,516<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-exhausted-x -->3,448<!-- END weight:wt-exhausted-x --> | <!-- BEGIN weight:wt-exhausted-yd -->1,193<!-- END weight:wt-exhausted-yd --> | <!-- BEGIN weight:wt-exhausted-z -->926<!-- END weight:wt-exhausted-z --> | <!-- BEGIN weight:wt-exhausted-fr -->38.7<!-- END weight:wt-exhausted-fr -->/<!-- BEGIN weight:wt-exhausted-rr -->61.3<!-- END weight:wt-exhausted-rr -->% | <!-- BEGIN weight:wt-exhausted-nr -->48.8<!-- END weight:wt-exhausted-nr -->/<!-- BEGIN weight:wt-exhausted-fa -->51.2<!-- END weight:wt-exhausted-fa -->% |
...
<!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm higher** than the exhausted state (<!-- BEGIN weight:wt-exhausted-z -->926<!-- END weight:wt-exhausted-z -->mm), making it the **highest-CG
transport case** that governs road-transport stability (tie-down and cornering).
The exhausted (return) state is both lighter — **<!-- BEGIN weight:wt-total-exhausted -->4,516<!-- END weight:wt-total-exhausted --> kg**, since ~<!-- BEGIN fact:lost_l -->434<!-- END fact:lost_l --> kg of the
...
CG marker shows the loaded center of gravity at X=<!-- BEGIN weight:wt-ready-x -->3,648<!-- END weight:wt-ready-x -->, Yd=<!-- BEGIN weight:wt-ready-yd -->1,179<!-- END weight:wt-ready-yd -->.
...
is swung ~56° about the pivot to its transport position. Total mass therefore drops to **<!-- BEGIN weight:wt-total-exhausted -->4,516<!-- END weight:wt-total-exhausted --> kg**
(~<!-- BEGIN weight:wt-mass-drop -->540<!-- END weight:wt-mass-drop --> kg below the loaded state), and the vertical CG drops by <!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm (Z: <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> → <!-- BEGIN weight:wt-exhausted-z -->926<!-- END weight:wt-exhausted-z -->mm) as the
...
the **top** tier, raising the vertical CG to **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z -->mm** (+<!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm vs the lighter
...
|-------|-----------|------------|-------------|
| Dry | <!-- BEGIN weight:wt-dry-total -->3,256<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-iso-dry-margin -->20,744<!-- END weight:wt-iso-dry-margin --> | <!-- BEGIN weight:wt-iso-dry-util -->13.6<!-- END weight:wt-iso-dry-util -->% |
| Camera Ready | <!-- BEGIN weight:wt-ready-total -->5,056<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-iso-ready-margin -->18,944<!-- END weight:wt-iso-ready-margin --> | <!-- BEGIN weight:wt-iso-ready-util -->21.1<!-- END weight:wt-iso-ready-util -->% |
| Materials Exhausted | <!-- BEGIN weight:wt-exhausted-total -->4,516<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-iso-exhausted-margin -->19,484<!-- END weight:wt-iso-exhausted-margin --> | <!-- BEGIN weight:wt-iso-exhausted-util -->18.8<!-- END weight:wt-iso-exhausted-util -->% |
| Loaded Transport | <!-- BEGIN weight:wt-loadedtx-total -->5,056<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-iso-loadedtx-margin -->18,944<!-- END weight:wt-iso-loadedtx-margin --> | <!-- BEGIN weight:wt-iso-loadedtx-util -->21.1<!-- END weight:wt-iso-loadedtx-util -->% |
...
The near/far split stays close to balanced in all states (<!-- BEGIN weight:wt-near-lo -->48.4<!-- END weight:wt-near-lo -->–<!-- BEGIN weight:wt-near-hi -->50.1<!-- END weight:wt-near-hi -->% near). The
transport states lean slightly far (up to ~<!-- BEGIN weight:wt-far-hi -->51.6<!-- END weight:wt-far-hi -->% far) because the swung panel + drum carry
...
across the container width. The film plane carriage contributes ~<!-- BEGIN weight:wt-comp-film -->57<!-- END weight:wt-comp-film --> kg to
...
X=<!-- BEGIN weight:wt-dry-x -->2,738<!-- END weight:wt-dry-x -->mm. This front bias comes from the cargo doors (<!-- BEGIN weight:wt-doors-total -->280<!-- END weight:wt-doors-total --> kg total) being
...
the CG shifts rearward to X=<!-- BEGIN weight:wt-ready-x -->3,648<!-- END weight:wt-ready-x -->mm (~<!-- BEGIN weight:wt-cg-shift -->910<!-- END weight:wt-cg-shift -->mm past the dry CG). The doors
...
- **Materials Exhausted:** Z_cg = <!-- BEGIN weight:wt-exhausted-z -->926<!-- END weight:wt-exhausted-z -->mm (<!-- BEGIN fact:recovered_l -->1,260<!-- END fact:recovered_l --> kg of recovered water in bottom-tier IBCs)
- **ΔZ = −<!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm** (CG drops ~<!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm during a session)
...
lost to the open process, so total mass drops from <!-- BEGIN weight:wt-total-loaded -->5,056<!-- END weight:wt-total-loaded --> to **<!-- BEGIN weight:wt-total-exhausted -->4,516<!-- END weight:wt-total-exhausted --> kg**. The water that
remains migrates from the top tier to the bottom tier, dropping the center of gravity by
<!-- BEGIN weight:wt-mig-dz -->416<!-- END weight:wt-mig-dz -->mm and improving stability through the session.
