...
| **Equipment subtotal** | **<!-- BEGIN weight:wt-cat-equipment -->487<!-- END weight:wt-cat-equipment -->** | | | |

### 3.4 Dry Weight Summary

| Category | Weight (kg) | % of Dry Total |
|----------|------------|---------------|
| Container (shell + doors) | <!-- BEGIN weight:wt-cat-container -->2,200<!-- END weight:wt-cat-container --> | <!-- BEGIN weight:wt-pct-container -->67.2<!-- END weight:wt-pct-container -->% |
| Structure | <!-- BEGIN weight:wt-cat-structure -->585<!-- END weight:wt-cat-structure --> | <!-- BEGIN weight:wt-pct-structure -->17.9<!-- END weight:wt-pct-structure -->% |
| Equipment | <!-- BEGIN weight:wt-cat-equipment -->487<!-- END weight:wt-cat-equipment --> | <!-- BEGIN weight:wt-pct-equipment -->14.9<!-- END weight:wt-pct-equipment -->% |
| **Total dry** | **<!-- BEGIN weight:wt-total-dry -->3,272<!-- END weight:wt-total-dry -->** | **100%** |
...
**Total loaded weight: <!-- BEGIN weight:wt-total-loaded -->5,072<!-- END weight:wt-total-loaded --> kg** (<!-- BEGIN weight:wt-total-dry -->3,272<!-- END weight:wt-total-dry --> dry + 1,800 liquid)
...
**Total exhausted weight: <!-- BEGIN weight:wt-total-exhausted -->4,532<!-- END weight:wt-total-exhausted --> kg** (<!-- BEGIN weight:wt-total-dry -->3,272<!-- END weight:wt-total-dry --> dry + 1,260 liquid)

### 4.3 State Comparison

| State | Total (kg) | X_cg (mm) | Yd_cg (mm) | Z_cg (mm) | Front/Rear | Near/Far |
|-------|-----------|-----------|------------|-----------|------------|----------|
| Dry (Transport) | <!-- BEGIN weight:wt-dry-total -->3,272<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-dry-x -->2,755<!-- END weight:wt-dry-x --> | <!-- BEGIN weight:wt-dry-yd -->1,208<!-- END weight:wt-dry-yd --> | <!-- BEGIN weight:wt-dry-z -->1,097<!-- END weight:wt-dry-z --> | <!-- BEGIN weight:wt-dry-fr -->52.9<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->47.1<!-- END weight:wt-dry-rr -->% | <!-- BEGIN weight:wt-dry-nr -->47.7<!-- END weight:wt-dry-nr -->/<!-- BEGIN weight:wt-dry-fa -->52.3<!-- END weight:wt-dry-fa -->% |
| Loaded Transport (Blue full) | <!-- BEGIN weight:wt-loadedtx-total -->5,072<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-loadedtx-x -->3,652<!-- END weight:wt-loadedtx-x --> | <!-- BEGIN weight:wt-loadedtx-yd -->1,198<!-- END weight:wt-loadedtx-yd --> | <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> | <!-- BEGIN weight:wt-loadedtx-fr -->34.2<!-- END weight:wt-loadedtx-fr -->/<!-- BEGIN weight:wt-loadedtx-rr -->65.8<!-- END weight:wt-loadedtx-rr -->% | <!-- BEGIN weight:wt-loadedtx-nr -->48.5<!-- END weight:wt-loadedtx-nr -->/<!-- BEGIN weight:wt-loadedtx-fa -->51.5<!-- END weight:wt-loadedtx-fa -->% |
| Camera Ready (Deployed) | <!-- BEGIN weight:wt-ready-total -->5,072<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-ready-x -->3,652<!-- END weight:wt-ready-x --> | <!-- BEGIN weight:wt-ready-yd -->1,184<!-- END weight:wt-ready-yd --> | <!-- BEGIN weight:wt-ready-z -->1,341<!-- END weight:wt-ready-z --> | <!-- BEGIN weight:wt-ready-fr -->34.2<!-- END weight:wt-ready-fr -->/<!-- BEGIN weight:wt-ready-rr -->65.8<!-- END weight:wt-ready-rr -->% | <!-- BEGIN weight:wt-ready-nr -->49.8<!-- END weight:wt-ready-nr -->/<!-- BEGIN weight:wt-ready-fa -->50.2<!-- END weight:wt-ready-fa -->% |
| Materials Exhausted (Transport) | <!-- BEGIN weight:wt-exhausted-total -->4,532<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-exhausted-x -->3,458<!-- END weight:wt-exhausted-x --> | <!-- BEGIN weight:wt-exhausted-yd -->1,201<!-- END weight:wt-exhausted-yd --> | <!-- BEGIN weight:wt-exhausted-z -->927<!-- END weight:wt-exhausted-z --> | <!-- BEGIN weight:wt-exhausted-fr -->38.2<!-- END weight:wt-exhausted-fr -->/<!-- BEGIN weight:wt-exhausted-rr -->61.8<!-- END weight:wt-exhausted-rr -->% | <!-- BEGIN weight:wt-exhausted-nr -->48.4<!-- END weight:wt-exhausted-nr -->/<!-- BEGIN weight:wt-exhausted-fa -->51.6<!-- END weight:wt-exhausted-fa -->% |
...
<!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm higher** than the exhausted state (<!-- BEGIN weight:wt-exhausted-z -->927<!-- END weight:wt-exhausted-z -->mm), making it the **highest-CG
transport case** that governs road-transport stability (tie-down and cornering).
The exhausted (return) state is both lighter — **<!-- BEGIN weight:wt-total-exhausted -->4,532<!-- END weight:wt-total-exhausted --> kg**, since ~<!-- BEGIN fact:lost_l -->465<!-- END fact:lost_l --> kg of the
...
The dry state is nearly balanced; the camera-ready/loaded states shift the CG rearward by ~<!-- BEGIN weight:wt-cg-shift -->895<!-- END weight:wt-cg-shift -->mm (the lighter exhausted return state by ~<!-- BEGIN weight:wt-cg-shift-ex -->705<!-- END weight:wt-cg-shift-ex -->mm).
...
CG marker shows the loaded center of gravity at X=<!-- BEGIN weight:wt-ready-x -->3,652<!-- END weight:wt-ready-x -->, Yd=<!-- BEGIN weight:wt-ready-yd -->1,184<!-- END weight:wt-ready-yd -->.
...
is swung ~56° about the pivot to its transport position. Total mass therefore drops to **<!-- BEGIN weight:wt-total-exhausted -->4,532<!-- END weight:wt-total-exhausted --> kg**
(~<!-- BEGIN weight:wt-mass-drop -->540<!-- END weight:wt-mass-drop --> kg below the loaded state), and the vertical CG drops by <!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm (Z: <!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z --> → <!-- BEGIN weight:wt-exhausted-z -->927<!-- END weight:wt-exhausted-z -->mm) as the
...
the **top** tier, raising the vertical CG to **Z=<!-- BEGIN weight:wt-loadedtx-z -->1,342<!-- END weight:wt-loadedtx-z -->mm** (+<!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm vs the lighter
exhausted state at <!-- BEGIN weight:wt-exhausted-z -->927<!-- END weight:wt-exhausted-z -->mm). This is the worst-case transport vertical CG.
...
|-------|-----------|------------|-------------|
| Dry | <!-- BEGIN weight:wt-dry-total -->3,272<!-- END weight:wt-dry-total --> | <!-- BEGIN weight:wt-iso-dry-margin -->20,728<!-- END weight:wt-iso-dry-margin --> | <!-- BEGIN weight:wt-iso-dry-util -->13.6<!-- END weight:wt-iso-dry-util -->% |
| Camera Ready | <!-- BEGIN weight:wt-ready-total -->5,072<!-- END weight:wt-ready-total --> | <!-- BEGIN weight:wt-iso-ready-margin -->18,928<!-- END weight:wt-iso-ready-margin --> | <!-- BEGIN weight:wt-iso-ready-util -->21.1<!-- END weight:wt-iso-ready-util -->% |
| Materials Exhausted | <!-- BEGIN weight:wt-exhausted-total -->4,532<!-- END weight:wt-exhausted-total --> | <!-- BEGIN weight:wt-iso-exhausted-margin -->19,468<!-- END weight:wt-iso-exhausted-margin --> | <!-- BEGIN weight:wt-iso-exhausted-util -->18.9<!-- END weight:wt-iso-exhausted-util -->% |
| Loaded Transport | <!-- BEGIN weight:wt-loadedtx-total -->5,072<!-- END weight:wt-loadedtx-total --> | <!-- BEGIN weight:wt-iso-loadedtx-margin -->18,928<!-- END weight:wt-iso-loadedtx-margin --> | <!-- BEGIN weight:wt-iso-loadedtx-util -->21.1<!-- END weight:wt-iso-loadedtx-util -->% |
...
The near/far split stays close to balanced in all states (<!-- BEGIN weight:wt-near-lo -->47.7<!-- END weight:wt-near-lo -->–<!-- BEGIN weight:wt-near-hi -->49.8<!-- END weight:wt-near-hi -->% near). The
transport states lean slightly far (up to ~<!-- BEGIN weight:wt-far-hi -->52.3<!-- END weight:wt-far-hi -->% far) because the swung panel + drum carry
...
The dry/transport state has a front-biased split (<!-- BEGIN weight:wt-dry-fr -->52.9<!-- END weight:wt-dry-fr -->/<!-- BEGIN weight:wt-dry-rr -->47.1<!-- END weight:wt-dry-rr -->%), with CG at
X=<!-- BEGIN weight:wt-dry-x -->2,755<!-- END weight:wt-dry-x -->mm. This front bias comes from the cargo doors (<!-- BEGIN weight:wt-doors-total -->280<!-- END weight:wt-doors-total --> kg total) being
...
the CG shifts rearward to X=<!-- BEGIN weight:wt-ready-x -->3,652<!-- END weight:wt-ready-x -->mm (~<!-- BEGIN weight:wt-cg-shift -->895<!-- END weight:wt-cg-shift -->mm past the dry CG). The doors
...
doors closed), the container's CG is at <!-- BEGIN weight:wt-cg-lengthpct -->58.7<!-- END weight:wt-cg-lengthpct -->% of the length from the cargo
...
- **Materials Exhausted:** Z_cg = <!-- BEGIN weight:wt-exhausted-z -->927<!-- END weight:wt-exhausted-z -->mm (<!-- BEGIN fact:recovered_l -->1,245<!-- END fact:recovered_l --> kg of recovered water in bottom-tier IBCs)
- **ΔZ = −<!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm** (CG drops ~<!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm during a session)
...
lost to the open process, so total mass drops from <!-- BEGIN weight:wt-total-loaded -->5,072<!-- END weight:wt-total-loaded --> to **<!-- BEGIN weight:wt-total-exhausted -->4,532<!-- END weight:wt-total-exhausted --> kg**. The water that
remains migrates from the top tier to the bottom tier, dropping the center of gravity by
<!-- BEGIN weight:wt-mig-dz -->415<!-- END weight:wt-mig-dz -->mm and improving stability through the session.

### 6.5 Walkway Weight Sensitivity

The walkway system contributes <!-- BEGIN weight:wt-walkway-total -->149<!-- END weight:wt-walkway-total --> kg (<!-- BEGIN weight:wt-walkway-pct -->4.6<!-- END weight:wt-walkway-pct -->% of dry weight), making it the
